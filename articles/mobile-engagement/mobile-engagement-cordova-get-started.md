...
+ [Mobile Engagement Cordova プラグイン](https://www.npmjs.com/package/cordova-plugin-ms-azure-mobile-engagement)

> [AZURE.NOTE] の Cordova プラグインのソース コードおよび readme ファイルを検索 [Github](https://github.com/Azure/azure-mobile-engagement-cordova)
...
2. アプリケーションを実行します。
    ...
    - **iOS の場合**
        ...
        `ターミナル` ウィンドウは、次を実行することによって、新しいシミュレーター インスタンスでアプリを起動します。

            cordova run ios

    - **Android の場合**

        `ターミナル` ウィンドウは、次を実行することによって、新しいエミュレーター インスタンスでアプリを起動します。
