<properties
    pageTitle="Rozpoczynanie pracy z usługą Azure Mobile Engagement dla oprogramowania Cordova/Phonegap"
...
> [AZURE.NOTE] Kod źródłowy i plik ReadMe dla wtyczki Cordova można znaleźć w serwisie [GitHub](https://github.com/Azure/azure-mobile-engagement-cordova)
...
###Konfigurowanie poświadczeń wypychania dla usługi Mobile Engagement
...
###Włączanie powiadomień wypychanych w aplikacji Cordova
