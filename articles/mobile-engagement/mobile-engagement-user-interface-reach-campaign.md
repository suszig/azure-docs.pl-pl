...
- 言語固有の言語は、既定の言語に加えて選択できます。
- キャンペーン: すべての言語で同じ
- 通知: 既定の言語に加えて言語ごとに一意
- コンテンツ: 既定の言語に加えて言語ごとに一意
- 対象ユーザー: 言語ごとの条件でフィルター処理できます。
- 期間: すべての言語に対して同じ
- 一度にテスト: 言語ごとに送信する可能性があります。
...
- 名前: すべて
- カテゴリ: アナウンス、アンケート.
- 対象ユーザーを無視するプッシュは API を使用してユーザーに送信されます: すべて
...
- [UI ドキュメント - Reach - プッシュ コンテンツ ][link 29]
...
- [UI ドキュメント - Reach - 新しいプッシュ条件 ][link 28]
...
- ユーザーのサブセットのみを対象にする: すべて (アナウンス、アンケート、データ プッシュ、タイル)
- 古いユーザーのみ対象: すべて (アナウンス、アンケート、データ プッシュ、タイル)
- 新しいユーザーのみ対象: すべて (アナウンス、アンケート、データ プッシュ、タイル)
- アイドル状態のユーザーのみを対象にする: アナウンス、アンケート、タイル
- アクティブなユーザーのみを対象にする: すべて (アナウンス、アンケート、データ プッシュ、タイル)
- ネイティブ プッシュ通知を使用してアクセスできるユーザーのみを対象にする: お知らせ、アンケート
