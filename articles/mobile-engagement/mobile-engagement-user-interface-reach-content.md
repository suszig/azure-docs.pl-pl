...
### 追跡用 URL を構築する:
-    「設定」セクションを参照してください、 <UI Documentation> 追跡 URL を構築する方法をユーザーが、他のアプリケーションのいずれかをダウンロードします。
