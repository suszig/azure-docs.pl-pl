...
そのあと、新しい Microsoft Azure Engagement NuGet パッケージをプロジェクトにインストールします。 [Nuget の web サイト] で直接検索することができます。 またはここのインデックス。 この操作は、Engagement によって使用されるすべてのリソース ファイルを置換し、プロジェクトの参照に新しい Engagement の DLL を追加します。
