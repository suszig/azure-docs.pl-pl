...
詳細についてを参照してください: [SDK ドキュメント - iOS - ][link 5]
...
- [SDK ドキュメント Android する方法の GCM の統合 ][link 5]
...
- [SDK ドキュメント Android する方法の統合 ADM ][link 5]
- [Amazon 開発者向けの ADM ドキュメント](https://developer.amazon.com/sdk/adm/credentials.html#Getting)
