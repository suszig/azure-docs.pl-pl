...
## デバイス:
表示、追加、または削除するテストに使用できるテスト デバイスのテスト デバイス ID、 **到達** または **プッシュ** キャンペーン。 各プラットフォーム用 (iOS、Android、Windows Phone など) のデバイスのデバイス ID を検索する方法のコンテキストは、[新しいデバイス] をクリックすると表示されます。 
