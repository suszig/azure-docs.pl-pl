...
使用することができます、 **KPI ビルダー** ワークシートに、[メディア戦略のテンプレート] [メディアの戦略のリンク] 例とガイダンスです。
...
使用して、 **エンゲージメント プログラム** [メディア戦略] [メディアの戦略のリンク] のテンプレートの例とガイダンスのワークシートです。
...
アプリケーションに対し、やみくもにタグ付けすることは避けてください。 対象とするタグ データは、モバイル エンゲージメント戦略に不可欠な要素に限定します。 通常この点はアプリケーションによって異なります。 [メディア戦略テンプレート] [メディアの戦略のリンク] は、指定されたメソッドを使用してタグ計画を作成する Azure モバイル エンゲージメントによりによって提供されます。 使用して、 **タグ計画** タグ計画を作成するためのガイドとしてワークシートです。
