...
この記事で説明、 **モニター** のタブ、 **モバイル エンゲージメント** ポータルです。 使用する、 **モバイル エンゲージメント** を監視し、モバイル アプリの管理ポータル。 ポータルの使用を開始する最初必要を作成する、 **Azure モバイル エンゲージメント** アカウントです。 詳細については、次を参照してください。 [Azure モバイル エンゲージメント アカウントを作成する](mobile-engagement-create-account.md)です。
...
詳細についてを参照してください: [SDK のドキュメント] [リンク 5]
...
詳細についてを参照してください: [SDK ドキュメント - リリース ノート] [リンク 5]
