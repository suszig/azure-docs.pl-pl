...
| --- | --- |
| INTERNET |Wymagane. Na podstawowym raportowaniem |
| ACCESS_NETWORK_STATE |Wymagane. Na podstawowym raportowaniem |
| RECEIVE_BOOT_COMPLETED |Wymagane. Wyświetlani Centrum powiadomień po ponownym uruchomieniu urządzenia |
