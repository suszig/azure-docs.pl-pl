...
---
title: Tworzenie bramy aplikacji przy użyciu szablonów usługi Azure Resource Manager | Microsoft Docs
...
> [!NOTE]
> Te ustawienia to parametry tego szablonu. Aby dostosować szablon, możesz zmienić reguły, odbiornik oraz protokół SSL, który służy do otwierania pliku azuredeploy.json.
> 
> 
...
1. Sprawdź zawartość w obszarze **resources**, w szczególności następujące pozycje:
...
2. Przejdź z powrotem na stronę [https://github.com/Azure/azure-quickstart-templates/blob/master/101-application-gateway-create/](https://github.com/Azure/azure-quickstart-templates/blob/master/101-application-gateway-create).
3. Kliknij plik **azuredeploy-paremeters.json**, a następnie kliknij opcję **RAW**.
4. Zapisz plik w folderze lokalnym na komputerze.
5. Otwórz zapisany plik i edytuj wartości parametrów. Do wdrożenia opisanej w scenariuszu bramy aplikacji użyj poniższych wartości.
...
6. Zapisz plik. Szablon JSON i szablon parametrów można przetestować za pomocą narzędzi weryfikacji danych JSON w trybie online, takich jak [JSlint.com](http://www.jslint.com/).
