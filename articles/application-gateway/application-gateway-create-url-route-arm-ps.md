...
Zmień adres URL do http://<ip-address>:8080/video/test.htm na końcu podstawowy adres URL i powinny zostać wyświetlone informacje, jak w następującym przykładzie:
