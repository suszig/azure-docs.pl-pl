...
> Aby uzyskać pełną dokumentację interfejsu API zapytania, zobacz [zapytania interfejsu API](/rest/api/time-series-insights/time-series-insights-reference-queryapi).
