...
7. W pliku **AzureSqlLinkedService1.json** zastąp wartości `<servername>``<databasename>``<username@servername>``<password>`, wpisując nazwy serwera SQL Azure, bazy danych i konta użytkownika oraz hasło.    
...
> [AZURE.IMPORTANT] Aby tworzyć wystąpienia usługi Data Factory, musisz być administratorem lub współadministratorem subskrypcji platformy Azure
