...
| Data/godzina |From(X) |X: ciąg |Przeanalizować ciągu X na czas daty. |
| Data/godzina |Ticks(X) |X: DateTime |Pobiera właściwość parametru X to znaczniki osi. Jeden znaczników jest równy 100 nanosekundach. Wartość ta właściwość reprezentuje liczbę znaczników, które upłynęły od północy 12:00:00 1 stycznia 0001. |
