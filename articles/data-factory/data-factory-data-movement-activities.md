...
| ソース| シンク |
|:------- | :---- |
| <ul><li>[Azure BLOB](data-factory-azure-blob-connector.md)</li><li>[Azure テーブル](data-factory-azure-table-connector.md)</li><li>[Azure SQL データベース](data-factory-azure-sql-connector.md)</li><li>[Azure SQL Data Warehouse](data-factory-azure-sql-data-warehouse-connector.md)</li><li>[Azure DocumentDB](data-factory-azure-documentdb-connector.md)</li><li>[Azure Data Lake Store](data-factory-azure-datalake-connector.md)</li><li>[SQL Server の内部設置型と Azure の IaaS](data-factory-sqlserver-connector.md)</li><li>[オンプレミス/Azure IaaS のファイル システム](data-factory-onprem-file-system-connector.md)</li><li>[オンプレミス/Azure IaaS の Oracle データベース](data-factory-onprem-oracle-connector.md)</li><li>[オンプレミス/Azure IaaS の MySQL データベース ](data-factory-onprem-mysql-connector.md)</li><li>[オンプレミス/Azure IaaS の DB2 データベース](data-factory-onprem-db2-connector.md)</li><li>[オンプレミス/Azure IaaS の Teradata データベース ](data-factory-onprem-teradata-connector.md)</li><li>[オンプレミス/Azure IaaS の Sybase データベース](data-factory-onprem-sybase-connector.md)</li><li>[オンプレミス/Azure IaaS の PostgreSQL データベース](data-factory-onprem-postgresql-connector.md)</li></ul> | <ul><li>[Azure BLOB](data-factory-azure-blob-connector.md)</li><li>[Azure テーブル](data-factory-azure-table-connector.md)</li><li>[Azure SQL データベース](data-factory-azure-sql-connector.md)</li><li>[Azure SQL Data Warehouse](data-factory-azure-sql-data-warehouse-connector.md)</li><li>[Azure DocumentDB](data-factory-azure-documentdb-connector.md)</li><li>[Azure Data Lake Store](data-factory-azure-datalake-connector.md)</li><li>[SQL Server の内部設置型と Azure の IaaS](data-factory-sqlserver-connector.md)</li><li>[オンプレミス/Azure IaaS のファイル システム](data-factory-onprem-file-system-connector.md)</li></ul> |
