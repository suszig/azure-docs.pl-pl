...
|:--- |:--- |:--- |
| type | Właściwość type musi mieć ustawioną: **AzurePostgreSql** | Tak |
...
| Właściwość | Opis | Wymagane |
|:--- |:--- |:--- |
| type | Musi mieć ustawioną właściwość type źródła działania kopiowania: **AzurePostgreSqlSource** | Tak |
