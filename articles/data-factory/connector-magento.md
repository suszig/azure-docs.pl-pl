...
|:--- |:--- |:--- |
| type | Właściwość type musi mieć ustawioną: **Magento** | Tak |
| Host | Adres URL wystąpienia Magento. (to znaczy 192.168.222.110/magento3)  | Tak |
...
| Właściwość | Opis | Wymagane |
|:--- |:--- |:--- |
| type | Musi mieć ustawioną właściwość type źródła działania kopiowania: **MagentoSource** | Tak |
| query | Użyj niestandardowych zapytania SQL można odczytać danych. Na przykład: `"SELECT * FROM Customers"`. | Tak |
