...
---
# <a name="tutorial-create-a-pipeline-with-copy-activity-using-azure-powershell"></a>Samouczek: tworzenie potoku za pomocą działania kopiowania przy użyciu programu Azure PowerShell
