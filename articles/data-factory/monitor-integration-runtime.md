...
| Właściwość | Opis |
-------- | ------------- | 
| Nazwa | Nazwa środowiska uruchomieniowego integracji platformy Azure. |  
...
| Grupy zasobów o nazwie | Nazwa grupy zasobów, do której należy fabryki danych.  |
...
| W trybie offline | Środowisko uruchomieniowe integracja Azure jest w trybie offline z powodu błędu wewnętrznego. |
...
| Właściwość | Opis | 
| -------- | ----------- | 
| Nazwa | Nazwa środowiska uruchomieniowego integracji siebie i skojarzonych z nim węzłów. Węzeł jest na lokalnej maszynie systemu Windows ma środowiska uruchomieniowego integracji siebie na nim zainstalowany. |  
...
| Nieaktywne | Węzeł znajduje się w różnych konfiguracji innych węzłów większość konfiguracji. |
...
| Grupy zasobów o nazwie | Nazwa grupy zasobów Azure, w którym zostały utworzone z fabryki danych i środowiska uruchomieniowego integracji usług SSIS Azure. |
| DataFactoryName | Nazwa użytkownika fabryki danych Azure. |
| Nazwa | Nazwa Twojego środowiska uruchomieniowego integracji usług SSIS Azure. |
...
| Niedostępne | Ten węzeł nie jest gotowe do wdrożenia/wykonywania pakietów SSIS i można wykonać błędy/problemy, które można rozwiązać. |
