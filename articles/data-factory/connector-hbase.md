...
|:--- |:--- |:--- |
| type | Właściwość type musi mieć ustawioną: **HBase** | Tak |
| Host | Adres IP lub hosta nazwę serwera bazy danych HBase. (tj. 192.168.222.160)  | Tak |
...
| Typ authenticationType | Mechanizm uwierzytelniania na potrzeby łączenia się z serwerem bazy danych HBase. <br/>Dozwolone wartości to: **anonimowe**, **podstawowe** | Tak |
...
| Właściwość | Opis | Wymagane |
|:--- |:--- |:--- |
| type | Musi mieć ustawioną właściwość type źródła działania kopiowania: **HBaseSource** | Tak |
