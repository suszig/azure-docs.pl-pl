...
## [Indeks wszystkich artykułów](data-factory-alltopcat.md)
## Pojęcia
### [Zestawy danych](data-factory-create-datasets.md)
### [Potoki i działania](data-factory-create-pipelines.md)
### [Działania przenoszenia danych](data-factory-data-movement-activities.md)
### [Działania przekształcania danych](data-factory-data-transformation-activities.md)
...
## [Samouczek: przenoszenie danych ze środowiska lokalnego do chmury](data-factory-move-data-between-onprem-and-cloud.md)
## [Samouczek: tworzenie i używanie niestandardowych działań w potoku](data-factory-use-custom-activities.md)

# Instrukcje
## Przenoszenie danych
### [Kreator kopiowania w usłudze Data Factory](data-factory-copy-wizard.md)
### [Przekazywanie 1 TB danych w ciągu 15 minut przy użyciu kreatora kopiowania](data-factory-load-sql-data-warehouse.md)
### [Działanie kopiowania](data-factory-data-movement-activities.md)
### [Hybrydowe przenoszenie danych](data-factory-move-data-between-onprem-and-cloud.md)
### [Brama zarządzania danymi](data-factory-data-management-gateway.md)
### [Przewodnik dotyczący wydajności i dostosowywania działania kopiowania](data-factory-copy-activity-performance.md)
### [Azure Blob Storage](data-factory-azure-blob-connector.md)
### [Tabele platformy Azure](data-factory-azure-table-connector.md)
...
### [Źródła danych OData](data-factory-odata-connector.md)
### [Magazyny danych ODBC](data-factory-odbc-connector.md)
...
## Programowanie
### [Korzystanie z witryny Azure Portal](data-factory-copy-activity-tutorial-using-azure-portal.md)
...
### [Korzystanie z szablonu usługi Azure Resource Manager](data-factory-how-to-use-resource-manager-templates.md)
...
### [Korzystanie z witryny Azure Portal](data-factory-api-change-log.md)
...
### [Wdrażanie przy użyciu szablonów usługi Azure Resource Manager](data-factory-how-to-use-resource-manager-templates.md)
