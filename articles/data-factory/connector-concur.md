...
|:--- |:--- |:--- |
| type | Właściwość type musi mieć ustawioną: **Concur** | Tak |
| clientId | Dostarczona przez Zarządzanie aplikacjami cząstkowe client_id aplikacji.  | Tak |
| nazwa użytkownika | Nazwa użytkownika, który umożliwia dostęp do usługi cząstkowe.  | Tak |
...
| Właściwość | Opis | Wymagane |
|:--- |:--- |:--- |
| type | Musi mieć ustawioną właściwość type źródła działania kopiowania: **ConcurSource** | Tak |
| query | Użyj niestandardowych zapytania SQL można odczytać danych. Na przykład: `"SELECT * FROM Opportunities where Id = xxx "`. | Tak |
