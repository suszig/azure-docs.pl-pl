...
|:--- |:--- |:--- |
| type | Właściwość type musi mieć ustawioną: **Eloqua** | Tak |
| punkt końcowy | Punkt końcowy serwera Eloqua. (to znaczy eloqua.example.com)  | Tak |
| nazwa użytkownika | Nazwa lokacji i nazwa użytkownika konta Eloqua w postaci: nazwa użytkownika/nazwa witryny. (to znaczy Eloqua/Anna)  | Tak |
...
| Właściwość | Opis | Wymagane |
|:--- |:--- |:--- |
| type | Musi mieć ustawioną właściwość type źródła działania kopiowania: **EloquaSource** | Tak |
