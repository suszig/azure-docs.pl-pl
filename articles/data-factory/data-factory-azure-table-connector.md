...
**AzureTableSource** の typeProperties セクションでは次のプロパティがサポートされます。
 ...
 プロパティ| 説明| 使用できる値| 必須
-------- | ----------- | -------------- | --------
 azureTableSourceQuery| カスタム クエリを使用してデータを読み取ります。| <p>Azure テーブル クエリ文字列。</p>**例:**<br/> "azureTableSourceQuery":"PartitionKey eq 'DefaultPartitionKey'" <br/><br/>"azureTableSourceQuery":"$$text.format('partitionkey ('PartitionKey ge \\'{0:yyyyMMddHH00_0000}\\ 'と PartitionKey le \\'{0:yyyyMMddHH00_9999}\\')', SliceStart)"| いいえ
...
-------- | ----------- | -------------- | --------
 ...
 azureTableInsertType| Azure テーブルにデータを挿入する方法です。| マージ<br/>置き換えます| いいえ
