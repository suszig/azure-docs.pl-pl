<properties
    ...
    description="W tym samouczku przedstawiono tworzenie przykładowego potoku usługi Fabryka danych Azure przy użyciu programu Azure PowerShell."
...
Szczegółowe informacje znajdują się w artykule [Deprecation of Switch AzureMode in Azure PowerShell](https://github.com/Azure/azure-powershell/wiki/Deprecation-of-Switch-AzureMode-in-Azure-PowerShell) (Zakończenie obsługi polecenia Switch AzureMode w programie Azure PowerShell). 
