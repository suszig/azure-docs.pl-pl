...
- Chcesz połączyć się z lokalnymi magazynami danych z pakietów usług SSIS działającymi w środowisku Azure SSIS Integration Runtime.
 ...
 Usługa Azure Data Factory w wersji 2 (wersja zapoznawcza) umożliwia dołączenie środowiska Azure-SSIS Integration Runtime do klasycznej sieci wirtualnej. Obecnie usługa Azure Resource Manager w sieci wirtualnej nie jest obsługiwane. Jednak można nim działać jak pokazano w poniższej sekcji. 
