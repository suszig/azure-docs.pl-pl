...
|:--- |:--- |:--- |
| type | Właściwość type musi mieć ustawioną: **Przechodzenie do szczegółów** | Tak |
...
| Właściwość | Opis | Wymagane |
|:--- |:--- |:--- |
| type | Musi mieć ustawioną właściwość type źródła działania kopiowania: **DrillSource** | Tak |
