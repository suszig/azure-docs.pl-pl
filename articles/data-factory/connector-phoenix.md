...
|:--- |:--- |:--- |
| type | Właściwość type musi mieć ustawioną: **Phoenix** | Tak |
| Host | IP adres lub nazwę hosta serwera Phoenix. (to znaczy 192.168.222.160)  | Tak |
...
| Typ authenticationType | Mechanizm uwierzytelniania używany do łączenia się z serwerem Phoenix. <br/>Dozwolone wartości to: **anonimowe**, **UsernameAndPassword**, **WindowsAzureHDInsightService** | Tak |
...
| Właściwość | Opis | Wymagane |
|:--- |:--- |:--- |
| type | Musi mieć ustawioną właściwość type źródła działania kopiowania: **PhoenixSource** | Tak |
