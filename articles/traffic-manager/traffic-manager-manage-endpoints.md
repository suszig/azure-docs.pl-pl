...
>[AZURE.NOTE]  W tym artykule wyjaśniono, jak korzystać z klasycznego portalu. Klasyczny portal Azure obsługuje tylko tworzenie i przypisywanie usług w chmurze i aplikacji sieci Web jako punktów końcowych. Nowy [portal Azure](https://portal.azure.com) stanowi preferowany interfejs.
...
>[AZURE.NOTE] Wyłączenie punktu końcowego nie ma nic wspólnego z jego stanem wdrożenia na platformie Azure. Punkt końcowy w dobrej kondycji będzie nadal działać i będzie mógł odbierać ruch nawet po wyłączeniu w usłudze Traffic Manager. Ponadto wyłączenie punktu końcowego w jednym profilu nie wpływa na jego stan w innym profilu.
