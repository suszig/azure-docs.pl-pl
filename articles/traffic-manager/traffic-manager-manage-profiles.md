...
5. **トラフィック ルーティング方法を選びます。****[traffic routing Policy]** でトラフィック ルーティング方法を選びます。 トラフィック ルーティング方法の詳細については、次を参照してください。 [Traffic Manager に関するトラフィック ルーティング方法](traffic-manager-load-balancing-methods.md)します。
