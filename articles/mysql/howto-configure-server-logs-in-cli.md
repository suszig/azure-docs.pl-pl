...
Aby wyświetlić pliki dziennika dostępne na serwerze, uruchom [az mysql dzienniki serwera listy](/cli/azure/mysql/server-logs#list) polecenia.
...
[Pobierz dzienniki serwera az mysql](/cli/azure/mysql/server-logs#download) polecenie umożliwia pobieranie osobnych plikach dziennika dla serwera. 
