---
title: "Migracja online bazą danych Azure dla programu MySQL | Dokumentacja firmy Microsoft"
description: "W tym artykule opisano, jak wykonać migrację online bazy danych programu MySQL do bazy danych platformy Azure dla programu MySQL i jak skonfigurować ładowania początkowego i przeprowadź synchronizację z ciągłymi danymi ze źródłowej bazy danych do docelowej bazy danych przy użyciu replikacji Attunity Migrations firmy Microsoft."
services: mysql
author: HJToland3
ms.author: jtoland
manager: jhubbard
...
---
# <a name="online-migration-to-azure-database-for-mysql"></a>Migracja online bazą danych Azure dla programu MySQL
...
1. **Migrowanie schematu źródła MySQL** bazą danych Azure dla programu MySQL przy użyciu [MySQL Workbench](https://www.mysql.com/products/workbench/).

2. **Konfigurowanie ładowania początkowego i synchronizacji danych ciągłego źródłowej bazy danych do docelowej bazy danych** przy użyciu replikacji Attunity Migrations firmy Microsoft. Wykonanie tej tak minimalizuje czas, który źródłowej bazy danych musi być ustawiona jako tylko do odczytu podczas przygotowań do przełącznika aplikacji docelowej bazy danych MySQL na platformie Azure.
