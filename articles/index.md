                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <h3>Wprowadzenie — przewodnik dla deweloperów platformy Azure</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <h3>Wprowadzenie — przewodnik dla operatorów IT platformy Azure</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <h3>5-minutowe filmy wprowadzające</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>App Service</h3>
                                                    <p>Tworzenie aplikacji sieci Web i aplikacji mobilnych dla dowolnych platform i urządzeń</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <ul id="sdkstools">
                    <li>
                        ...
                        <ul id="sdkstools-all" class="cardsF">
                            ...
                            <li>
                                <div class="container">
                                    <h1>Interfejs wiersza polecenia (CLI)</h1>
                                </div>
                            </li>
                            <li>
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Azure CLI 2.0 (wersja zapoznawcza) </h3>
                                                <p>
                                                    <a href="/cli/azure/get-started/">Wprowadzenie</a>
                                                </p>
                                                <p>
                                                    <a href="https://github.com/Azure/azure-cli">Pobierz interfejs wiersza polecenia platformy Azure w wersji 2.0</a>
                                                </p>
                                                <p>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>PowerShell</h3>
                                                <p>
                                                    <a href="/azure/powershell-install-configure">Wprowadzenie</a>
                                                </p>
                                                <p>
                                                    <a href="https://github.com/PowerShell/PowerShell/blob/master/docs/installation/">Pobierz program PowerShell</a>
                                                </p>
                                                <p>
                                                    <a href="/powershell/">Dokumentacja</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="https://azure.microsoft.com/documentation/articles/azure-cli-arm-commands/">Dokumentacja</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <li>
                                <div class="container">
                                    <h1>Narzędzia i rozszerzenia</h1>
                                </div>
                            </li>
                            <li>
                                <div class="cardSize">
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="/en-us/dotnet/articles/core/docker/visual-studio-tools-for-docker">Wprowadzenie</a>
                                                </p>
                                                <p>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Wytyczne scenariusza</h3>
                                                    <p>Wytyczne dotyczące różnych kompleksowych scenariuszy aplikacji w chmurze. Zawiera pisemne wskazówki i przykładowe implementacje.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
