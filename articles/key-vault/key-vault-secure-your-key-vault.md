<properties
    pageTitle="Zabezpieczanie własnego magazynu kluczy | Microsoft Azure"
...
# Zabezpieczanie własnego magazynu kluczy
...
## Płaszczyzna zarządzania i płaszczyzna danych
...
## Kontrola dostępu do płaszczyzny zarządzania
...
>[AZURE.NOTE] Audytorzy muszą mieć uprawnienia do wyświetlania kluczy i wpisów tajnych, aby móc dokonywać inspekcji atrybutów kluczy i wpisów tajnych, które nie są emitowane w dziennikach, takich jak tagi oraz daty aktywacji i wygaśnięcia.
