...
![リソース ブレードとリソース グループのブレードの ](./media/azure-architecture-cpif-overview/overview.png)
...
[Azure ネットワー キング](https://gallery.technet.microsoft.com/Cloud-Platform-Integration-5e401f38)
