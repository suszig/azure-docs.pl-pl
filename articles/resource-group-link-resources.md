...
- タグで、リソースを整理することもできます。 リソースのタグを付ける方法については、次を参照してください。 [タグを使用して、リソースを整理する](resource-group-using-tags.md)です。
- テンプレートを作成してデプロイするリソースを定義する方法については、次を参照してください。 [テンプレートの作成](resource-group-authoring-templates.md)します。
