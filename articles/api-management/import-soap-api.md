---
title: "Importuj SOAP interfejsu API przy użyciu portalu Azure | Dokumentacja firmy Microsoft"
description: "Dowiedz się, jak zaimportować SOAP interfejsu API za pomocą interfejsu API zarządzania."
...
---
# <a name="import-soap-api"></a>Interfejs API SOAP importu

W tym artykule przedstawiono sposób importowania standardowej reprezentację XML SOAP API. Artykuł opisuje również sposób testowania APIM interfejsu API.

W tym artykule dowiesz się, jak:

> [!div class="checklist"]
> * Interfejs API SOAP importu
...
4. **Przekazywanego SOAP** przycisku radiowego jest domyślnie zaznaczona. Z tego wyboru interfejsu API ma być udostępniany jako protokołu SOAP. Konsument musi używać reguł protokołu SOAP. Jeśli chcesz "restify" interfejsu API, postępuj zgodnie z instrukcjami [zaimportować SOAP API i przekształcić ją w REST](restify-soap-api.md).

    ![Przekazywania](./media/import-soap-api/pass-through.png)
...
### <a name="test-the-new-apim-api-in-the-administrative-portal"></a>Testowanie nowy interfejs API APIM w portalu administracyjnego

Operacje można wywołać bezpośrednio z portalu administracyjnego oferują wygodny sposób, aby wyświetlić i przetestować operacje interfejsu API.  
