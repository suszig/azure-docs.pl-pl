...
+ Upewnij się, że istnieje aplikacji logiki w ramach subskrypcji. Aby uzyskać więcej informacji [tworzenie pierwszej aplikacji logiki](../logic-apps/logic-apps-create-a-logic-app.md)
