...
1. Z menu głównego po lewej stronie wybierz pozycję **Wszystkie usługi** (w górnej części listy).

    ![Opcja menu Wszystkie usługi](./media/devtest-lab-create-lab/more-services-menu-option.png)
