...
## <a name="supported-virtual-machine-size-families"></a>Rodziny rozmiar obsługiwanych maszyn wirtualnych
...
Podgląd stref dostępności jest dostępny w regionach Europa dla określonych usług platformy Azure i wschodnie stany USA 2. 
