...
[Jak IoT urządzenia może służyć jako brama] [ lnk-edge-as-gateway] artykuł zawiera koncepcyjnej overviwe jak urządzenia IoT mogą być używane jako przezroczysty bramy lub Wykonaj translację protokołu lub tożsamości. Ten artykuł zawiera szczegółowe instrukcje dotyczące używania urządzenia IoT jako przezroczysty bramy. W pozostałej części niniejszego artykułu *brama brzegowa IoT* jest IoT urządzenia używane jako przezroczysty bramy.
