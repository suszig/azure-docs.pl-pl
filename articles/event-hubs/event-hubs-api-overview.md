...
監視シナリオは管理とランタイムの両方にまたがります。 .NET Api に関する詳細なリファレンス ドキュメントについては、次を参照してください。、 [.NET クラス ライブラリ](https://msdn.microsoft.com/library/azure/mt419900.aspx) と [EventProcessorHost API](https://msdn.microsoft.com/library/azure/mt445521.aspx) 参照します。
