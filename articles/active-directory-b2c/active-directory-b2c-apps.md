...
### <a name="daemonsserverside-apps"></a>Demony/aplikacje po stronie serwera
...
### <a name="web-api-chains-onbehalfof-flow"></a>Łańcuchy interfejsu API sieci Web (przepływ „w imieniu”)
