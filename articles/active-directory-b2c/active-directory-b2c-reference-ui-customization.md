...
指定した Azure Blob ストレージでホストされているサンプル HTML と CSS コンテンツを使用して、ユーザー エクスペリエンスのカスタマイズ機能を試す場合は、 [単純なヘルパー ツール](active-directory-b2c-reference-ui-customization-helper-tool.md) にアップロードして静的コンテンツを構成します。
...
- セキュリティ上の理由から、コンテンツに JavaScript を含めることはできません。 必要なものの多くは既に用意されているはずです。 ない場合を使用してください [User Voice](http://feedback.azure.com/forums/169401-azure-active-directory) を新しい機能を要求します。
