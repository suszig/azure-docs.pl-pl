...
テストするには、任意のサインイン ポリシー (ID プロバイダーがローカル アカウントのもの) で [今すぐ実行] 機能を使用します。 ローカル アカウントでサインインのページ (ここで入力する電子メール アドレスとパスワードまたはユーザー名とパスワード)、をクリックして **アカウントにアクセスできないでしょうか。** コンシューマーのエクスペリエンスを確認します。
