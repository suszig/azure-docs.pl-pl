...
1. (省略可能) サービス構成の名前を変更するには、[名前] ボックスの一覧から新しいサービス構成を選択し、**[名前の変更]** をクリックします。 **[名前]** ボックスに、このサービス構成に使用する名前を入力し、**[OK]** をクリックします。
    ...
    &Gt;.cscfg という新しいサービス構成ファイル。<New Name>.cscfg がソリューション エクスプ ローラーで Azure プロジェクトに追加します。
...
1. プロファイルを作成した後にをクリックして * *<Manage…>* * で、 **profile を対象に** ] ボックスの一覧です。
...
1. **[前へ]** と **[次へ]** をクリックして発行ウィザードの各ページを表示し、このプロファイルの設定をカスタマイズします。 参照してください [Azure アプリケーションの発行ウィザード](http://go.microsoft.com/fwlink/p/?LinkID=623085) についてです。
...
1. **[前へ]** と **[次へ]** をクリックして発行ウィザードの各ページを表示し、目的の設定を変更します。 参照してください [Azure アプリケーションの発行ウィザード](http://go.microsoft.com/fwlink/p/?LinkID=623085) についてです。
...
Visual Studio から Azure のプロジェクトの他の部分を構成する詳細については、を参照してください [Azure プロジェクトの構成](http://go.microsoft.com/fwlink/p/?LinkID=623075)。
