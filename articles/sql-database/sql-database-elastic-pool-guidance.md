...
エラスティック データベース プールの価格は、プール eDTU によって変わります。 プールは単一のデータベースの DTU 単価よりも大きい x 1.5 の eDTU の単価を while **プール Edtu より少ない合計 Edtu が必要な多くの場合などの多くのデータベースで共有できる**です。 これらの価格と eDTU 共有の特徴が、プールで節約を可能にするベースとなります。  
