...
Są to ręcznej metody, ponieważ potrzebne do podejmowania decyzji [warstw usług](sql-database-service-tiers.md) należy wybrać lub trzeba ponownie pisać kodu aplikacji lub bazy danych i deply zmiany.
