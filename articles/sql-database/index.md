---
title: "Dokumentacja usługi Azure SQL Database — samouczki i dokumentacja interfejsu API | Microsoft Docs"
description: "Dowiedz się, jak używać baz danych Azure SQL."
...
---
<div class="content">
    <h1>Dokumentacja usługi SQL Database</h1>
    <div class="introHolder" style="justify-content: space-between;">
        <div class="intro" style="min-width: 200px">
            <p>Usługa Azure SQL Database to relacyjna baza danych oferowana jako usługach, która korzysta z aparatu programu Microsoft SQL Server. Usługa SQL Database to wysokiej wydajności niezawodna i bezpieczna baza danych, za pomocą której można tworzyć oparte na danych aplikacje i witryny internetowe w wybranym języku programowania bez zarządzania infrastrukturą. Dowiedz się, jak używać usługi SQL Database, korzystając z przewodników Szybki Start, samouczków i przykładów.</p>
        </div>
        <a href="https://azure.microsoft.com/en-us/resources/videos/create-sql-database-on-azure/">
            <div class="calloutHolder" style="max-width: 250px">
                ...
                <div>
                    <p style="margin-top: 0; color: #6e6e6e">Tworzenie bazy danych SQL na platformie Azure. (3:12)</p>
                </div>
            </div>
        </a>
    </div>
<h2 style="margin-top: 18px; margin-bottom: 0px;">5-minutowe przewodniki Szybki start</h2>
<p style="margin-top: 6px; margin-bottom: 6px;">Dowiedz się, jak utworzyć bazę danych SQL, zarządzać nią za pomocą narzędzia SQL Management Studio i programować z jej użyciem w językach C#, Java, Python, Node.js i Ruby:</p>
<div class="ico48Case">
    <div class="ico48Link">
    ...
    <div class="ico48Link">
        <a href="/azure/sql-database/sql-database-get-started-cli">
            ...
            <span>Interfejs wiersza polecenia platformy Azure</span>
        </a>
    </div>
    <div class="ico48Link">
...
<p>Dowiedz się, jak tworzyć i migrować bazy danych oraz zarządzać nimi za pomocą usługi SQL DB</p>
<ol>
    <li><a href="/azure/sql-database/sql-database-design-first-database">Tworzenie i projektowanie schematu dla nowej bazy danych SQL</a></li>
    <li><a href="/azure/sql-database/sql-database-migrate-your-sql-server-database">Migrowanie istniejącej bazy danych programu SQL Server do używania w usłudze Azure SQL Database</a></li>
</ol>

<h2 style="margin-top: 36px">Bezpłatne szkolenie wideo firmy PluralSight</h2>
                ...
                <div class="cardPadding">
                    <div class="card">
                       <div class="cardImageOuter">
                        ...
                        <div class="cardText">
                            <p>Programowanie przy użyciu platformy .NET</p>
                        </div>
                    </div>
                </div>
            </div>
...
<h2 style="margin-top: 36px">Przykłady</h2>
<p>Znajdowanie skryptów umożliwiających zarządzanie typowymi zadaniami</p>
<ul class="spaced">
    <li><a href="/azure/sql-database/sql-database-cli-samples">Interfejs wiersza polecenia platformy Azure</a></li>
    <li><a href="/azure/sql-database/sql-database-powershell-samples">Azure PowerShell</a></li>
</ul>

<h2 style="margin-top: 36px">Dokumentacja</h2>
<ul class="panelContent cardsW">
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="/powershell/elasticdatabasejobs/v0.8.33/elasticdatabasejobs">Azure PowerShell (elastyczna baza danych)</a></p>
                        <p><a href="/cli/azure/sql">Interfejs wiersza polecenia platformy Azure 2.0</a></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3><a href="https://msdn.microsoft.com/library/mt238365.aspx">Narzędzia programu SQL Server</a></h3>
                        ...
                        <p><a href="https://www.nuget.org/packages/Microsoft.Azure.Management.Sql">Pakiet biblioteki zarządzania usługi SQL Database</a></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3><a href="https://msdn.microsoft.com/library/mt654049.aspx">Sterowniki programu SQL Server</a></h3>
