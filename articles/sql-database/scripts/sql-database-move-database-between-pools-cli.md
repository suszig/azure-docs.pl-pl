...
| [Utwórz az programu sql server](https://docs.microsoft.com/cli/azure/sql/server#az_sql_server_create) | Tworzy serwer logiczny, który jest hostem bazy danych lub elastyczna pula. |
| [Utwórz sql az elastyczna pule](https://docs.microsoft.com/cli/azure/sql/elastic-pool#az_sql_elastic_pool_create) | Tworzy elastycznej puli w ramach serwera logicznego. |
| [Tworzenie bazy danych sql az](https://docs.microsoft.com/cli/azure/sql/db#az_sql_db_create) | Tworzy bazę danych w serwera logicznego jako jedną lub puli bazy danych. |
| [Aktualizacja bazy danych sql az](https://docs.microsoft.com/cli/azure/sql/db#az_sql_db_update) | Aktualizuje właściwości bazy danych lub bazy danych są przenoszone do z i między pule elastyczne. |
