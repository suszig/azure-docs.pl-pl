...
---
# <a name="use-powershell-to-import-a-pacpac-file-into-an-azure-sql-database"></a>Importowanie pliku PACPAC do bazy danych Azure SQL przy użyciu programu PowerShell
