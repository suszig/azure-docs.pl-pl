...
- **Microsoft SQL Server 2008 R2 SP1 System CLR Types (x86)**
 ...
 Microsoft SQL Server 2008 R2 SP1 System CLR Types (x86)からをインストールする  [ここ](http://www.microsoft.com/download/en/details.aspx?id=26728)

- **Microsoft SQL Server 2008 R2 SP1 Shared Management Objects (x86)**

 Microsoft SQL Server 2008 R2 SP1 共有管理オブジェクト (x86)からをインストールする [ここ](http://www.microsoft.com/download/en/details.aspx?id=26728)
...
* [完全な SQL データ同期のテクニカル ドキュメントをダウンロードします。](http://download.microsoft.com/download/4/E/3/4E394315-A4CB-4C59-9696-B25215A19CEF/SQL_Data_Sync_Preview.pdf)
* [SQL Database の概要](sql-database-technical-overview.md)
* [データベース ライフ サイクル管理](https://msdn.microsoft.com/library/jj907294.aspx)
