...
このトピックでは Python で記述されたコード サンプルについて説明します。 サンプルは、Windows コンピューター上で実行されます。 このサンプルを使用して Azure SQL Database に接続して、 **pymssql** ドライバー。
...
インストール [pymssql](http://www.lfd.uci.edu/~gohlke/pythonlibs/#pymssql)します。
...
Pip の使用を有効にする手順を参照して [ここで](http://stackoverflow.com/questions/4750806/how-to-install-pip-on-windows)
