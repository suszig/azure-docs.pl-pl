...
機能は、Azure SQL の一部を [Database 弾力性データベースの機能セット](sql-database-elastic-scale.md)します。
...
* [マスター_キーを作成します。](https://msdn.microsoft.com/library/ms174382.aspx)

* [データベース スコープを作成する資格情報](https://msdn.microsoft.com/library/mt270260.aspx)

* [外部データ ソースの作成/削除](https://msdn.microsoft.com/library/dn935022.aspx)

* [外部テーブルの作成/削除](https://msdn.microsoft.com/library/dn935021.aspx)
...
* SHARDED は、シャード マップ内のデータベース間でこのテーブルのデータが行方向にパーティション分割されることを意味します。データの分布のパーティション分割キーがキャプチャされた、 <sharding_column_name> パラメーター。
