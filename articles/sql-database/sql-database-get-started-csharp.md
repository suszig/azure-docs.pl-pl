...
C# コマンドを使用して、使用した Azure SQL database を作成する方法について、 [Azure SQL Database Library for .NET](https://www.nuget.org/packages/Microsoft.Azure.Management.Sql)します。

SQL と C# で 1 つのデータベースを作成して、SQL Database を試してみます。 弾力性データベースを作成するを参照してください。 [弾力性データベース プールを作成する](sql-database-elastic-pool-portal.md)します。
...
- [接続し、c# を使用して SQL データベースの照会](sql-database-connect-query.md)
