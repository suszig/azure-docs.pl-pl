...
3. クリックして **Data Services**します。

4. クリックして **SQL データベース**します。
...
8. Server では、次のように選択します。 **新しい SQL データベース サーバー**します。 
...
13. 保管しておいてください、 **Azure サービスをサーバーにアクセスする許可** オプションが選択されているので、SQL データベース、ストレージ サービス、および他のサービスを Azure クラシック ポータルを使用してこのデータベースに接続することができます。 
...
1. クリックして **SQL データベース**, 、] をクリックして **サーバー** 上部のページ、および作成するサーバーをクリックします。
...
7. クリックして **保存** の手順を完了にページの下部にあります。 表示されない場合 **保存**, 、ブラウザーのページを更新します。
