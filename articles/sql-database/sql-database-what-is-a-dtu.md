...
* Zobacz [Warstwy usługi](sql-database-service-tiers.md), aby uzyskać informacje na temat jednostek DTU i eDTU dostępnych dla pojedynczych baz danych i pul elastycznych.
