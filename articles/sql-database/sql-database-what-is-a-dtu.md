<properties
    pageTitle="Usługa SQL Database: Co to jest jednostka DTU? | Microsoft Azure"
...
# Wyjaśnienie jednostek DTU (Database Transaction Units) i eDTU (elastic Database Transaction Units)
...
## Co to są jednostki DTU (Database Transaction Unit)
...
## Co to są jednostki eDTU (elastic Database Transaction Unit)
...
## Jak określić wymaganą liczbę jednostek DTU dla mojego obciążenia?
...
## Jak sprawdzić, czy elastyczna pula zasobów jest dla mnie korzystnym rozwiązaniem?
...
## Co się stanie po osiągnięciu limitu jednostek DTU?
