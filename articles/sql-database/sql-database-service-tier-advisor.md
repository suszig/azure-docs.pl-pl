...
- [サービス階層とパフォーマンス レベル (価格レベル)、SQL データベースの変更します。](sql-database-scale-up.md)
- [Azure SQL サーバーを V12 にアップグレードします。](sql-database-v12-upgrade.md)
...
価格レベルの提案を受けるには、既存の Web または Business データベースを選択し、**[価格レベル]** タイルをクリックします。 (価格レベルの提案も利用可能な場合に、 [V12 にアップグレードの Azure SQL server](sql-database-v12-upgrade.md).)
