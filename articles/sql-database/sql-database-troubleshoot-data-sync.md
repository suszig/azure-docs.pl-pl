...
## <a name="troubleshooting-sync"></a>Rozwiązywanie problemów z synchronizacji
...
## <a name="troubleshooting-the-client-agent"></a>Rozwiązywanie problemów z agentem klienta
...
-   Utwórz nowy agent, w tym samym centrum danych jako grupy synchronizacji. Następnie przeprowadź rejestrację bazy danych z tego agenta.
...
## <a name="troubleshooting-setup-and-maintenance"></a>Rozwiązywanie problemów z instalacja i konserwacja
...
3. Dodaj konto użytkownika w **Zaloguj jako usługa** **właściwości** okno dialogowe.
...
W przypadku utraty lub uszkodzenia bazy danych można przywrócić z kopii zapasowej, może być z systemem innym niż zbieżność danych w grupy synchronizacji, do którego należy bazy danych.
