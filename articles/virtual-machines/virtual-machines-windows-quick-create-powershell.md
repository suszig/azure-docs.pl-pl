...
Utwórz sieciową grupę zabezpieczeń i regułę sieciowej grupy zabezpieczeń. Sieciowa grupa zabezpieczeń chroni maszynę wirtualną za pomocą reguł ruchu przychodzącego i wychodzącego. W tym przypadku jest tworzona reguła ruchu przychodzącego dla portu 3389, która umożliwia nawiązywanie przychodzących połączeń pulpitu zdalnego.
...
[Przegląd przykładowych poleceń programu PowerShell umożliwiających wdrożenie maszyny wirtualnej](./virtual-machines-windows-powershell-samples.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)
