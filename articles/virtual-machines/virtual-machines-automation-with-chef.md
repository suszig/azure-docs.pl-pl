...
開始する前に Chef の基本的な概念を確認しておくことをお勧めします。 優れた資料がある <a href="http://www.chef.io/chef" target="_blank">ここ</a> し、このチュートリアルを開始する前にクイック読み取りがあることをお勧めします。 基礎については開始する前に要約します。
