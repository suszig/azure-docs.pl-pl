...
| Azure CLI 2.0 (wersja zapoznawcza) | Aby podać identyfikator wcześniej utworzonego publicznego adresu IP, użyj polecenia [az network nic create](https://docs.microsoft.com/cli/azure/network/nic#create) z parametrem **--public-ip-address**. |
| [Interfejs wiersza polecenia platformy Azure](../virtual-network/virtual-network-deploy-multinic-arm-cli.md) | Aby podać identyfikator wcześniej utworzonego publicznego adresu IP, użyj polecenia **azure network nic create** z parametrem **--public-ip-address**. |
...
| Azure CLI 2.0 (wersja zapoznawcza) | Użyj polecenia [az network public-ip create](https://docs.microsoft.com/cli/azure/network/public-ip#create) z parametrem **--allocation-method** jako dynamicznym lub statycznym. |
| [Interfejs wiersza polecenia platformy Azure](../virtual-network/virtual-network-deploy-static-pip-arm-cli.md) | Użyj polecenia **azure network public-ip create** z parametrem **--allocation-method** jako dynamicznym lub statycznym. |
...
| Azure CLI 2.0 (wersja zapoznawcza) | Podsieć i sieć wirtualna są tworzone jednocześnie. Użyj polecenia [az network vnet create](https://docs.microsoft.com/cli/azure/network/vnet#create) z parametrem**--subnet-name**, podając nazwę podsieci. |
| [Interfejs wiersza polecenia platformy Azure](../virtual-network/virtual-networks-create-vnet-arm-cli.md) | Użyj polecenia **azure network vnet create** z parametrem**-n**, podając nazwę podsieci. |
...
| Azure CLI 2.0 (wersja zapoznawcza) | Użyj polecenia [az network nsg create](https://docs.microsoft.com/cli/azure/network/nsg#create), aby utworzyć początkową sieciową grupę zabezpieczeń. Użyj polecenia [az network nsg rule create](https://docs.microsoft.com/cli/azure/network/nsg/rule#create), aby dodać reguły do sieciowej grupy zabezpieczeń. Użyj polecenia [az network vnet subnet update](https://docs.microsoft.com/en-us/cli/azure/network/vnet/subnet#update), aby dodać sieciową grupę zabezpieczeń do podsieci. |
| [Interfejs wiersza polecenia platformy Azure](../virtual-network/virtual-networks-create-nsg-arm-cli.md) | Użyj polecenia **azure network nsg create**, aby utworzyć początkową sieciową grupę zabezpieczeń. Użyj polecenia **azure network nsg rule create**, aby dodać reguły do sieciowej grupy zabezpieczeń. Użyj polecenia **azure network vnet subnet update**, aby dodać sieciową grupę zabezpieczeń do podsieci. |
...
| [Interfejs wiersza polecenia platformy Azure](../load-balancer/load-balancer-get-started-ilb-arm-cli.md) | Użyj polecenia **azure network lb create**, aby utworzyć początkową konfigurację modułu równoważenia obciążenia. Użyj polecenia **azure network lb frontend-ip create** z parametrem **--private-ip-address**, aby zdefiniować prywatny adres IP. Użyj polecenia **azure network lb address-pool create**, aby dodać konfigurację puli adresów zaplecza. Użyj polecenia **azure network lb inbound-nat-rule create**, aby dodać reguły NAT. Użyj polecenia **azure network lb rule create**, aby dodać reguły modułu równoważenia obciążenia. Użyj polecenia **azure network lb probe create**, aby dodać sondy.|
