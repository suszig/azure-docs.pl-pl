...
- 別の VM サイズの VM のサイズを変更します。<br>
    [すべて参照]、[仮想マシン (クラシック)]、仮想マシン、[設定]、**[サイズ]** の順にクリックします。 詳細については、「 [仮想マシン サイズを変更する](https://msdn.microsoft.com/library/dn168976.aspx)します。
...
> [AZURE.NOTE] 割り当てシナリオごとに示されているエラーは、省略形です。 参照してください、 [付録](#appendix) 文字列の詳細なエラーです。
...
サーバーで内部エラーが発生しました。 要求し直してください。" または、"サービスの割り当てを作成できませんでした。
