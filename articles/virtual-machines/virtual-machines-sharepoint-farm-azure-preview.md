...
SharePoint のサーバーの全体管理サイトで [My Sites]、SharePoint アプリケーション、その他の機能を構成できます。 詳細については、次を参照してください。 [SharePoint 2013 を構成する](http://technet.microsoft.com/library/ee836142.aspx)します。
