...
仮想マシンは、テンプレートを使ってすばやく作成できます。 これらのテンプレートだけでなくテンプレートを探すことができます] (https://azure.microsoft.com/documentation/templates/)。
...
上に、利用できるすべてのテンプレートの検出 [GitHub](https://github.com/Azure/azure-quickstart-templates)します。

詳細について [Azure リソース マネージャー](../resource-group-template-deploy.md)します。
