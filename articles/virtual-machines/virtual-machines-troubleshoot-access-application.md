...
- ネットワーク セキュリティ グループで、リクエスト受信と応答送信のトラフィックが許可されているかどうか。 詳細については、を参照してください [ネットワーク セキュリティ グループ (NSG) は何ですか?](virtual-networks-nsg.md)。.
...
[Windows ベースの Azure 仮想マシンへのリモート デスクトップ接続のトラブルシューティングを行う](virtual-machines-troubleshoot-remote-desktop-connections.md)
