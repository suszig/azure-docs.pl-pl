    ...
    <div class="calloutHolder">
        <div class="callout">
            <a href="https://azure.microsoft.com/community/training/courses/managing-infrastructure-microsoft-azure-getting-started/">
                <img src="media/index/pluralsight.svg" /> Free PluralSight video training - Managing Infrastructure using Microsoft Azure </a>
         (Bezpłatne szkolenie wideo firmy PluralSight — Zarządzanie infrastrukturą za pomocą platformy Microsoft Azure)</div>
    </div>
</div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Tworzenie maszyny wirtualnej z systemem Linux przy użyciu interfejsu wiersza polecenia platformy Azure 2.0</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Tworzenie maszyny wirtualnej przy użyciu portalu</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Informacje o maszynie wirtualnej z systemem Linux</h3>
                    </div>
                </div>
            </div>
        </div>
