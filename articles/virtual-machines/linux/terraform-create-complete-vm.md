...
Po zakończeniu Terraform infrastruktury maszyna wirtualna jest gotowa. Publiczny adres IP maszyny wirtualnej z [az maszyny wirtualnej pokazu](/cli/azure/vm#show):
