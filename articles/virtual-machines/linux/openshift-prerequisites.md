...
Zaloguj się do Twojej subskrypcji platformy Azure z [logowania az](/cli/azure/reference-index#az_login) polecenia i wykonaj na ekranie wskazówek, lub kliknij przycisk **wypróbuj** użycia chmury powłoki.
