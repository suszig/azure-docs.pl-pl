...
[アーティクル] をクリックして  [拡張機能のテンプレートの作成](virtual-machines-extensions-authoring-templates.md) 拡張機能を使用するためのテンプレートの作成に関する詳細。
...
「Azure vm get からインスタンス ビューの」の出力の拡張機能の種類に「パブリッシャー名」対応場所
名前は、テンプレートからの拡張機能リソースの名前と
