...
Zaplanowane zdarzenia jest dostępna dla maszyn wirtualnych systemu Windows i Linux. Informacje o zdarzeniach zaplanowane w systemie Linux, zobacz [zaplanowane zdarzenia dla maszyn wirtualnych systemu Linux](../linux/scheduled-events.md).
