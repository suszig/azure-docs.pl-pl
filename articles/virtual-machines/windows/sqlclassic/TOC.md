...
### [Rozszerzanie lokalnej grupy dostępności na platformę Azure](virtual-machines-windows-classic-sql-onprem-availability.md)
## Zarządzanie
### [Korzystanie z rozszerzenia agenta IaaS w programie SQL Server](virtual-machines-windows-classic-sql-server-agent-extension.md)
...
### [Korzystanie z programu Azure PowerShell do tworzenia maszyny wirtualnej platformy Azure z serwerem raportów](virtual-machines-windows-classic-ps-sql-report.md)
