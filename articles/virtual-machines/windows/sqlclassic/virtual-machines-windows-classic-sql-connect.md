...
Można tworzyć wiele maszyn wirtualnych w tej samej usłudze w chmurze. Aby zrozumieć, w tym scenariuszu maszyn wirtualnych, zobacz [sposób nawiązywania połączenia z usługą wirtualnych sieci lub w chmurze maszyn wirtualnych](../classic/connect-vms.md#connect-vms-in-a-standalone-cloud-service). Ten scenariusz jest podczas próby nawiązania połączenia programu SQL Server uruchomionego na innej maszynie wirtualnej w tej samej usłudze w chmurze klienta na jednej maszynie wirtualnej.
