...
Alokowanie nowej maszyny wirtualnej jest proste, a system Azure oferuje szeroką gamę rozmiarów maszyn wirtualnych.  Podobnie jak w przypadku dowolnego zakupów sprzętu ma być saldo wydajności i kosztów.  Ponieważ program Visual Studio jest aplikacji zaawansowane, wielowątkowych, ma rozmiar maszyny Wirtualnej, która zawiera co najmniej 2 procesorów i 7 GB pamięci.  Poniżej przedstawiono zalecane rozmiary maszyny Wirtualnej dla obrazów programu Visual Studio:
