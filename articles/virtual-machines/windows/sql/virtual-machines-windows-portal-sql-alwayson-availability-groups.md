...
7. **Pulpit zdalny** może ostrzeżenie, że komputer zdalny nie można uwierzytelnić z powodu problemów z jego certyfikatem zabezpieczeń. Przedstawia on nazwę certyfikatu zabezpieczeń. Po wykonaniu tego samouczka jest nazwa **sqlserver 0.contoso.com**. Kliknij przycisk **Yes** (Tak).
