...
| [Azure PowerShell](../../virtual-network/virtual-network-deploy-multinic-arm-ps.md) | Użyj polecenia [New-AzureRmNetworkInterface](/powershell/module/azurerm.network/new-azurermnetworkinterface) z parametrem **-PublicIpAddressId** umożliwiającym podanie identyfikatora wcześniej utworzonego publicznego adresu IP. |
...
| [Azure PowerShell](../../virtual-network/virtual-network-deploy-static-pip-arm-ps.md) | Użyj polecenia [New-AzureRmPublicIpAddress](/powershell/module/azurerm.network/new-azurermpublicipaddress) z parametrem **-AllocationMethod** jako dynamicznym lub statycznym. |
...
| [Azure PowerShell](../virtual-machines-windows-ps-create.md) | Obejmuje użycie polecenia [Add-AzureRmVMNetworkInterface](/powershell/module/azurerm.compute/add-azurermvmnetworkinterface) w celu dodania wcześniej utworzonej karty sieciowej do konfiguracji maszyny wirtualnej. |
