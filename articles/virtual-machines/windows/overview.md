...
| Azure PowerShell |Aby dowiedzieć się więcej o zarządzaniu maszynami wirtualnymi za pomocą programu PowerShell, zobacz artykuł [Manage Azure Virtual Machines using Resource Manager and PowerShell](ps-manage.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json) (Zarządzanie maszynami wirtualnymi na platformie Azure za pomocą usługi Resource Manager i programu PowerShell). |
