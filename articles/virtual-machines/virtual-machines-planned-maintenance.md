...
Sla の詳細については、の「クラウド サービス、仮想マシンおよび仮想ネットワーク」セクションを参照してください [サービス レベル アグリーメント](http://azure.microsoft.com/support/legal/sla/)します。
...
この計画的メンテナンス イベントは、この種の仮想マシン構成を使用するアプリケーションの可用性に影響を及ぼします。 Azure では、単一インスタンス構成内の仮想マシンの計画的なメンテナンスについての 1 週間高度な通知を提供します。
