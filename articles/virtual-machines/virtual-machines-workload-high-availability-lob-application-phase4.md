...
進むには、このフェーズを完了する必要があります [フェーズ 5](virtual-machines-workload-high-availability-LOB-application-phase5.md)します。 参照してください [、高可用性の基幹業務アプリケーションで、Azure のデプロイ](virtual-machines-workload-high-availability-LOB-application-overview.md) の全フェーズ。
