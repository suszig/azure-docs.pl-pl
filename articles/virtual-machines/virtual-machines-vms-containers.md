...
コンテナー テクノロジが新たなメリットをもたらすことは一般的な観点からも明らかですが、事業部単位でもさまざまなメリットが期待できます。 Docker コンテナーの例で見てみましょう。 このトピックはないについて深く掘り下げる Docker 今 (を読み取る [What is Docker?](https://www.docker.com/whatisdocker/) そのストーリーのまたは [wikipedia](http://wikipedia.org/wiki/Docker_%28software%29)), 、Docker とそのエコシステムは開発者と IT プロフェッショナルの両方に大きなメリットを提供します。
...
Docker は、独自の VM 作成ツールのセット ([docker マシン](virtual-machines-docker-machine.md)) と、負荷分散、docker コンテナー クラスター管理ツール ([swarm](virtual-machines-docker-swarm.md))します。 さらに、 [Azure Docker VM 拡張機能](https://github.com/Azure/azure-docker-extension/blob/master/README.md) に対する既定のサポートが付属 [`docker-作成`] (https://docs.docker.com/compose/) デプロイできる、複数のコンテナー アプリケーション コンテナーが構成されています。
...
- [コンテナーを開いているプロジェクト](http://opencontainers.org/)
...
- [Visual Studio 2015 RC Tools for Docker - プレビュー](https://visualstudiogallery.msdn.microsoft.com/6f638067-027d-4817-bcc7-aa94163338f0)
...
- [Azure の Docker VM 拡張機能のユーザー ガイド](https://github.com/Azure/azure-docker-extension/blob/master/README.md)
...
- [Azure のリソース グループ テンプレートを使用して、Azure で Docker ホストをすばやく作成するには](https://github.com/Azure/azure-quickstart-templates/tree/master/docker-simple-on-ubuntu)
- [の組み込みサポート `作成`] (https://github.com/Azure/azure-docker-extension#11-public-configuration-keys) 含まれているアプリケーションの
- [Azure 上の Docker プライベート レジストリを実装します。](virtual-machines-docker-registry-on-azure-blob-storage.md)
...
-   Deis
    - [3 ノードの Azure VM グループを作成、Deis のインストール、Hello World Go アプリケーションを起動し、](virtual-machines-deis-cluster.md)
...
-   [Azure オートメーション](http://azure.microsoft.com/services/automation/)
