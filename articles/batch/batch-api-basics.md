<properties
    pageTitle="Omówienie funkcji usługi Azure Batch dla deweloperów | Microsoft Azure"
...
> [AZURE.TIP] Bardziej szczegółowe wprowadzenie do usługi Batch można znaleźć w temacie [Podstawy usługi Azure Batch](batch-technical-overview.md).
...
- [Zadanie](#task)
  ...
  - [Zadanie uruchamiania](#start-task)
  - [Zadanie Menedżera zadań](#job-manager-task)
  - [Zadania przygotowania i zwolnienia zadań](#job-preparation-and-release-tasks)
...
- [Zadanie Menedżera zadań](#job-manager-task)
- [Zadania przygotowania i zwolnienia zadań](#job-preparation-and-release-tasks)
- [Zadania obejmujące wiele wystąpień](#multi-instance-tasks)
- [Zależności zadań](#task-dependencies)
...
>[AZURE.IMPORTANT] Gdy węzeł zostanie usunięty z puli, zostaną *usunięte* wszystkie pliki przechowywane w węźle.
...
>[AZURE.NOTE] W przypadku dodawania pakietów aplikacji na poziomie puli do *istniejącej* puli musisz ponownie uruchomić jej węzły obliczeniowe dla pakietów aplikacji do wdrożenia w węzłach.
...
>[AZURE.IMPORTANT] Aby połączyć się z węzłem za pośrednictwem protokołu RDP lub SSH, musisz najpierw utworzyć użytkownika w węźle. W tym celu możesz użyć portalu Azure, [dodać konto użytkownika do węzła][rest_create_user] za pomocą interfejsu API REST usługi Batch, wywołać metodę [ComputeNode.CreateComputeNodeUser][net_create_user] na platformie .NET usługi Batch lub wywołać metodę [add_user][py_add_user] w module języka Python usługi Batch.
