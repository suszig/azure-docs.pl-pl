...
**Skalowanie w poziomie równoległej aplikacji do platformy Azure**<br/><br/>[![Azure Batch][batch_proc]](./media/batch-hpc-solutions/batch_proc.png)<br/><br/>Więcej informacji:<br/>• [Podstawy usługi Azure Batch](./batch-technical-overview.md)<br/><br/>• [Wprowadzenie do biblioteki usługi Azure Batch dla środowiska .NET](./batch-dotnet-get-started.md)|• Projektowanie za pomocą usługi [Azure Batch](https://azure.microsoft.com/documentation/services/batch/) w celu skalowania w poziomie różnych obciążeń funkcji dużych obliczeń i uruchamiania ich w pulach maszyn wirtualnych z systemem Windows lub Linux.<br/><br/>• Wykorzystanie usługi platformy Azure do zarządzania wdrażaniem i automatycznym skalowaniem maszyn wirtualnych, harmonogramem zadań, odzyskiwaniem po awarii, przenoszeniem danych, zarządzaniem zależnościami i wdrażaniem aplikacji.|• Nie chcesz zarządzać zasobami obliczeniowymi ani harmonogramem zadań. Zamiast tego chcesz skupić się na uruchamianiu aplikacji.<br/><br/>• Chcesz odciążyć aplikację wymagającą intensywnych obliczeń, aby była uruchamiania jako usługa w chmurze.<br/><br/>• Chcesz automatycznie skalować zasoby obliczeniowe, aby odpowiadały obciążeniu obliczeniowemu.
