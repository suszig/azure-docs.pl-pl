...
1. Postępuj zgodnie z instrukcjami dwóch pierwszych [jak skompilować i uruchomić prosty program MS-MPI][msmpi_howto]. Spełnia on prerequesites dla następny krok.
...
5. *Opcjonalne*: Użyj [portalu Azure] [ portal] lub [Explorer partii] [ batch_explorer] do sprawdzenia puli próbki, zadań i zadań (" MultiInstanceSamplePool","MultiInstanceSampleJob","MultiInstanceSampleTask") przed usunięciem zasobów.
