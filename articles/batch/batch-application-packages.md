...
W węzłach Linux format różni się nieznacznie. Kropki (.), łączniki (-) i znaki numeru (#) są jako spłaszczone podkreślenia w zmiennej środowiskowej. Na przykład:
...
W węzłach Linux Określ zmienną środowiskową w następującym formacie:
