...
RBAC は、**ユーザー**がさまざまな範囲で実行できるアクションにフォーカスしています。 
特定のユーザーが必要なスコープで、リソース グループに関する共同作業者役割に追加されるため、ユーザーに変更を加えることができますなど 
リソース グループ。

ポリシーは、さまざまな範囲の**リソース** アクションにフォーカスしています。 たとえばのポリシーを使用することができます。 
...
サービス型 Microsoft.Resources/\ の*, 、Microsoft.Compute/\*,、
Microsoft.Storage/\*, 、Microsoft.Network/\* は許可されます。 その他
拒否されます。
...
api-version には、*2015-10-01-preview* を使用します。 例と詳細については、
