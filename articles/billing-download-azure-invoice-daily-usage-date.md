<properties
    pageTitle="Azure の請求書や毎日の使用状況データを課金をダウンロードする方法 |Microsoft Azure"
    description="Azure の課金請求書と毎日の使用状況データをダウンロードする方法について説明します"
    services="billing"
    documentationCenter=""
    authors="genlin"
    manager="jarrettr"
...
Azure アカウント管理者の場合、Azure アカウント センターで現在の料金を確認し、過去 6 か月間の料金の明細書をダウンロードすることができます。 ここでは、どのようにします。

1. サインイン、 [使用状況と課金ポータル](https://account.windowsazure.com/subscriptions) Microsoft アカウント ID、作業アカウントの ID または学校のアカウント ID を使用
