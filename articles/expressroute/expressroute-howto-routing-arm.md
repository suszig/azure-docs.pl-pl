...
4. **回線用に Azure プライベート ピアリングを構成します。**
    ...
    次のコマンドレットを実行して、回線用に Azure プライベート ピアリングを構成することができます。
        ...
        追加 AzureRmExpressRouteCircuitPeeringConfig-名前"AzurePrivatePeering"-回路 $ckt PeeringType AzurePrivatePeering PeerASN 100 - PrimaryPeerAddressPrefix「10.0.0.0/30」- SecondaryPeerAddressPrefix「10.0.0.4/30」VlanId 200

        セット AzureRmExpressRouteCircuit ExpressRouteCircuit $ckt

    MD5 ハッシュを使用する場合は、以下のコマンドレットを使用できます。

        追加 AzureRmExpressRouteCircuitPeeringConfig-名前"AzurePrivatePeering"-回路 $ckt PeeringType AzurePrivatePeering PeerASN 100 - PrimaryPeerAddressPrefix「10.0.0.0/30」- SecondaryPeerAddressPrefix「10.0.0.4/30」VlanId 200-sharedkey"A1B2C3D4"
...
4. **回線用に Azure パブリック ピアリングを構成します。**
    ...
    次のコマンドレットを実行して、回線用に Azure プライベート ピアリングを構成することができます。
        ...
        追加 AzureRmExpressRouteCircuitPeeringConfig-名前"AzurePublicPeering"-回路 $ckt PeeringType AzurePublicPeering PeerASN 100 - PrimaryPeerAddressPrefix「12.0.0.0/30」- SecondaryPeerAddressPrefix「12.0.0.4/30」VlanId 100

        セット AzureRmExpressRouteCircuit ExpressRouteCircuit $ckt

    MD5 ハッシュを使用する場合は、次のコマンドレットを使用することができます。

        追加 AzureRmExpressRouteCircuitPeeringConfig-名前"AzurePublicPeering"-回路 $ckt PeeringType AzurePublicPeering PeerASN 100 - PrimaryPeerAddressPrefix「12.0.0.0/30」- SecondaryPeerAddressPrefix「12.0.0.4/30」VlanId 100-sharedkey"A1B2C3D4"
