<properties 
   pageTitle="Wprowadzenie do usługi ExpressRoute | Microsoft Azure"
...
## <a name="howtoconnect"></a>Jak połączyć sieć z firmą Microsoft przy użyciu usługi ExpressRoute?

Połączenie między siecią lokalną i chmurą Microsoft można utworzyć na trzy sposoby:

### Kolokowanie w ramach wymiany w chmurze
...
### Globalna łączność dzięki dodatkowi ExpressRoute Premium
