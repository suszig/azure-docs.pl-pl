...
以下のルーター構成サンプルは、すべてのピアリングを対象としています。 レビュー [ExpressRoute のピアリング](expressroute-circuit-peerings.md) と [ExpressRoute ルーティング要件を満たす](expressroute-routing.md) ルーティングの詳細についてです。
