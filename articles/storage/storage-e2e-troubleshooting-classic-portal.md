...
- **Azure クラシック ポータル**。 メトリックとログを構成するには、ストレージ アカウント内の [Azure Classic Portal](manage.windowsazure.com)します。 アプリケーションの経時的な動作を表すチャートやグラフを表示できるほか、指定したメトリックに関してアプリケーションが予期しない動作をした場合に通知するよう、アラートを構成することもできます。
...
![Message Analyzer の ](./media/storage-e2e-troubleshooting-classic-portal/mma-start-page-1.png)
