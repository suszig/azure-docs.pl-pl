...
* Albo zainstalować IDE, do którego ma integracji Maven lub instalowanie i konfigurowanie Maven do pracy z wiersza polecenia
    * W tym samouczku używana [Eclipse](http://www.eclipse.org/downloads/) z konfiguracją "Eclipse IDE dla języka Java deweloperzy"
...
Po utworzeniu konta magazynu jest przypięta do pulpitu nawigacyjnego. Kliknij go, aby go otworzyć. W obszarze Ustawienia, kliknij przycisk **klucze dostępu**. Wybierz klucz i skopiuj go do Schowka, a następnie wklej go w edytorze tekstu do późniejszego użycia. Skopiuj nazwę swojego konta magazynu i wklej go w edytorze tekstu do późniejszego użycia.
...
Przykładowy kod tworzy plik lokalny do zastosowania w przypadku przekazywania i pobierania, przechowywanie plików do przekazania jako **źródła** i nazwa obiektu blob w **obiektu blob**. Poniższy przykład powoduje przekazanie pliku z kontenera o nazwie **quickstartblobs**.
