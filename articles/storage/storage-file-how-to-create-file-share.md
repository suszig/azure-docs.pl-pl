...
Aby utworzyć udział plików Azure, można użyć już istniejącego konta magazynu lub [utworzyć nowe konto magazynu Azure](storage-create-storage-account.md). Aby utworzyć udział plików Azure przy użyciu programu PowerShell, konieczny jest klucz konta i nazwa konta magazynu. Jeśli planujesz użyć programu PowerShell lub interfejsu wiersza polecenia, niezbędny będzie klucz konta magazynu.
...
2. **Kliknij przycisk Dodaj udział pliku**:    
    ![Kliknij przycisk Dodaj udział pliku](media/storage-file-how-to-create-file-share/create-file-share-portal2.png)

3. **Podaj nazwę i limit przydziału. Obecnie maksymalna wartość przydziału wynosi 5 TB**:    
    ![Podaj nazwę i żądany limit przydziału dla nowego udziału plików](media/storage-file-how-to-create-file-share/create-file-share-portal3.png)
