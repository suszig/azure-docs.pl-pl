...
|**Premium**|ジョブ コレクションあたり 50 個のジョブ|1 分に 1 回。 1 分に 1 回を超えてジョブを実行できません。|1 つのサブスクリプションに最大で 10,000 個の Premium ジョブ コレクションが許可されます。 <a href="mailto:wapteams@microsoft.com">問い合わせ先</a> 詳細についてです。|Scheduler の完全な機能セットへのアクセス|
...
ジョブ コレクションの課金状態は変わりません –、ジョブ コレクションは 1 回の操作でジョブ コレクション内のすべてのジョブを無効にすることがあります、 _まだ_ 課金されます。 同様に、空のジョブ コレクションもアクティブと見なされ、課金の対象となります。 
