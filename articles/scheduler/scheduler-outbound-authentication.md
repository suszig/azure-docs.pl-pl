...
|_パスワード_|必須。 PFX ファイルにアクセスするためのパスワード。|
...
|_テナント_ |必須。 Azure AD テナントのテナント ID です。|
|_対象となる読者_ |必須。 これは、https://management.core.windows.net/に設定されます。|
...
|_テナント_ |Azure AD テナントのテナント ID です。 |
|_対象となる読者_ |これは、https://management.core.windows.net/に設定されます。|
