<properties
   ...
   description="Service Fabric リソース バランサーのアーキテクチャの概要です。"
...
- [クラスターを説明します。](service-fabric-resource-balancer-cluster-description.md)
- [サービスを説明します。](service-fabric-resource-balancer-service-description.md)
- [レポートの動的読み込み](service-fabric-resource-balancer-dynamic-load-reporting.md)
- [プロアクティブ メトリック パッキング](service-fabric-resource-balancer-proactive-metric-packing.md)
- [ノード バッファー使用率](service-fabric-resource-balancer-node-buffer-percentage.md)
