...
Vm またはこれらのオペレーティング システムを実行しているマシンにクラスターを作成することができます。
...
これらのプログラミング言語のいずれかと、Service Fabric アプリケーションを作成することができます。
* C#
* Java
...
* 診断: Azure での統合で提供 WAD (Windows Azure 診断) と Operational Insights の診断します。
