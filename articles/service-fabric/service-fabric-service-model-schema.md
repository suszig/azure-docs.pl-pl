...
## <a name="containerhealthconfigtype-complextype"></a>Element complexType ContainerHealthConfigType
Określa opcje integracji test kondycji docker kontenera.
...
|---|---|
|type|anonimowe complexType.|
|Zawartość|9 elementy, atrybuty (5)|
...
|minOccurs|0|
|REF|Parametry|
## <a name="imageoverridestype-complextype"></a>Element complexType ImageOverridesType
|Atrybut|Wartość|
|---|---|
|type|anonimowe complexType.|
|Zawartość|1 elementy, atrybuty (0)|
...
|maxOccurs|bez ograniczeń|
|type|Typ obrazu|
## <a name="imagetype-complextype"></a>Element complexType ImageType
|Atrybut|Wartość|
|---|---|
|type|anonimowe complexType.|
|Zawartość|0 elementy, atrybuty (2)|
