...
アップグレードには、正常性ポリシーを設定する必要があります (既定値を使用することもできます)。 すべてのアップグレード ドメインが、指定されたタイムアウト内でアップグレードされ、すべてのアップグレード ドメインが正常であると判断された場合、アップグレードが成功したことになります。 正常なアップグレード ドメインはことを意味する正常性ポリシーで指定されているすべての正常性チェックに合格などの正常性ポリシーが、アプリケーション インスタンス内のすべてのサービスがある必要があることを要求することがあります <em>正常</em>, 、Service Fabric によって状態が定義されています。
