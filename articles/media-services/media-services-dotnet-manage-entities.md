<properties 
    pageTitle =「アセットの管理と Media Services .NET SDK を持つ関連エンティティ」 
    description =「を .NET のアセットと Media Services SDK で関連エンティティを管理する方法について説明します」。 
    authors ="juliako" 
    manager="dwrede" 
    エディター ="" 
    サービス = [media services] 
...
を参照してください [環境をセットアップ](media-services-set-up-computer.md)
