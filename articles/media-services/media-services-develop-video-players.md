...
- [Azure Media Player の概要ブログの開始](http://azure.microsoft.com/blog/2015/04/15/announcing-azure-media-player)
- [Azure Media Player から最新バージョンの最新情報します。](http://aka.ms/ampsignup)
- [新しい機能の要望、アイデア、フィードバックを追加します。](http://aka.ms/ampuservoice)
...
- [Microsoft スムーズ ストリーミングの OSMF プラグイン](https://www.microsoft.com/download/details.aspx?id=36057)
- [ライセンス Microsoft ® Smooth Streaming Client Porting Kit](http://aka.ms/sspk)
...
[Dash.js を使用した HTML5 アプリケーションに MPEG-DASH アダプティブ ストリーミング ビデオを埋め込む](media-services-embed-mpeg-dash-in-html5.md)
