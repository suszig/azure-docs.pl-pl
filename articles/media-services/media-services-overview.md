...
2. Skonfiguruj zasady autoryzacji klucza zawartości.
1. Skonfiguruj zasady dostarczania elementu zawartości (używane podczas dynamicznego tworzenia pakietów i dynamicznego szyfrowania).
1. Opublikuj element zawartości, tworząc lokalizator OnDemand.
1. Prześlij strumieniowo opublikowaną zawartość. 
...
1. Opublikuj element zawartości, tworząc lokalizator OnDemand lub SAS.
