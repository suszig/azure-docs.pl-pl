...
2.  検索、 **< Grid >** と **</グリッド >**  XAML ファイルのタグし、2 つのタグの間で次のコードを貼り付けます。
...
- [高度な機能での Smooth Streaming Windows 8 JavaScript アプリケーションを作成する方法](http://blogs.iis.net/cenkd/archive/2012/08/10/how-to-build-a-smooth-streaming-windows-8-javascript-application-with-advanced-features.aspx)
