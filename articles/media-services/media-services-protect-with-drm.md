...
>[AZURE.NOTE]Azure Media Sevices によって提供される Widevine ライセンス配信サービスはプレビュー期間中です。 詳細については、次を参照してください。 [このブログ](http://azure.microsoft.com/blog/announcing-google-widevine-license-delivery-services-public-preview-in-azure-media-services/)します。
...
詳細については、次を参照してください。 [コンテンツ キー承認ポリシーを構成する](media-services-dotnet-configure-content-key-auth-policy.md#playready-dynamic-encryption)します。
...
[AMS による Widevine パッケージを構成します。](http://mingfeiy.com/how-to-configure-widevine-packaging-with-azure-media-services)

[Google Widevine ライセンス配信サービスでパブリック プレビュー Azure Media Services の発表](http://azure.microsoft.com/blog/announcing-google-widevine-license-delivery-services-public-preview-in-azure-media-services/)
