...
使用する [castLabs](http://castlabs.com/company/partners/azure/) Widevine ライセンスを配信します。 詳細については、次を参照してください [Azure Media Services に DRM を配信する castLabs を使用してライセンス。](media-services-castlabs-integration.md)

##Axinom

使用する [Axinom](http://www.axinom.com/press/ibc-axinom-drm-6/) Widevine ライセンスを配信します。 詳細については、次を参照してください [Azure Media Services に DRM を配信するのを使用して Axinom のライセンス。](media-services-axinom-integration.md)
