...
>[AZURE.NOTE] お客様を聞くし、ユーザーに影響する問題の修正に尽力してみます。 問題の報告または質問を [Azure Media Services MSDN フォーラム] に投稿してください。
...
* **インデクサー メディア プロセッサ**します。 詳細については、[インデックス作成によるメディア ファイルの Azure Media Indexer] を参照してください。
