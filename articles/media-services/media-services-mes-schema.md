...
| **KeyFrameInterval**<br/><br/> minOccurs = "0"<br/><br/> **domyślne = "00: 00:02"** |**xs: Time** |Określa stały odstęp między ramki IDR w jednostkach czasu w sekundach. Również nazywane GOP czas trwania. Zobacz **SceneChangeDetection** do kontrolowania, czy koder można różni się od tej wartości. |
...
| Name (Nazwa) | Typ | Opis |
| --- | --- | --- |
| **Profil**<br/><br/> minOccurs = "0"<br/><br/> domyślne = "Auto" |**xs: ciąg** |Może być jedną z następujących **xs: ciąg** wartości: **automatycznie**, **linii bazowej**, **Main**, **wysokiej**. |
| **Poziom**<br/><br/> minOccurs = "0"<br/><br/> domyślne = "Auto" |**xs: ciąg** | |
...
| **BufferWindow**<br/><br/> minOccurs = "0"<br/><br/> domyślne = "00: 00:05" |**xs: czas** |Długość buforu wideo. |
...
| **EntropyMode**<br/><br/> minOccurs = "0"<br/><br/> domyślne = "Cabac" |**xs: ciąg** |Może być jedną z następujących wartości: **Cabac** i **Cavlc**. |
...
| Name (Nazwa) | Typ | Opis |
| --- | --- | --- |
| **Profil**<br/><br/> minOccurs = "0"<br/><br/> domyślne = "AACLC" |**xs: ciąg** |Może być jedną z następujących wartości: **AACLC**, **HEAACV1**, lub **HEAACV2**. |
