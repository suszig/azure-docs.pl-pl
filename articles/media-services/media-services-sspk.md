...
Microsoft Smooth Streaming Client Porting Kit (**SSPK** 略して) 内蔵デバイス メーカー、ケーブルおよび携帯電話会社、コンテンツ サービス プロバイダー、ハンドセット製造会社、独立系ソフトウェア ベンダー (Isv)、およびソリューション プロバイダー Smooth Streaming 形式でコンテンツ ストリーミング アダプティブ ストリーミングの製品とサービスを作成するために最適化された Smooth Streaming クライアント実装です。 SSPK は、デバイスやプラットフォームに依存しないスムーズ ストリーミング クライアントの実装であり、ライセンシーは任意のデバイスやプラットフォームに移植できます。 
...
- チップセット製造元やシステム インテグレーター、独立系ソフトウェア ベンダー (Isv)、ソースを必要とするコードの移植キットを Microsoft Smooth Streaming Client Porting Kit、中間の製品を開発する **中間製品ライセンス** 実行する必要があります。
- デバイスの製造元または用スムーズ ストリーミング クライアント最終的な Microsoft Smooth Streaming Client Porting Kit、エンドユーザーに配布する権利を必要とする Isv の **最終的な製品のライセンス** 実行する必要があります。
...
米国 1 回限りのライセンス費用を 50,000 米ドル、Smooth Streaming Client Porting Kit にアクセスを提供します。 
