...
このチュートリアルでは、AAC の使用方法について説明することに注意してください。 ただし、FMLE は、既定では AAC をサポートしません。 AAC のエンコードなど MainConcept から用のプラグインを購入する必要があります: [AAC プラグイン](http://www.mainconcept.com/products/plug-ins/plug-ins-for-adobe/aac-encoder-fmle.html)
...
チャネルの起動中にすることができます [エンコーダーを構成する](media-services-configure-fmle-live-encoder.md#configure_fmle_rtmp)します。
...
>[AZURE.IMPORTANT] **[接続]** をクリックする前に、チャネルの準備が整っていることを確認する**必要**があります。 
