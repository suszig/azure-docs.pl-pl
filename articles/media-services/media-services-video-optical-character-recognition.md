...
Ten temat zawiera szczegółowe informacje o **Azure Media Rozpoznawania** i pokazuje, jak z niego korzystać z zestawu SDK usługi Media Services dla platformy .NET. Aby uzyskać dodatkowe informacje i przykłady, zobacz [ten blog](https://azure.microsoft.com/blog/announcing-video-ocr-public-preview-new-config/).
