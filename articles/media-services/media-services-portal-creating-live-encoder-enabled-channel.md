<properties 
    pageTitle="Korzystanie z usługi Azure Media Services i witryny Azure Portal do prowadzenia transmisji strumieniowych na żywo ze strumieniami o różnych szybkościach transmisji bitów | Microsoft Azure" 
...
3. Utwórz wydarzenie/program (to spowoduje również utworzenie elementu zawartości). 
...
1.  Utworzenie wydarzenia/programu (i elementu zawartości)
