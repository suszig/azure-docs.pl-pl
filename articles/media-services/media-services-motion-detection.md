...
Ten temat zawiera szczegółowe informacje o **czujnik ruchu Azure Media** i pokazuje, jak z niego korzystać z zestawu SDK usługi Media Services dla platformy .NET
...
Zadanie wykrywania ruchu zwróci pliku JSON w elementu zawartości wyjściowej, opisujący alerty ruchu i ich w kategorie wideo. Plik będzie zawierać informacje o czas i czas trwania ruchu wykryto wideo.

Interfejs API wykrywanie ruchu zawiera wskaźniki po ruchu w stałej tło w formie wideo (np. nadzoru, wideo) są obiekty. Czujnik ruchu jest uczony zmniejszenie fałszywe alarmy, takie jak oświetlenia i zmiany w tle. Bieżące ograniczenia algorytmy obejmują nocy wizji wideo, półprzezroczyste obiektów i małych obiektów.
...
* Niektóre ruchu mogą nie być wykrywane z powodu problemów technicznych; np. nocy wizji wideo, półprzezroczyste obiektów i małych obiektów.
