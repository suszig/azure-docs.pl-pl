...
![1Green](./media/best-practices-availability-paired-regions/1Green.png) **Azure コンピューティング (PaaS)** – 事前にリソースを確実に利用可能な別のリージョンに、災害時に追加のコンピューティング リソースをプロビジョニングする必要があります。 詳細については、を参照してください [Azure のビジネス継続性テクニカル ガイダンス](https://msdn.microsoft.com/library/azure/hh873027.aspx)。
