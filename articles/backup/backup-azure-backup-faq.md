...
# Pytania dotyczące usługi Azure Backup
...
### Czy istnieją ograniczenia dotyczące liczby serwerów/maszyn, które można zarejestrować w każdym magazynie? <br/>
...
### Mam utworzone kopie zapasowe moich klasycznych maszyn wirtualnych w magazynie usługi Backup. Czy mogę migrować maszyny wirtualne z trybu klasycznego do trybu usługi Resource Manager i chronić je w magazynie usługi Recovery Services?
...
### Jaka jest maksymalna długość ścieżki pliku, którą można określić w ramach zasad usługi Backup przy użyciu agenta usługi Azure Backup? <br/>
...
## Programy Azure Backup Server i System Center Data Protection Manager
...
### Czy mogę zarejestrować serwer programu DPM w wielu magazynach? <br/>
...
### Która wersja programu System Center Data Protection Manager jest obsługiwana? <br/>
...
### Agent usługi Azure Backup został zainstalowany w celu ochrony plików i folderów. Czy można teraz zainstalować program System Center DPM do pracy z agentem usługi Azure Backup, aby chronić obciążenia aplikacji lokalnych i maszyn wirtualnych na platformie Azure? <br/>
...
### Czy jeśli zadanie tworzenia kopii zapasowej nie powiedzie się, będzie można skonfigurować usługę Backup w taki sposób, aby wysyłała wiadomości e-mail? <br/>
...
### Czy istnieją ograniczenia dotyczące czasu wykonywania zadań tworzenia kopii zapasowej i ich liczby?<br/>
...
### Dlaczego rozmiar danych przesyłanych do magazynu usługi Recovery Services jest mniejszy niż rozmiar danych, dla których utworzono kopię zapasową?<br/>
...
## Dla jakich danych mogę utworzyć kopię zapasową

<a id="which-operating-systems-do-azure-backup-support-br" class="xliff"></a>

### Jakie systemy operacyjne są obsługiwane przez usługę Azure Backup? <br/>
...
## Zasady przechowywania i punkty odzyskiwania
...
### Czy podczas przywracania danych należy zapłacić za ruch wychodzący z platformy Azure? <br/>
...
### Nawet po skonfigurowaniu zasad kopii zapasowych wyświetlany jest komunikat ostrzegawczy „Proces tworzenia kopii zapasowych Azure nie został skonfigurowany dla tego serwera” <br/>
