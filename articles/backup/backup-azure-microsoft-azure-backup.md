...
を参照することもできます [Azure Backup に関するよく寄せられる質問](backup-azure-backup-faq.md)。
...
Q: サブスクリプションの状態が引き続き*アクティブ*であると仮定すると、Microsoft Azure Backup サーバーの接続が復元された場合、どうなりますか。
...
Q: サブスクリプションの状態が*有効期限が切れ*の状態から*アクティブ*な状態に復元された場合、どうなりますか。
...
Q: サブスクリプションの状態が*プロビジョニング解除済み*の状態から*アクティブ*な状態に復元された場合、どうなりますか。
...
<br>A: 必要があります - ファイアウォールのプロファイルで次のドメインのアドレスを許可するように、www.msftncsi.com \*します。Microsoft.com \*します。WindowsAzure.com、\*. microsoftonline.com、\*. 準備完了です。
...
Q: なぜサブスクリプションの状態が*アクティブ*でないのでしょうか。 どうすればこれを*アクティブ*に変更できますか。
