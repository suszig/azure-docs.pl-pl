...
---
# <a name="upgrade-to-vm-backup-stack-v2"></a>Uaktualnij do stos kopii zapasowej maszyny Wirtualnej w wersji 2
...
Dla zarządzanych dysków jest *bez zwiększania cen* ponieważ restorePointCollections jest wolny. 
