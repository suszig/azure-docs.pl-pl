...
- Azure Backup に関する詳細については、を参照してください [Azure Backup の概要](backup-introduction-to-azure-backup.md)。
- アクセス、 [Azure のバックアップ フォーラム](http://go.microsoft.com/fwlink/p/?LinkId=290933)
