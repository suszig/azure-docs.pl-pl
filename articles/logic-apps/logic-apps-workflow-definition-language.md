...
|pusta|Zwraca wartość PRAWDA, jeśli obiekt, tablicy lub ciągu jest pusty. Na przykład, funkcja zwraca `true`: <p>`empty('')` <p> **Liczba parametrów**: 1 <p> **Nazwa**: kolekcji <p> **Opis elementu**: wymagane. Kolekcja, aby sprawdzić, czy jest pusta.|  
...
|liczba zmiennoprzecinkowa|Liczba zmiennoprzecinkowa przekonwertować argumentu parametru. Na przykład, funkcja zwraca `10.333`: <p>`float('10.333')` <p> **Liczba parametrów**: 1 <p> **Nazwa**: wartość <p> **Opis elementu**: wymagane. Wartość, która jest konwertowana na liczba zmiennoprzecinkowa.|  
