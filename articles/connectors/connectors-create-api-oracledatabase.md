...
[Tworzenie aplikacji logiki](../logic-apps/logic-apps-create-a-logic-app.md)i przejrzyj dostępne łączniki w aplikacjach logiki w naszym [listy interfejsów API](apis-list.md).
