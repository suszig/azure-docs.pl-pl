...
Po utworzeniu połączenia, należy wprowadzić dysk Google właściwości, takie jak nazwa pliku lub ścieżka folderu. 

## <a name="connector-specific-details"></a>Szczegóły dotyczące łącznika

Wyświetl wszystkie wyzwalacze i akcje zdefiniowane w swagger i zobacz też żadnych limitów w [szczegóły łącznika](/connectors/googledrive/).
