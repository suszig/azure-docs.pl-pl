---
title: "Informacje o sposobie korzystania z łącznika usługi SharePoint Online w aplikacjach logiki | Dokumentacja firmy Microsoft"
...
## <a name="connect-to-sharepoint-online"></a>Połącz z usługą SharePoint Online
...
### <a name="create-a-connection-to-sharepoint-online"></a>Utwórz połączenie do usługi SharePoint Online
> [!INCLUDE [Steps to create a connection to SharePoint](../../includes/connectors-create-api-sharepointonline.md)]


## <a name="use-a-sharepoint-online-trigger"></a>Użyj wyzwalacz usługi SharePoint Online
...
## <a name="use-a-sharepoint-online-action"></a>Za pomocą akcji usługi SharePoint Online
