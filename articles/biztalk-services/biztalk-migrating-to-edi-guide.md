...
また、Microsoft Azure BizTalk Services には、BizTalk Server の取引先モジュールから BizTalk Services ポータルに取引先とアグリーメントを移行するための **TPM データ移行**ツールが用意されています。 TPM データ移行ツールは Tools パッケージの一部として、ダウンロードできるから、 [MABS SDK](http://go.microsoft.com/fwlink/p/?LinkId=235057)します。 パッケージには、ツールの使用方法とツールの基本的なトラブルシューティング情報を提供する readme も含まれます。
...
- 「*WCF ワークフロー サービスを Service Bus のキューおよびトピックに統合する方法*」 (Paolo Salvatori)。 See [here](https://msdn.microsoft.com/library/azure/hh709041.aspx).

- 「*Building apps with Windows Workflow Foundation and Azure (Windows Workflow Foundation と Azure でのアプリの構築)*」 (Build 2011 カンファレンスのセッション)。 See [here](http://go.microsoft.com/fwlink/p/?LinkId=237314).

- *Windows Workflow Foundation デベロッパー センター* (MSDN)。 See [here](http://go.microsoft.com/fwlink/p/?LinkId=237315).

- *Windows Workflow Foundation 4 (WF4) のドキュメント* (MSDN)。 See [here](https://msdn.microsoft.com/library/dd489441(v=vs.100).aspx).
...
[Azure でのエンタープライズ アプリケーションの開発](https://msdn.microsoft.com/library/azure/hh674490.aspx)
