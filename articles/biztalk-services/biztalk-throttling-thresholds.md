...
| | 説明| 低いしきい値| 高いしきい値|
|---|---|---|---|
| メモリ| 使用可能な合計システム メモリ/PageFileBytes の割合。<p><p>合計使用可能な PageFileBytes は、システムの RAM の 2 倍では約です。| 60%| 70%|
...
- 調整はロール インスタンス単位で行われます。 例を示します。<br/>
...
** サーバーがビジーです。 お試しください again.* *<br/><br/>
- どの取り出し元も、メッセージのポーリングやダウンロードを行いません。 例を示します。<br/>
