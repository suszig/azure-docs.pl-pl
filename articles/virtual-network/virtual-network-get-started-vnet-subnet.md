...
1. W witrynie [Azure Portal](https://portal.azure.com) kliknij kolejno pozycje **Utwórz zasób** > **Obliczenia** > **systemu Windows Server 2016 Datacenter**.
...
1. W witrynie [Azure Portal](https://portal.azure.com) kliknij pozycję **Wszystkie usługi**.
2. Wpisz frazę *Grupy zasobów* w polu zawierającym wyraz *Filtruj*. Kliknij pozycję **Grupy zasobów** na wyświetlonej wyfiltrowanej liście.
