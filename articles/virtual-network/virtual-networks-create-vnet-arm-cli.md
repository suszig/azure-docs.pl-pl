...
[AZURE.INCLUDE [azure-arm-classic-important-include](../../includes/azure-arm-classic-important-include.md)] このドキュメントでは、リソース マネージャーの配置モデルを使用した VNet の作成について説明します。 こともできます [Azure CLI を使用して従来のデプロイ モデルで仮想ネットワークの作成](virtual-networks-create-vnet-classic-cli.md)します。
