...
1. 仮想ネットワークの DNS サーバーの情報を指定します。 DNS サーバーを指定する方法の詳細については、次を参照してください。 [仮想ネットワーク構成ファイルで DNS サーバーを指定する](virtual-networks-specifying-a-dns-settings-in-a-virtual-network-configuration-file.md)します。 ネットワーク構成ファイルの詳細については、次を参照してください。 [Azure 仮想ネットワーク構成スキーマ](https://msdn.microsoft.com/library/azure/jj157100.aspx) と [ネットワーク構成ファイルを使用して仮想ネットワークを構成](virtual-networks-using-network-configuration-file.md)します。
...
[仮想ネットワークでパブリック IP アドレスを使用する方法](../virtual-networks-public-ip-within-vnet)
