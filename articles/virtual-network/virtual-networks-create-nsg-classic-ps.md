...
[AZURE.INCLUDE [azure-arm-classic-important-include](../../includes/azure-arm-classic-important-include.md)] この記事では、従来のデプロイ モデルについて説明します。 こともできます [Nsg をリソース マネージャーの展開モデルの作成](virtual-networks-create-nsg-arm-ps.md)します。

[AZURE.INCLUDE [virtual-networks-create-nsg-scenario-include](../../includes/virtual-networks-create-nsg-scenario-include.md)]

以下の PowerShell のサンプル コマンドでは、上記シナリオに基づいて単純な環境が既に作成されていると想定します。 このドキュメントに表示されているように、コマンドを実行する場合は、最初、テスト環境にビルド [VNet を作成する](virtual-networks-create-vnet-classic-netcfg-ps)です。

## フロントエンドのサブネットの NSG を作成する方法
名前を名前付き NSG を作成する *NSG フロント エンド* 上記のシナリオに基づいて、以下の手順。
...
3. ネットワーク セキュリティ グループを作成 **NSG フロント エンド**します。
...
3. ネットワーク セキュリティ グループを作成 **NSG バックエンド**します。
