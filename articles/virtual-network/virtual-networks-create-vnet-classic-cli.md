...
[AZURE.INCLUDE [azure-arm-classic-important-include](../../includes/azure-arm-classic-important-include.md)] このドキュメントでは、従来のデプロイ モデルを使用した VNet の作成について説明します。 こともできます [リソース マネージャーの展開モデルの Azure CLI を使用した仮想ネットワークの作成](virtual-networks-create-vnet-arm-cli.md)します。
