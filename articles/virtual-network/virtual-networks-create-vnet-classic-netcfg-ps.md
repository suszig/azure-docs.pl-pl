...
W tym dokumencie opisano tworzenie sieci wirtualnej przy użyciu klasycznego modelu wdrażania. Możesz również [utworzyć sieć wirtualną w modelu wdrażania usługi Resource Manager](virtual-networks-create-vnet-arm-ps.md).
