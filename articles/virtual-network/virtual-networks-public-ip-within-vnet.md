...
プライベート IP アドレス範囲; の追加と同じ方法でパブリック IP アドレス範囲を追加します。使用するか、 *netcfg* ファイル、またはポータルで構成することです。 パブリック IP アドレス範囲は、VNet の作成時に追加することも、後で追加することもできます。 次の例では、同じ仮想ネットワーク内で構成されたパブリックとプライベートの両方の IP アドレス空間を示しています。
