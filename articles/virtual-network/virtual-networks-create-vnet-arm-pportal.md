...
W tym dokumencie opisano tworzenie sieci wirtualnej z zastosowaniem modelu wdrażania przy użyciu usługi Resource Manager. Możesz również [utworzyć sieć wirtualną w klasycznym modelu wdrażania przy użyciu witryny Azure Portal w wersji zapoznawczej](virtual-networks-create-vnet-classic-pportal.md).
