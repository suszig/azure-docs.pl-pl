<properties
   pageTitle="Tworzenie wirtualnej sieci równorzędnej przy użyciu portalu Azure | Microsoft Azure"
...
4. W bloku Add Peering (Dodaj sesję komunikacji równorzędnej), nadaj połączeniu komunikacji równorzędnej nazwę PolaczenieZVnet2, wybierz subskrypcję oraz równorzędną sieć wirtualną VNET2 i kliknij przycisk OK.
...
7. W bloku Add Peering (Dodaj sesję komunikacji równorzędnej) nadaj połączeniu komunikacji równorzędnej nazwę PolaczenieZVnet1, wybierz subskrypcję oraz równorzędną sieć wirtualną i kliknij przycisk OK.
...
9. Należy sprawdzić stan połączenia PolaczenieZVnet2, który powinien również zmienić się na Połączono.  

    ![Końcowy stan połączenia 2](./media/virtual-networks-create-vnetpeering-arm-portal/figure08.png)

10. UWAGA: Komunikacja równorzędna w sieci wirtualnej jest ustanowiona tylko wtedy, gdy oba połączenia są połączone. 
...
5. Następnie zaloguj się do portalu Azure jako użytkownik B, który jest użytkownikiem o odpowiednich uprawnieniach w subskrypcji B. Wykonaj powyższe kroki, aby dodać użytkownika A jako użytkownika o roli Network Contributor (Współautor sieci).
    ...
    UWAGA: Można wylogować i zalogować się w obu sesjach użytkownika w przeglądarce, aby upewnić się, że autoryzacja została włączona pomyślnie.
