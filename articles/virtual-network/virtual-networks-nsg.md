<properties 
   pageTitle="Co to jest grupa zabezpieczeń sieci (Network Security Group, NSG)"
...
>[AZURE.IMPORTANT] Pamiętaj, aby przed projektowaniem rozwiązania przejrzeć wszystkie [limity dotyczące usług sieciowych na platformie Azure](../azure-subscription-service-limits.md#networking-limits). Niektóre limity można zwiększyć przez otwarcie biletu pomocy technicznej.
