...
1. W oknie **Pakiet zawartości dla usługi Power BI** zostaną wyświetlone dwie opcje w sposób przedstawiony poniżej.
    ...
    >[AZURE.NOTE] Jeśli zostały już wykonane czynności z pierwszej części tego artykułu, zostanie wyświetlona tylko jedna opcja, którą jest Zarządzanie zasadami Centrum zabezpieczeń Azure.
