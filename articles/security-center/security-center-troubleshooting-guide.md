<properties
   pageTitle="Przewodnik rozwiązywania problemów z usługą Azure Security Center | Microsoft Azure"
...
> [AZURE.NOTE] Jeśli agent Azure Security Center nie działa poprawnie, należy ponownie uruchomić docelową maszynę wirtualną, ponieważ nie istnieje żadne polecenie służące do zatrzymywania i uruchamiania agenta.
