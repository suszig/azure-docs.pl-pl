---
title: Wprowadzenie do Centrum zabezpieczeń Azure | Microsoft Docs
...
> [!NOTE]
> Podane tu informacje odnoszą się do wersji zapoznawczej Centrum zabezpieczeń Azure. Informacje na temat usługi przedstawiono w tym dokumencie za pomocą przykładowego wdrożenia.
> 
> 
...
> [!NOTE]
> Aby zmodyfikować zasady zabezpieczeń na poziomie subskrypcji lub grupy zasobów, użytkownik musi być właścicielem lub współpracownikiem subskrypcji.
> 
> 
...
> [!NOTE]
> Funkcje zbierania danych i wyboru konta magazynu dla regionu są konfigurowane na poziomie subskrypcji.
> 
> 
