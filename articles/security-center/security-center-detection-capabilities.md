<properties
   pageTitle="Funkcje wykrywania w usłudze Azure Security Center | Microsoft Azure"
...
> [AZURE.NOTE] Funkcje zaawansowanego wykrywania są dostępne w warstwie Standardowa usługi Azure Security Center. Dostępna jest bezpłatna 90-dniowa wersja próbna. Uaktualnienie usługi jest możliwe po przejściu do wyboru warstwy cenowej na stronie [Zasady zabezpieczeń](security-center-policies.md). Odwiedź [stronę usługi Security Center](https://azure.microsoft.com/pricing/details/security-center/), aby dowiedzieć się więcej na temat cen. 


## Odpowiadanie na nowe rodzaje zagrożeń
...
## Jak usługa Azure Security Center wykrywa zagrożenia i reaguje na nie
