<properties
   pageTitle="Korzystanie z usługi Azure Security Center w celu reagowania na zdarzenia | Microsoft Azure"
...
1. Kliknij kafelek **Alerty zabezpieczeń** i przejdź do bloku **Alerty zabezpieczeń**.
    ...
    > [AZURE.NOTE] Na potrzeby tego scenariusza Julia zamierza przeprowadzić ocenę alertu dotyczącego złośliwego działania SQL, jak widać na rysunku powyżej. 
