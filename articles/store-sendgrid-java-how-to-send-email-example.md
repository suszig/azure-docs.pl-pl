...
1. Javax.mail Jar をなどから入手 <http://www.oracle.com/technetwork/java/javamail/index.html>します。
...
また、電子メールを送信するには、SendGrid のユーザー名とパスワードを取得している必要があります。 最初に SendGrid を使用した、次を参照してください。 [Java から SendGrid を使用して電子メールを送信する方法](store-sendgrid-java-how-to-send-email.md)します。

情報がさらに、使いやすさ [Eclipse で Azure の Hello World アプリケーションを作成する](http://msdn.microsoft.com/library/windowsazure/hh690944), 、または、Eclipse を使用していない場合は、Azure で Java アプリケーションをホストするための他の手法では強くお勧めします。
