...
-   [Redis Cache がデータをキャッシュすることによってパフォーマンスを向上する方法のデモします。](https://github.com/rustd/RedisSamples/tree/master/RedisCacheCustomerQuerySample)
-   [デモ用のデータベースおよびキャッシュをシードします。](https://github.com/rustd/RedisSamples/tree/master/SeedCacheForCustomerQuerySample)
