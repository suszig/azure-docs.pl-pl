...
Z systemu Windows Server 2012 lub nowszym administratorów usługi uzyskać możliwość konfigurowania ograniczonego delegowania dla usługi. W tym modelu administrator usług zaplecza można akceptować lub odrzucać określonych usług frontonu z za pomocą KCD. Ten model jest nazywany **kerberos oparte na zasobach ograniczonego delegowania**.
