...
2. 選択、 **プロファイル** このページのタブをクリックします。
3. をクリックして、 **パスワードの変更** パスワード変更を開始するには、このページを並べて表示します。
...
4. すると、 **のパスワードを変更** ページです。 ユーザーは、既存の (古い) パスワードを入力し、操作を進めてパスワードを変更します。
...
最低限のバージョンを推奨: **1.0.9125** - 2015 年 11 月 3 日に公開します。
...
Azure AD Connect のインストール手順については、次の記事 - [Azure AD Connect の概要](../active-directory/active-directory-aadconnect.md)
