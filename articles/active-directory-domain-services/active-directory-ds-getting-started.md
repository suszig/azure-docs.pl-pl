...
9. **[メンバーの追加]** ダイアログ ボックスで、このグループのメンバーにするユーザーを選択し、チェック ボックスをオンします。
    ...
    ![管理者グループにユーザーを追加します。](./media/active-directory-domain-services-getting-started/add-group-members.png)

---

[* * 次の手順を作成または選択すると、Azure 仮想 network.* *](active-directory-ds-getting-started-vnet.md)
