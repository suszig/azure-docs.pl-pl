...
1. PowerApps にて、**[管理 API]** を選択し、API を選択します。 たとえば、*MS Power BI* API を作成した場合は、それを選択して、そのブレードを開きます。 選択 **API へのユーザー アクセス**:  
![][1]
...
- [SQL Server の接続を作成します。](powerapps-create-api-sqlserver.md)
...
2. この新しいブレードで、[**接続ユーザー アクセス**] を選択します。 次の例では、**ハイブリッド トンネル**接続が選択されています。 新しいブレードが開き、これは、選択した **接続ユーザーのアクセスを**:  
![][2]
