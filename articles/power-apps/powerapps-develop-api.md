...
PowerApps 用 API の構築とデプロイは通常の API の作成と似ています。 好きなプログラミング言語とフレームワークを選択できます。 API のホスト先を選択することもできます。 お勧めとして同じ PowerApps の app service 環境でホスト [API アプリ](https://azure.microsoft.com/services/app-service/api/)します。
