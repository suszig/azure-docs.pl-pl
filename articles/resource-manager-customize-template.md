---
title: Dostosowywanie wyeksportowanego szablonu usługi Azure Resource Manager | Microsoft Docs
...
1. W celu wdrożenia przy użyciu własnego skryptu użyj jednej z poniższych procedur.
...
2. Jeśli pobrano wyeksportowany szablon i skrypty, znajdź plik **deploy.ps1** (dla programu PowerShell) lub plik **deploy.sh** (dla interfejsu wiersza polecenia platformy Azure).
