...
IoT Hub では、IoT Hub S1 または S2 ユニット数を 2.000 に増やすことで、最大 100 万の同時接続デバイスをサポートできます。 詳細については、次を参照してください。 [IoT Hub の料金][lnk-pricing]します。
...
このスループット情報に加えて、次を参照してください、 [IoT Hub クォータとスロットル][] し、それに応じて、ソリューションを設計します。
...
特定のバースト パフォーマンス数値の場合、次を参照してください。 [IoT Hub クォータとスロットル][]します。
