...
Należy przekazać kopię urządzenia parametry połączenia uzyskane z narzędzia Eksplorator urządzenia do tej funkcji. Możesz również określić protokół komunikacji ma być używany. W tym przykładzie użyto MQTT, ale AMQP i HTTP są także opcje.
