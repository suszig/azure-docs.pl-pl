...
- **Redis Cache のセカンダリ コピーを保守するため、高可用性オプションを有効にします。** Redis Cache を使用する場合は、標準のオプションを選択して内容のセカンダリ  コピーを保守します。 詳細については、ページを参照してください。 [Azure Redis Cache でキャッシュを作成](https://msdn.microsoft.com/library/dn690516.aspx) 、Microsoft web サイトです。
