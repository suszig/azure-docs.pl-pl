---
title: Przykładowy skrypt interfejsu wiersza polecenia platformy Azure — tworzenie aplikacji internetowej ASP.NET Core w kontenerze platformy Docker z usługi Azure Container Registry | Microsoft Docs
description: Przykładowy skrypt interfejsu wiersza polecenia platformy Azure — tworzenie aplikacji internetowej ASP.NET Core w kontenerze platformy Docker z usługi Azure Container Registry
services: appservice
...
---
# <a name="create-an-aspnet-core-web-app-in-a-docker-container-from-azure-container-registry"></a>Tworzenie aplikacji internetowej ASP.NET Core w kontenerze platformy Docker z usługi Azure Container Registry

Ten przykładowy skrypt tworzy grupę zasobów, plan usługi App Service dla systemu Linux i aplikację internetową. Następnie aplikacja ASP.NET Core jest wdrażana za pomocą kontenera platformy Docker z usługi Azure Container Registry.
