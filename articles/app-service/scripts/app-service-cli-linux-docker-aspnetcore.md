---
title: Przykładowy skrypt interfejsu wiersza polecenia platformy Azure — tworzenie aplikacji internetowej ASP.NET Core w kontenerze platformy Docker | Microsoft Docs
description: Przykładowy skrypt interfejsu wiersza polecenia platformy Azure — tworzenie aplikacji internetowej ASP.NET Core w kontenerze platformy Docker
services: appservice
...
---
# <a name="create-an-aspnet-core-web-app-in-a-docker-container"></a>Tworzenie aplikacji internetowej ASP.NET Core w kontenerze platformy Docker

Ten przykładowy skrypt tworzy grupę zasobów, plan usługi App Service dla systemu Linux i aplikację internetową. Następnie aplikacja ASP.NET Core jest wdrażana za pomocą kontenera platformy Docker.
...
| [`az webapp config container set`](/cli/azure/webapp/config/container?view=azure-cli-latest#az_webapp_config_container_set) | Ustawia kontener platformy Docker dla aplikacji internetowej platformy Azure. |
