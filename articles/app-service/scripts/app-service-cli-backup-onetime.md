---
title: "Azure CLI przykładowym skrypcie — tworzenie kopii zapasowej aplikacji sieci web | Dokumentacja firmy Microsoft"
description: "Azure CLI przykładowym skrypcie — tworzenie kopii zapasowej aplikacji sieci web"
...
| [`az webapp config backup create`](/cli/azure/webapp/config/backup?view=azure-cli-latest#az_webapp_config_backup_create) | Tworzy kopię zapasową dla aplikacji sieci web. |
