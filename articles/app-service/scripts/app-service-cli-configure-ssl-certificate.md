...
| [Dodaj az nazwy hosta z konfiguracji aplikacji sieci Web](https://docs.microsoft.com/cli/azure/webapp/config/hostname#az_webapp_config_hostname_add) | Mapuje domeny niestandardowej aplikacji sieci web. |
| [AZ aplikacji sieci Web config ssl przekazywania](https://docs.microsoft.com/cli/azure/webapp/config/ssl#az_webapp_config_ssl_upload) | Przekazywanie certyfikatu SSL w aplikacji sieci web. |
| [Powiązanie ssl konfiguracji aplikacji sieci Web az](https://docs.microsoft.com/cli/azure/webapp/config/ssl#az_webapp_config_ssl_bind) | Wiąże przekazano certyfikat SSL do aplikacji sieci web. |
