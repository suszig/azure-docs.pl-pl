...
Aby rozpocząć przesyłanie strumieniowe dziennika, użyj [końcowego fragmentu dziennika aplikacji sieci Web az](/cli/azure/appservice/web/log#tail) polecenie w powłoce chmury.
