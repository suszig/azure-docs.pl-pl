...
* [How to use a custom Docker image for Web App for Containers](quickstart-custom-docker-image.md) (Używanie niestandardowego obrazu platformy Docker dla usługi Web App for Containers)
