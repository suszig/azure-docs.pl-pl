...
Wszystkie typy aplikacji korzystają ze skalowalnej i elastycznej platformy aplikacji sieci Web, która zapewnia zoptymalizowane środowisko programowania obejmujące pełny cykl życia aplikacji — od ich projektowania po obsługę. Funkcje cyklu życia gwarantują deweloperom następujące możliwości:
...
* Uruchamianie zadań asynchronicznych i zadań wsadowych — można uruchamiać kod w tle lub aktywować go na podstawie zdarzeń (na przykład wiadomości kierowanych do kolejki usługi Azure Storage) i zaplanowanych godzin (za pomocą usługi CRON).
