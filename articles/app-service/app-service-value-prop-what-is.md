...
- **Web アプリやモバイル アプリの迅速構築** - 迅速に構築、展開および管理 web およびモバイル アプリ、従業員や単一のバックエンドを使用しているお客様向けです。 .NET、Java、NodeJS、PHP、Python など、既存の言語スキルを使用します。 Azure Marketplace に用意されている豊富な API、コネクタ、ロジックのギャラリーへのアクセスにより、開発時間を短縮します。
