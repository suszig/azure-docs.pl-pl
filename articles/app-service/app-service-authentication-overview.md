...
### <a id="obotosaas"></a>その他のリソースにアクセスするユーザーの同意を取得します。
...
- [.NET サーバー](https://www.nuget.org/packages/Microsoft.Azure.Mobile.Server/)
...
* API Apps のリソース
    ...
    * [API Apps サーバー フロー](#apiaserver)
    * [API Apps での代理呼び出し](#apiaobo)
* Mobile Apps のリソース
    * [Mobile Apps のクライアント フロー](#maclient)
    * [Mobile Apps サーバー フロー](#maserver)
    * [Mobile Apps での代理呼び出し](#maobo)
...
* [OAuth2、OpenID Connect し、概要 JSON Web トークン (JWT) - PluralSight コース](http://www.pluralsight.com/courses/oauth2-json-web-tokens-openid-connect-introduction)
* [構築と ASP.NET - PluralSight コースの複数のクライアント用 RESTful API をセキュリティ保護](http://www.pluralsight.com/courses/building-securing-restful-api-aspdotnet)
...
* [.NET クライアントから Azure App Service で API アプリの使用](../app-service-api/app-service-api-dotnet-consume.md) - 認証された呼び出しのサンプル アプリケーションは、サーバー フローを示していますが、その後は、 [クライアント フロー](../app-service-api/app-service-api-dotnet-consume.md#client-flow) セクションのサンプル コードです。
...
* [.NET クライアントから Azure App Service で API アプリの使用](../app-service-api/app-service-api-dotnet-consume.md) -認証された呼び出しのサンプル コードは、サーバー フローを示しています。

### <a id="apiaobo"></a>API Apps での代理呼び出し

* [展開し、Azure App Service での SaaS コネクタ API アプリの構成](../app-service-api/app-service-api-connnect-your-app-to-saas-connector.md) - 事前にパッケージされたコネクタ API アプリのプロビジョニング、構成する方法について説明し、ブラウザー ツールを使用した呼び出し。
...
* [IOS アプリに Azure Active Directory シングル サインオンを追加します。](../app-service-mobile/app-service-mobile-dotnet-backend-ios-aad-sso-preview.md)

### <a id="maserver"></a>Mobile Apps サーバー フロー

* [IOS アプリに認証を追加します。](../app-service-mobile/app-service-mobile-dotnet-backend-ios-get-started-users-preview.md)
* [Xamarin.iOS アプリに認証を追加します。](../app-service-mobile/app-service-mobile-dotnet-backend-xamarin-ios-get-started-users-preview.md)
* [Xamarin.Android アプリに認証を追加します。](../app-service-mobile/app-service-mobile-dotnet-backend-xamarin-android-get-started-users-preview.md)
* [Windows アプリに認証を追加します。](../app-service-mobile/app-service-mobile-dotnet-backend-windows-store-dotnet-get-started-users-preview.md)

### <a id="maobo"></a>セキュリティで保護されたリソースへの Mobile Apps の代理としての呼び出し

* [アクセス トークンを取得し、モバイル アプリで SharePoint API を呼び出す](../app-service-mobile/app-service-mobile-dotnet-backend-get-started-connect-to-enterprise.md#obtain-token)
