...
3. Po pomyślnym wdrożeniu sieci wirtualnej w grupie zasobów spójrz ponownie na historię wdrażania. Są w niej teraz wyświetlone dwa wdrożenia. Jeśli drugie wdrożenie nie jest widoczne, może być konieczne zamknięcie i ponowne otwarcie bloku grupy zasobów. Wybierz nowsze wdrożenie.
