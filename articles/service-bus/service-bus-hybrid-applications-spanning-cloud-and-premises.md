...
- [リレー型メッセージングと仲介型メッセージング](service-bus-messaging-overview.md)

## 構築

- [Service Bus リレーを使用する内部設置型/クラウド ハイブリッド アプリケーションをビルドする](service-bus-dotnet-hybrid-app-using-service-bus-relay.md)
