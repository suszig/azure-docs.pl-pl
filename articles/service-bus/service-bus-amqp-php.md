...
Service Bus .NET API でメッセージ アプリケーションのプロパティが格納されている、 **プロパティ** のコレクション [BrokeredMessage:operator[]][]します。 次のコードは、PHP クライアントから受信したメッセージのアプリケーションのプロパティを読み取る方法を示しています。
