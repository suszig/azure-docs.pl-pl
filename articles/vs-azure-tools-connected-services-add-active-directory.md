...
質問してヘルプを表示します。
 ...
 - [Azure AD の MSDN フォーラム:](https://social.msdn.microsoft.com/forums/azure/home?forum=WindowsAzureAD)

 - [Azure AD に関するドキュメント](http://azure.microsoft.com/documentation/services/active-directory/)
