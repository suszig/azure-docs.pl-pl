...
### [Konfigurowanie publicznego modułu równoważenia obciążenia (klasyczny program PowerShell)](load-balancer-get-started-internet-classic-ps.md)
#### [Konfigurowanie publicznego modułu równoważenia obciążenia (chmura klasyczna)](load-balancer-get-started-internet-classic-cloud.md)
#### [Konfigurowanie publicznego modułu równoważenia obciążenia (klasyczny interfejs wiersza polecenia)](load-balancer-get-started-internet-classic-cli.md)
