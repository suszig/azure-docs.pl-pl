...
サービスと同じ仮想ネットワーク内の仮想マシン
サービスと接続されているオンプレミス ネットワークから仮想マシン
サービスと Vm、相互接続された Vnet
...
次の例では、"subnet-1"と呼ばれるサブネットが含まれる仮想ネットワークを構成します。
...
SQL AlwaysOn の作成の詳細を検索する [チュートリアル: Azure AlwaysOn 可用性グループ](https://msdn.microsoft.com/library/dn249504.aspx) または [ポータル ギャラリーを使用して](http://blogs.technet.com/b/dataplatforminsider/archive/2014/08/25/sql-server-alwayson-offering-in-microsoft-azure-portal-gallery.aspx)します。
