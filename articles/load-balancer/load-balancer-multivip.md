...
>[AZURE.NOTE] これらをエンドポイントに関連付けると、サブスクリプションは余分な VIP にのみ課金されます。 料金の詳細については、次を参照してください。 [IP アドレスの料金](http://azure.microsoft.com/pricing/details/ip-addresses/)します。
...
[インターネットに接続するロード バランサーの開始します。](load-balancer-internet-getstarted.md)
