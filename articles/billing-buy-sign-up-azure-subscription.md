...
![個人情報のスクリーンショット](./media/billing-buy-sign-up-azure-subscription/AboutYou.png)

 **注** 最初にサインアップするときに国を設定します。後で国を変更することはできません。電子メール アドレスと Azure サブスクリプションにサインアップするときに指定した国の情報が常に、サブスクリプションに関連付けられているありは後で変更することはできません。</br>
...
6. **[契約]** セクションで、サブスクリプション契約、プランの詳細、プライバシーに関する声明に同意する場合は、チェック ボックスをオンにします。 その後、**[サインアップ]** を選択します。
 ...
 **申し訳ありませんが、操作を完了できませんでした。後でもう一度試すか、web ページを再読み込みください** </br>
...
3. 選択 **はい**, 、し、[ **今すぐアップグレード**します。 </br>![upgrade](./media/billing-buy-sign-up-azure-subscription/Upgrade.png)
...
2. プロダクト キーを入力し、アグリーメントのオプションを確認します。</br>![OSA KEY](./media/billing-buy-sign-up-azure-subscription/OSAkey.png)
3. **[アクティブ化]** を選択します。
