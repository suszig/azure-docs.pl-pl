 ...
 **注** 最初にサインアップすると、国の設定、後で、国を変更することはできません。 電子メール アドレスと Azure サブスクリプションにサインアップするときに指定した国の情報が常に、サブスクリプションに関連付けられているありは後で変更することはできません。</br>
 ...
 **申し訳ありませんが、操作を完了できませんでした。 後で再試行するか、web ページを再読み込みしてください。** </br>
...
2. サブスクリプションを選択し、[ **アップグレード**します。</br>![billpage](./media/billing-buy-sign-up-azure-subscription/billpage.png)
