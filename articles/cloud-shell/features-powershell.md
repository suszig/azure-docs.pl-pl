...
|**Kategoria**    |**Nazwa**                                 |
|----------------|-----------------------------------------|
|Narzędzia platformy Azure     |[Program Azure PowerShell (5.1.1)](https://docs.microsoft.com/powershell/azure/overview?view=azurermps-5.1.1)<br> [Azure CLI (2.0.22)](https://docs.microsoft.com/cli/azure/overview)|
