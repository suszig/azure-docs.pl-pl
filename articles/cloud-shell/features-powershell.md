...
|**Kategoria**    |**Nazwa**                                 |
|----------------|-----------------------------------------|
|Narzędzia platformy Azure     |[Program Azure PowerShell (4.4.1)](https://docs.microsoft.com/powershell/azure/overview?view=azurermps-4.4.1)<br> [Azure CLI (2.0.20)](https://docs.microsoft.com/en-us/cli/azure/overview)|
