---
title: Zabezpieczanie zasobów w chmurze przy użyciu usługi Azure Multi-Factor Authentication i usług AD FS
...
1. Włącz konta użytkowników, wykonując instrukcje podane w opisie [włączania uwierzytelniania wieloskładnikowego](multi-factor-authentication-get-started-cloud.md#turn-on-multi-factor-authentication-for-users)
