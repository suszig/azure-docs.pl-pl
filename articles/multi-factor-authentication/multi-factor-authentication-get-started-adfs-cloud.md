...
1. 説明する手順を使用して [多要素認証をオン](active-directory/multi-factor-authentication-get-started-cloud.md#turn-on-multi-factor-authentication-for-users) ユーザー アカウントを有効にするためです。
...
6. [サービス設定] ページの [信頼済み Ip を選択 **イントラネットから送信されたフェデレーション ユーザーからの要求。**
