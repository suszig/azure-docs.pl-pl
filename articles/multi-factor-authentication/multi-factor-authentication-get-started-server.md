...
6. サービスの設定] ページで、画面の下部にあるクリックして **ポータルに移動する**します。
...
:------------- | :------------- |
 ハードウェア| <li>200 MB のハード_ディスク領域</li><li>x32 または x64 対応プロセッサ</li><li>1 GB または大きい RAM</li>
 ソフトウェア| <li>Windows Server 2003 以降、ホストがサーバー OS 場合</li><li>Windows Vista またはホストがクライアント OS の場合は、大きい</li><li>Microsoft .NET Framework 2.0</li><li>サービス SDK を IIS 6.0 以降、ユーザー ポータルまたは web をインストールする場合</li>
