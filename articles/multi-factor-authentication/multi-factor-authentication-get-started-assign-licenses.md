...
Jeśli zakupiono licencję usługi Azure MFA, usługi Azure AD w wersji Premium lub pakietu Enterprise Mobility Suite, nie trzeba tworzyć dostawcy usługi Multi-Factor Authentication. Wystarczy po prostu przypisać licencje użytkownikom, a następnie umożliwić im korzystanie z usługi MFA.

## Aby przypisać licencję usługi Azure MFA, usługi Azure AD w wersji Premium lub pakietu Enterprise Mobility Suite
--------------------------------------------------------------------------------
...
8. Pojawi się komunikat z informacją o liczbie przypisanych licencji i liczbie ewentualnych niepowodzeń przypisań licencji.  Kliknij przycisk **OK**.
