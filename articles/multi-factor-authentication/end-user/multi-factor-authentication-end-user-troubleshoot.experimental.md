...
3. Wybierz opcję weryfikacji, który ma być używany. 
  - Jeśli nie masz dostępu do Twojej alternatywne metody albo, skontaktuj się z pomocą firmy obsługuje uzyskanie pomocy przy logowaniu do Twojego konta.
...
Jeśli Twój telefon zostało zgubione lub skradzione, zalecamy również Przekaż programowi obsługi Twojej firmy. Będzie możliwe dopiero zresetowania hasła aplikacji, a następnie wyczyść żadnego zapamiętanych urządzeniach. 
