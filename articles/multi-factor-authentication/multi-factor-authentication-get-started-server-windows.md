...
>[AZURE.NOTE]Windows Server 2012 R2 上のセキュリティで保護されたターミナル サービスには、この機能がサポートされていません。
...
1. Azure Multi-factor Authentication Server では、Windows 認証] アイコンをクリックします。
