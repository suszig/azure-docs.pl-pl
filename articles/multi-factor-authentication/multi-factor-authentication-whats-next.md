...
[記憶されたデバイスとブラウザーに対する Multi-Factor Authentication を一時停止する (パブリック プレビュー)](#suspend-multi-factor-authentication-for-remembered-devices-and-browsers-public-preview)|ユーザーが MFA を使用して正常にサインインした後、一定の日数の間 MFA を一時停止できます。|この機能の有効化と日数の設定に関する情報
...
<center>![クラウド](./media/multi-factor-authentication-whats-next/fraud.png)</center>
...
<center>![クラウド](./media/multi-factor-authentication-whats-next/report1.png)</center>
...
<center>![クラウド](./media/multi-factor-authentication-whats-next/create2.png)</center>
...
<center>![クラウド](./media/multi-factor-authentication-whats-next/report.png)</center>
...
<center>![クラウド](./media/multi-factor-authentication-whats-next/custom2.png)</center>

<li>[構成: 新しい電話メッセージ] ページで、[音声ファイルの管理] をクリックします。</li>

<center>![クラウド](./media/multi-factor-authentication-whats-next/custom3.png)</center>

<li>[構成: 音声ファイル] ページで、[ 音声ファイルのアップロード ] をクリックします。</li>

<center>![クラウド](./media/multi-factor-authentication-whats-next/custom4.png)</center>
...
<center>![クラウド](./media/multi-factor-authentication-whats-next/custom5.png)</center>
...
フェデレーション|<li>すべてのフェデレーション ユーザー - には、サインインから組織内にあるすべてのフェデレーション ユーザーには、AD FS によって発行されたクレームを使用して多要素認証をバイパスします。</li><li>特定の IP アドレス範囲 – 管理者は、会社のイントラネットからサインインするユーザーの多要素認証をバイパスできる範囲の IP アドレスを指定できます。
...
|信頼できる Ip enabled|信頼済み ip 機能を無効になっています
:------------- | :------------- | :------------- | 
内部 corpnet|ブラウザーのフロー多要素認証が必要ありません |。ブラウザーのフローで、多要素認証が必要です。
|リッチ クライアント アプリは、ユーザーがアプリ パスワードを作成していない場合に通常のパスワードが機能します。 アプリ パスワードを作成すると、アプリ パスワードが必要です |。リッチ クライアント アプリをアプリ パスワードが必要
外部 corpnet|ブラウザーのフローで、多要素認証が必要です |。ブラウザーのフローは、多要素認証が必要です。
...
<li>[サービス設定] ページの [信頼できる IP] で、次のいずれかを選択します。
<ul>
<li>イントラネットから発信するフェデレーション ユーザーからの要求の場合 - 企業ネットワークからサインインするすべてのフェデレーション ユーザーは、AD FS によって発行されたクレームを使用して多要素認証をバイパスします。 
...
<center>![クラウド](./media/multi-factor-authentication-whats-next/trustedips.png)</center>
...
:------------- | :------------- | :------------- 
|<ul><li>認証の第 1 要素はオンプレミスで実行されます。</li><li>第 2 要素は、クラウド Id で実行される電話ベースの方法です。</li>|<ul><li>管理者とユーザーの場合は、サインインをアプリ パスワードを使用できます。
...
>[AZURE.WARNING]  アプリ パスワードは、クライアントがオンプレミスと通信して、自動検出エンドポイントをクラウドのハイブリッド環境では機能しません。
>
...
<center>![クラウド](./media/multi-factor-authentication-whats-next/naming.png)</center>
...
<center>![追加のセキュリティ確認](./media/multi-factor-authentication-whats-next/federated.png)</center>
...
<center>![クラウド](./media/multi-factor-authentication-whats-next/security.png)</center>
...
<center>![クラウド](./media/multi-factor-authentication-whats-next/app2.png)</center>
...
<center>![クラウド](./media/multi-factor-authentication-whats-next/myapp.png)</center>
...
> [AZURE.NOTE] この機能は、ブラウザーの cookie キャッシュとして実装されます。 ブラウザーのクッキーが有効でない場合は機能しません。
