...
9.  Stan użytkownika zmieni się z **Wyłączony** na **łączony**.
![Włączanie użytkowników](./media/multi-factor-authentication-get-started-cloud/user.png)
10.  Po włączeniu użytkowników zaleca się powiadomienie ich o tym za pośrednictwem poczty e-mail.  Należy ich również poinformować, jak powinni używać aplikacji niekorzystających z przeglądarki, aby uniknąć zablokowania.
