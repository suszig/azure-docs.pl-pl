...
3. [Active Directory] ページの上部で [Multi-Factor Authentication Provider] をクリックします。 下部にあるをクリックして **新規**します。
...
有効 |ユーザーは多要素認証に登録されています。|いいえ、できません。  登録プロセスが完了するまで動作し続けます。|ユーザーは有効ですが、登録プロセスが完了していません。 次回サインインするときにプロセスを完了するよう求められます。
