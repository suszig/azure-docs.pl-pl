...
[わからない](#creating-and-deleting-app-passwords-with-myapps-portal)|これでアプリ パスワードを作成することを意味 [https://myapps.microsoft.com](https://myapps.microsoft.com)
...
![セットアップ](./media/multi-factor-authentication-end-user-manage/o365a.png)
5. 設定を変更できるページに移動します。
![クラウド](./media/multi-factor-authentication-end-user-manage/o365b.png)
6. 追加のセキュリティ確認の横にある、上部にあるをクリックして **アプリ パスワードです。**
7. クリックして **作成**します。
![クラウド](./media/multi-factor-authentication-end-user-app-passwords-create-o365/apppass.png)
8. アプリ パスワードの名前を入力し、クリックして **次**します。
![アプリ パスワードを作成します。](./media/multi-factor-authentication-end-user-app-passwords/create1.png)
...
![クラウド](./media/multi-factor-authentication-end-user-manage/o365b.png)
6. 追加のセキュリティ確認の横にある、上部にあるをクリックして **アプリ パスワードです。**
7. アプリ パスワードを削除するの横にある **削除**します。
![アプリ パスワードを削除します。](./media/multi-factor-authentication-end-user-app-passwords/delete1.png)
8. クリックして、削除の確認 **はい**します。
![削除を確認します。](./media/multi-factor-authentication-end-user-app-passwords/delete2.png)
9. アプリ パスワードが削除された後は、クリックして **閉じる**します。
![閉じる](./media/multi-factor-authentication-end-user-app-passwords/delete3.png)
...
5. 追加のセキュリティ確認の横にある、上部にあるをクリックして **アプリ パスワードです。**
6. クリックして **作成**します。
![アプリ パスワードを作成します。](./media/multi-factor-authentication-end-user-app-passwords/create3.png)
7. アプリ パスワードの名前を入力し、クリックして **次**します。
![アプリ パスワードを作成します。](./media/multi-factor-authentication-end-user-app-passwords/create1.png)
...
![セットアップ](./media/multi-factor-authentication-end-user-manage-myapps/proofup.png)
5. 追加のセキュリティ確認の横にある、上部にあるをクリックして **アプリ パスワードです。**
6. アプリ パスワードを削除するの横にある **削除**します。
![アプリ パスワードを削除します。](./media/multi-factor-authentication-end-user-app-passwords/delete1.png)
7. クリックして、削除の確認 **はい**します。
![削除を確認します。](./media/multi-factor-authentication-end-user-app-passwords/delete2.png)
8. アプリ パスワードが削除された後は、クリックして **閉じる**します。
![閉じる](./media/multi-factor-authentication-end-user-app-passwords/delete3.png)
...
4. クリックして **作成**します。
5. アプリ パスワードの名前を入力し、クリックして **次へ]**
6. アプリ パスワードをクリップボードにコピーし、アプリに貼り付けます。
![クラウド](./media/multi-factor-authentication-end-user-app-passwords-create-azure/app2.png)

### Azure ポータルでアプリ パスワードを削除するには

1. Microsoft Azure 管理ポータルにサインインします。
2. 上部のユーザー名を右クリックし、[追加のセキュリティ確認] を選択します。
3. 追加のセキュリティ確認の横にある、上部にあるをクリックして **アプリ パスワードです。**
4. アプリ パスワードを削除するの横にある **削除**します。
5. クリックして、削除の確認 **はい**します。
6. アプリ パスワードが削除された後は、クリックして **閉じる**します。
![閉じる](./media/multi-factor-authentication-end-user-app-passwords/delete3.png)
