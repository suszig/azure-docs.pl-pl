...
> [AZURE.NOTE]  このページに表示される次のドキュメントは、一般的なサインイン エクスペリエンスを示しています。  ヘルプを参照してくださいサインインを [Azure 多要素認証で問題が発生](multi-factor-authentication-end-user-manage-settings.md)
