...
- [Machine Learning web サービスを配置します。](machine-learning-publish-a-machine-learning-web-service.md)
- [ML Studio の概要](http://azure.microsoft.com/documentation/videos/getting-started-with-ml-studio/)
...
## <a id="connect"></a>Azure Machine Learning web サービスへの接続します。
...
Azure ML API ヘルプ ページは、Web サービスをデプロイするときに作成されます。 参照してください [Azure Machine Learning チュートリアル - Web サービスをデプロイする](machine-learning-walkthrough-5-publish-web-service.md)します。
