...
Inżynieryjne i wybór funkcji jest jedną z części z zespołu danych nauki procesu (TDSP) opisane w temacie [co to jest proces zespołu danych nauki?](overview.md). Funkcja inżynieryjne i wyboru są częściami **opracowywania funkcji** krok TDSP.
