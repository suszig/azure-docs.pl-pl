...
R、ブログの投稿 [ビルドと展開予測 Web アプリを使用して RStudio を参照してください。
Azure
...
マシン
Learning](machine-learning-walkthrough-develop-predictive-solution.md) します。
...
これを行う方法の詳細については、[Azure のマシンを使用する方法を参照してください。
Machine Learning から展開済み learning web サービス
experiment](machine-learning-consume-web-services.md) します。

Web サービスでは、予測実験および web を展開する 1 回
サービスに接続しておくし、それらの間の前後に移動できます。

| *** このページから ***| *** ここをクリックして. ***| *** このページを開くには ***|
| ------------------- | --------------- | ---------------------- |
...
1.  **Web サービスの実行中に、モデルの再トレーニング** - する場合
    ...
    実験すること、 *** 再トレーニング実験 ***, を選択できます
    展開として、 *** web * サービスを再トレーニング**します。 手順について
    これには、[Machine Learning の再トレーニング モデルを参照してください。
    programmatically](machine-learning-retrain-models-programmatically.md) します。

2.  * * に戻り、元のトレーニング実験を別の使用
    トレーニング データのモデル * * の予測実験を開発するには
    web サービスにリンクされているが、トレーニング実験はありません
    この方法で直接関連します。 元のトレーニングを変更する場合
    をクリックして **Web サービスのセットアップ**, が自動的に作成、 *新しい*
    予測実験を展開すると、作成、 *新しい*
...
-   -[Convert Machine Learning トレーニング実験に変換します。
    実際に試して experiment](machine-learning-convert-training-experiment-to-scoring-experiment.md) を予測する

-   [展開 Azure Machine Learning web - web サービスの展開
    service](machine-learning-publish-a-machine-learning-web-service.md)

-   [Machine Learning の再トレーニング モデル、モデルを再トレーニング
