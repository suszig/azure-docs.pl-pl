...
3. *トレーニング実験を Web サービスとして発行します。*
    トレーニング済みモデルの再トレーニングするには、Web サービスとして上記の手順 1 で作成したトレーニング実験を発行する必要があります。 この Web サービスは、Web サービスの出力モジュールが新しいトレーニング済みモデルを作成できるように、[モデルのトレーニング] [モデルのトレーニング] モジュールに接続されている必要があります。
