...
3. 公開された web サービスの URL を使用して、への公開 [Azure Marketplace (データ マーケット)](https://publish.windowsazure.com/workspace/)
...
1.  に移動 [Azure Marketplace (データ マーケット)](http://datamarket.azure.com/home)
2.  ページの上部にある **[発行]** リンクをクリックします。 へ移動する [Microsoft Azure 発行ポータル](https://publish.windowsazure.com)
