...
* 表 1. です。 アルゴリズム * の一般的なパフォーマンス (正確度)
...
上記の 4 つのカテゴリを利用すると、カテゴリごとの合理的なファクターによるインデックスに基づいた、単純かつ "決定論的" なアプローチにより、離反のリスクがある顧客を十分特定できるという楽観的な誤解が生じます。** これはもっともらしく思えるものの、残念なことに間違った理解です。 というのも、離反というものは一時的な現象であり、離反に影響するファクターは一般に不変ではないためです。 今顧客が離反を検討している理由は、明日には変わる可能性があります。そして 6 か月もすれば確実に変わっています。 だからこそ*確率論的*モデルが不可欠なのです。
...
[[正確度と精度] 2][accuracy and precision](http://en.wikipedia.org/wiki/Accuracy_and_precision) Wikipedia の「

[3 ][crisp-dm 1.0: step-by-step data mining guide](http://www.the-modeling-agency.com/crisp-dm.pdf)

[4] は、ビッグ データ マーケティング

[5 ][big data marketing: engage your customers more effectively and drive value](http://www.amazon.com/Big-Data-Marketing-Customers-Effectively/dp/1118733894/ref=sr_1_12?ie=UTF8 & ある qid = 1387541531 & sr = 8 ~ 12 & キーワード顧客を = + チャーン)
