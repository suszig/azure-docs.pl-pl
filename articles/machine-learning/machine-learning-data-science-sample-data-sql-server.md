...
>[AZURE.NOTE] このドキュメントにあるサンプルの SQL コードは、データが Azure の SQL Server に存在することを前提としています。 いない場合を参照してください [Azure に SQL Server にデータを移動する](machine-learning-data-science-move-sql-server-virtual-machine.md) 手順については、Azure で SQL Server にデータを移行する方法に関するトピック。
...
## <a name="python"></a>Python プログラミング言語を使用します。
...
3. 次のスクリーン ショットに示すように、Azure ML の**リーダー モジュールを使用して Azure BLOB からデータを読み取ります。
