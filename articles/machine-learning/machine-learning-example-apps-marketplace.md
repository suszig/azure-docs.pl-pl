...
[ドキュメント](machine-learning-apps-text-analytics.md)
 ...
 コード チャーンの ##Customer 予測 ##
顧客離れの予測とは、Azure Machine Learning で構築された顧客離れ分析サービスです。 (プレーヤー、サブスクライバー、ユーザーなど) の顧客を予測になっています 会社またはサービスと自分の関係を終了する可能性があります。 企業との関係を辞める可能性の高い顧客を予測できるため、企業は、顧客との交渉の機会を高め、解約の可能性を削減することができます。
