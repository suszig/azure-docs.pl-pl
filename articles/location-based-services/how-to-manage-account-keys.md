...
Twoje konto usługi na podstawie lokalizacji platformy Azure i klucze za pomocą portalu Azure można zarządzać. Po utworzeniu konta i klucz subskrypcji, można zaimplementować interfejsów API w witrynie sieci web lub aplikacji mobilnej.
