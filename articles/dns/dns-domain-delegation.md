<properties
   pageTitle="Delegowanie domeny do usługi Azure DNS | Microsoft Azure"
...
# Delegowanie domeny do usługi Azure DNS
...
Domena jest unikatową nazwą w systemie nazw domen, na przykład „contoso.com”. Strefa DNS jest używana do hostowania rekordów DNS dla konkretnej domeny. Na przykład domena „contoso.com” może zawierać wiele rekordów DNS, takich jak „mail.contoso.com” (dla serwera poczty) i „www.contoso.com” (dla witryny sieci Web).
...
>[AZURE.NOTE] Aby dowiedzieć się, kto jest właścicielem danej nazwy domeny lub uzyskać informacje o tym, jak kupić domenę, zobacz [Zarządzanie domenami internetowymi w usłudze Azure AD](https://msdn.microsoft.com/library/azure/hh969248.aspx).
...
Gdy cykliczny serwer DNS odbiera zapytanie dotyczące rekordu DNS takiego jak „www.contoso.com”, najpierw musi znaleźć serwer nazw hostujący strefę dla domeny „contoso.com”. W tym celu rozpoczyna od serwerów nazw głównych i wyszukuje serwery nazw hostujące strefę „com”. Następnie wykonuje zapytanie na serwerach nazw „com”, aby znaleźć serwery nazw hostujące strefę „contoso.com”.  Na koniec jest w stanie wykonać na tych serwerach nazw zapytanie dla „www.contoso.com”.
...
>[AZURE.NOTE] Nie musisz być właścicielem domeny, aby utworzyć strefę DNS z tą nazwą domeny w usłudze Azure DNS. Musisz być jednak właścicielem domeny, aby skonfigurować delegowanie do usługi Azure DNS u rejestratora.
...
### Znajdowanie nazw serwerów nazw
...
## Delegowanie domen podrzędnych w usłudze Azure DNS

Jeśli chcesz skonfigurować oddzielną strefę podrzędną, możesz delegować domenę podrzędną w usłudze Azure DNS. Na przykład załóżmy, że po skonfigurowaniu i delegowaniu domeny „contoso.com” w usłudze Azure DNS chcesz skonfigurować oddzielną strefę podrzędną „partners.contoso.com”.
...
### Aby delegować domenę podrzędną
...
#### Krok 1. Tworzenie stref nadrzędnych i podrzędnych
