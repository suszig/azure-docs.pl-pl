...
次の例では、レコード セットとレコードの作成方法を示します。 その他のレコードの種類がを参照してください、'A' の DNS レコードの種類を使用します [DNS レコードを管理する方法](dns-operations-recordsets.md)
...
[DNS ゾーンを管理する方法](dns-operations-dnszones.md)
