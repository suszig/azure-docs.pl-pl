...
このサービスは、Azure リソース マネージャー (ARM) に基づいています。  ドメインとレコードは、Azure リソース マネージャー REST API、.NET SDK、PowerShell コマンドレット、コマンド ライン インターフェイスを使用して管理できます。  Azure DNS は、現在プレビュー段階にあり、Azure 管理ポータルでまだサポートされていません。<BR><BR>
