...
W dolnej części bloku Strefa DNS wyświetlone są rekordy dla strefy DNS. Powinny zostać wyświetlone domyślne rekordy NS i SOA tworzone w każdej strefie oraz wszystkie nowo utworzone rekordy.
