<properties
   pageTitle="Omówienie usługi Access Control w usłudze Data Lake Store | Microsoft Azure"
...
>[AZURE.NOTE] Zmiana domyślnej listy ACL w lokalizacji nadrzędnej nie wpływa na listę ACL dostępu lub domyślną listę ACL elementów podrzędnych, które już istnieją.
...
>[AZURE.NOTE] Uprawnienia do zapisu dla pliku nie są wymagane do usunięcia pliku, jeśli dwa powyższe warunki pozostają spełnione.
...
>[AZURE.NOTE] Użytkownik będący właścicielem **nie może** zmienić użytkownika będącego właścicielem innego pliku. Tylko administratorzy mogą zmieniać użytkowników będących właścicielami pliku lub folderu.
...
>[AZURE.NOTE] W przypadku nowego konta usługi Data Lake Store maski dla listy ACL dostępu i domyślnej listy ACL folderu głównego („/”) są domyślnie maskami RWX.
