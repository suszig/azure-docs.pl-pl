---
title: "Azure przykładowego kodu json zasad - Użyj zatwierdzone sieci wirtualnej maszyny Wirtualnej w interfejsach sieciowych | Dokumentacja firmy Microsoft"
description: "Ta zasada próbki json wymaga, aby interfejsów sieciowych używać zatwierdzonych sieci wirtualnej."
...
---
# <a name="use-approved-vnet-for-vm-network-interfaces"></a>Użyj zatwierdzonych sieci wirtualnej maszyny Wirtualnej w interfejsach sieciowych

Ta zasada wymaga, aby interfejsów sieciowych używać zatwierdzonych sieci wirtualnej. Należy określić identyfikator zatwierdzonych sieci wirtualnej.
