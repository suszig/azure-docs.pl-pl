---
title: "Azure json zasad przykładowe — Zezwalaj niestandardowego obrazu maszyny Wirtualnej z grupy zasobów | Dokumentacja firmy Microsoft"
description: "Ta zasada próbki json wymaga, że niestandardowe obrazy pochodzą z grupy zasobów zatwierdzone."
...
---
# <a name="allow-custom-vm-image-from-a-resource-group"></a>Zezwalaj na niestandardowe obrazu maszyny Wirtualnej z grupy zasobów

Ta zasada próbki json wymaga, że niestandardowe obrazy pochodzą z grupy zasobów zatwierdzone. Należy określić nazwę grupy zasobów zatwierdzone.
...
Dodatkowe przykłady szablonów zasad usługi Azure można znaleźć w dokumentacji usługi Azure zasad
