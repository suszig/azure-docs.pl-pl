---
title: "Azure przykładowego kodu json zasad — ustawienie inspekcji poziomu inspekcji bazy danych SQL | Dokumentacja firmy Microsoft"
description: "Ta zasada próbki json inspekcji ustawienia inspekcji bazy danych SQL, jeśli te ustawienia są niezgodne z określonego ustawienia."
...
---
# <a name="audit-sql-db-level-audit-setting"></a>Inspekcja inspekcji na poziomie bazy danych SQL.

Te zasady inspekcji ustawienia inspekcji bazy danych SQL, jeśli te ustawienia są niezgodne z określonej wartości. Można określić wartość, która wskazuje, czy ustawienia inspekcji powinny być włączone lub wyłączone.
