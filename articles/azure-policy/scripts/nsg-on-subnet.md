---
title: "Azure zasad przykładowy kod json - NSG x w każdej podsieci | Dokumentacja firmy Microsoft"
description: "Ta zasada próbki json wymaga określonych sieciowej grupy zabezpieczeń jest z wszystkich podsieci wirtualnych."
...
---
# <a name="nsg-x-on-every-subnet"></a>Grupa NSG x w każdej podsieci

Te zasady wymagają, że grupy zabezpieczeń określonej sieci jest używana z wszystkich podsieci wirtualnych. Należy określić identyfikator sieciowej grupy zabezpieczeń do użycia.
