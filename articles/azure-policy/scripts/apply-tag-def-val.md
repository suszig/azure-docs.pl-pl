---
title: "Azure json zasad przykładowe - zastosowanie tagu i ich wartości domyślne | Dokumentacja firmy Microsoft"
description: "Ta zasada próbki json dołącza określonego tagu nazwy i wartości, jeśli nie dostarczanej tag."
...
---
# <a name="apply-tag-and-its-default-value"></a>Stosuje tag i wartość domyślną

Ta zasada dołącza określonego tagu nazwy i wartości, jeśli nie podano tagu. Można określić nazwy tagu i wartości do zastosowania.
