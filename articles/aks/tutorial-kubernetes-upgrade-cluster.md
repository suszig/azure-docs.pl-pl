---
title: "Kubernertes na Azure samouczek — klastra aktualizacji | Dokumentacja firmy Microsoft"
description: "Kubernertes na Azure samouczek — aktualizacji klastra"
...
Tutaj można zobaczyć, że bieżąca wersja węzła jest `1.7.7` i tej wersji `1.8.1` jest dostępna.
...
Użyj `az aks upgrade` polecenie Uaktualnij węzły klastra. Poniższe przykłady aktualizuje klastra do wersji `1.8.1`.
