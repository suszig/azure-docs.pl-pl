<properties 
   pageTitle="Wdrażanie urządzenia StorSimple z aktualizacją Update 1 | Microsoft Azure"
...
> [AZURE.IMPORTANT] Menedżer StorSimple może tworzyć tylko woluminy alokowane elastycznie. Nie można tworzyć w pełni lub częściowo inicjowanych woluminów. 
...
3.  Zostanie utworzone zadanie aktualizacji. Aby monitorować stan aktualizacji, przejdź do pozycji **Zadania**.
    ...
    > [AZURE.NOTE] Po uruchomieniu zadania aktualizacji stan zostanie od razu wyświetlony na poziomie 50 procent. Stan zmieni się na 100% dopiero po zakończeniu zadania aktualizacji. Zmiana stanu procesu aktualizacji w czasie rzeczywistym nie jest wyświetlana.
...
## Konfigurowanie wielościeżkowego wejścia/wyjścia (MPIO)
...
> [AZURE.NOTE] Wielościeżkowe wejście/wyjście (MPIO) nie jest obsługiwane na urządzeniu wirtualnym StorSimple. 
