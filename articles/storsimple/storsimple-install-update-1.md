...
- **オプション 1**: 更新プログラムをダウンロードして使用して適用して、 `Start-HcsHotfix` デバイスの Windows PowerShell インターフェイスからコマンドレットです。 これが推奨される方法です。 **デバイスが Update 1.0 または Update 1.1 を実行している場合は、この方法で Update 1.2 を適用しないでください。** 
