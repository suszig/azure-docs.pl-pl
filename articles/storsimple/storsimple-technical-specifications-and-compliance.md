...
10 GbE ネットワーク インターフェイス、DATA 2 と DATA 3 を参照してください、 [サポートされるネットワーク ケーブルとモジュールの一覧](storsimple-supported-hardware-for-10-gbe-network-interfaces.md)します。

## 次のステップ

StorSimple デバイスの仕様に関する詳細については、ダウンロード、 [StorSimple 8000 シリーズの仕様](http://storsimple.seagate.com/Specifications-8000)します。  
