...
Urządzenie StorSimple ma dwa 240 100 wentylator podwójne, zgodne SBB Power chłodzenia modułów (PCMs). Zapewnia to konfiguracji nadmiarowy. W przypadku niepowodzenia PCM urządzenie w dalszym ciągu działać normalnie na inne PCM, dopóki nie zostanie zastąpiony modułu nie powiodło się.  
...
Teraz można przystąpić do wdrażania urządzenia StorSimple w centrum danych. Aby uzyskać więcej informacji, zobacz [wdrażanie lokalnego urządzenia](storsimple-deployment-walkthrough-u2.md).  
