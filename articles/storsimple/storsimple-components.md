...
> [AZURE.NOTE] Microsoft Azure web サイトで公開する StorSimple のデプロイ情報は、StorSimple 8000 シリーズ デバイスのみに適用されます。 7000 シリーズ デバイスについてを参照してください: [StorSimple ヘルプ](http://onlinehelp.storsimple.com/)します。
...
詳細については、次を参照してください。 [StorSimple ハードウェア コンポーネントと状態](storsimple-monitor-hardware-status.md)します。
...
詳細については、次を参照してください。 [StorSimple 仮想デバイス](storsimple-virtual-device.md)します。
...
詳細については、次を参照してください。 [、デバイスを管理する StorSimple 用 Windows PowerShell を使用して](storsimple-windows-powershell-administration.md)します。
...
詳細については、次を参照してください。 [StorSimple Manager サービスを使用した StorSimple デバイスの管理](storsimple-manager-service-administration.md)します。
...
詳細については、次を参照してください。 [StorSimple Snapshot Manager は何ですか。](storsimple-what-is-snapshot-manager.md)
...
詳細については、次を参照してください。 [SharePoint 用 StorSimple アダプター](storsimple-adapter-for-sharepoint.md)します。 
