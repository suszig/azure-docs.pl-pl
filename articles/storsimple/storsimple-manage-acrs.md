...
> [AZURE.IMPORTANT] 
> 
> -ボリュームに ACR を割り当てる際はことボリューム同時にアクセスしていない複数の非クラスター化ホスト ボリュームが破損する可能性がありますのでように注意します。 
> -ボリュームから ACR を削除するときに、対応するホストいないにアクセスしているボリュームの削除は読み取り/書き込みによって中断されるおそれがあるため確認してください。
