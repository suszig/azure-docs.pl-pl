...
PowerShell リモート処理機能は、HTTPS または HTTP で利用することができます。 HTTPS でのリモート管理が有効になっている場合、対象デバイスからリモート管理証明書をダウンロードしてリモート クライアントにインストールする必要があります。 PowerShell リモート処理の詳細についてを参照してください [、StorSimple デバイスにリモートで接続する](storsimple-remote-connect)します。
...
CHAP と StorSimple ソリューションを構成する方法の詳細についてを参照してください [StorSimple デバイスの CHAP を構成する](storsimple-configure-chap.md)します。
...
StorSimple Snapshot Manager の詳細については、を参照してください [StorSimple Snapshot Manager は何ですか?](storsimple-what-is-snapshot-manager.md)
...
- 強力なパスワードを使用します。 詳細についてを参照してください [より強力なパスワードを作成し、保護する](http://blogs.microsoft.com/cybertrust/2014/08/25/create-stronger-passwords-and-protect-them/)します。
...
>
> サービス データ暗号化キーを紛失した場合、マイクロソフトのサポート担当者の支援を得ることでキーを読み出すことができます。そのためには、少なくとも 1 つのデバイスがオンライン状態であることが必要です。 サービス データ暗号化キーは、その取得後に変更するようお勧めします。 手順についてを参照してください [サービス データ暗号化キーを変更する](storsimple-service-dashboard.md#change-the-service-data-encryption-key)します。
...
- [サービス データ暗号化キーを変更します。](storsimple-service-dashboard.md#change-the-service-data-encryption-key)
...
- [表示またはサービス登録キーを再生成](storsimple-service-dashboard.md#view-or-regenerate-the-service-registration-key)
...
- [StorSimple Manager サービスを使用した storsimple のパスワードを変更](storsimple-change-passwords.md)
- [サービス データ暗号化キーを変更します。](storsimple-service-dashboard.md#change-the-service-data-encryption-key)
- [StorSimple デバイスの CHAP を構成します。](storsimple-configure-chap.md)
...
- [StorSimple Snapshot Manager のパスワードを変更します。](storsimple-change-passwords.md#change-the-storsimple-snapshot-manager-password)
- [デバイスを認証します。](storsimple-snapshot-manager-manage-devices.md#authenticate-a-device)
