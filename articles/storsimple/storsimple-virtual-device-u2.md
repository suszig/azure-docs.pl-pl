<properties 
   pageTitle="Urządzenie wirtualne StorSimple z aktualizacją Update 2| Microsoft Azure"
...
#### Porównanie modeli urządzenia wirtualnego
...
## Czym urządzenie wirtualne różni się od urządzenia fizycznego
...
## Wymagania wstępne dotyczące urządzeń wirtualnych
...
#### Wymagania dotyczące urządzenia StorSimple
...
### Krok 3 (opcjonalny): Modyfikowanie ustawień konfiguracji dla urządzeń
...
#### Konfigurowanie inicjatora protokołu CHAP
...
#### Konfigurowanie obiektu docelowego protokołu CHAP
...
#### Konfigurowanie hasła do programu StorSimple Snapshot Manager
...
>[AZURE.NOTE] Dla urządzenia wirtualnego host z systemem Windows jest maszyną wirtualną na platformie Azure.
...
#### Zmiana hasła administratora urządzenia 
...
## Zdalne nawiązywanie połączenia z urządzeniem wirtualnym
...
### Krok 1: Konfigurowanie zdalnego zarządzania
...
### Krok 2: Zdalne uzyskanie dostępu do urządzenia wirtualnego
...
>[AZURE.WARNING] **Zdecydowanie zalecamy, aby w celu zwiększenia bezpieczeństwa używać protokołu HTTPS podczas nawiązywania połączenia z punktami końcowymi, a następnie usunąć punkty końcowe po zakończeniu sesji zdalnej programu PowerShell.**
...
## Nawiązywanie bezpośredniego połączenia z urządzeniem wirtualnym
...
### Obsługa urządzenia wirtualnego StorSimple
...
### Konta magazynu dla urządzeń wirtualnych
...
### Dezaktywacja urządzenia wirtualnego StorSimple
...
## Wyłączanie lub usuwanie urządzeń wirtualnych
