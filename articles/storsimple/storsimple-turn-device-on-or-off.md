...
| 主エンクロージャと EBOD の接続が失われた後にデバイスの電源をオンにする| [プライマリの後、デバイスをオンにし、EBOD エンクロージャの接続が失われます。](#turn-on-a-device-after-the-primary-and-EBOD-enclosure-connection-is-lost)|
...
- [主エンクロージャのみを持つ新しいデバイス](#new-device-with-primary-enclosure-only)
...
>[AZURE.IMPORTANT] システムをオンにしたときに、SAS ケーブルに欠陥がある場合、または EBOD エンクロージャと主エンクロージャ間の接続が正常でない場合、回復モードになります。 ください [Microsoft サポートにお問い合わせ](storsimple-contact-microsoft-support.md) このような場合です。
...
[Microsoft サポートに問い合わせる](storsimple-contact-microsoft-support.md) をオンにするか、StorSimple デバイスをシャット ダウンするときに問題が発生した場合。
