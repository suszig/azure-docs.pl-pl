...
2. 次の手順に従って、バックアップ セットを選択します。
  ...
  3. 時間範囲を指定します。
  4. チェック アイコンをクリックして ![チェック マーク アイコン](./media/storsimple-restore-from-backup-set/HCS_CheckIcon.png) このクエリを実行します。
...
7. 復元情報を確認し、チェック アイコンをクリックして ![チェック マーク アイコン](./media/storsimple-restore-from-backup-set/HCS_CheckIcon.png)します。 復元ジョブが開始されます。このジョブは、**[ジョブ]** ページに表示されます。
