---
title: "Zastąp kontrolera urządzenia StorSimple | Dokumentacja firmy Microsoft"
description: "Wyjaśniono, jak usunąć i Zastąp jeden lub oba moduły kontroler na urządzeniu StorSimple."
services: storsimple
documentationcenter: 
author: alkohli
manager: timlt
...
> [!IMPORTANT]
> Przed usunięcie i zastąpienie kontrolera, zapoznaj się z informacjami bezpieczeństwa w [wymiana składników sprzętowych StorSimple](storsimple-hardware-component-replacement.md).
> 
> 
...
1. W systemie Azure klasycznego portalu, przejdź do usługi Menedżer StorSimple, kliknij przycisk **urządzeń** , a następnie kliknij nazwę urządzenia, które chcesz monitorować.
2. Przejdź do **konserwacji > Stan sprzętu**. Stan kontrolera 0 lub 1 kontroler powinien być czerwony, co wskazuje błąd.
...
8. Po ponownym uruchomieniu kontrolera, sprawdź **stan kontrolera** i **klastra stan** w klasycznym portalu Azure, aby sprawdzić, czy kontroler ma dobrej kondycji i jest w stanie wstrzymania.
...
4. Wszystko będzie gotowe, gdy zatrzaśnięcia zostanie zablokowany na miejscu. **OK** LED powinno być teraz na.  
   ...
   > 
   > 
5. Aby zweryfikować, że zastąpienia zakończyła się powodzeniem, w klasycznym portalu Azure, przejdź do **urządzeń** > **konserwacji** > **stan sprzętu**, i Upewnij się, że zarówno kontrolera 0 i kontrolera 1 są w dobrej kondycji (stan jest zielony).
...
* [Użyj klasycznego portalu Azure, aby zidentyfikować kontroler active](#use-the-azure-classic-portal-to-identify-the-active-controller)
...
### <a name="use-the-azure-classic-portal-to-identify-the-active-controller"></a>Użyj klasycznego portalu Azure, aby zidentyfikować kontroler active
W klasycznym portalu Azure, przejdź do **urządzeń** > **konserwacji**, a Przewiń **kontrolerów** sekcji. W tym miejscu można sprawdzić, który kontroler jest aktywny.

![Zidentyfikuj kontroler active w klasycznym portalu Azure](./media/storsimple-controller-replacement/IC752072.png)

**Rysunek 6** klasycznego portalu Azure przedstawiający active kontrolera
