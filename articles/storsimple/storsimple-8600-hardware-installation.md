...
> [AZURE.NOTE]
> 
> -は、いくつかの空きスロットの主エンクロージャと EBOD エンクロージャの間にすることも可能です。 
> -EBOD エンクロージャを主エンクロージャの接続に付属の 2 m SAS ケーブルを使用します。
> -EBOD ユニットに対するヘッド ユニットの相対的な配置の制約はありません。 したがって、主エンクロージャを最上部のスロットに配置して EBOD エンクロージャを下に配置しても、その逆でもかまいません。
...
する準備が整いました [展開して、オンプレミスの StorSimple デバイスを構成する](storsimple-deployment-walkthrough.md)
