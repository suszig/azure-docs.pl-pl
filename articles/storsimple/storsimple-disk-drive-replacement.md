...
>[AZURE.IMPORTANT]
>
>-システムに障害が発生した 1 つ以上のディスクがある場合から削除しない 1 つ以上の SSD または HDD どの時点でもシステムにします。 これを行うと、データが失われる可能性があります。
>
>-交換用 SSD を SSD が格納されていたスロットに配置することを確認します。 同様に、交換用の HDD は、必ず交換前の HDD が格納されていたスロットに配置してください。
>
>Azure クラシック ポータルでスロット番号が付けられて 0 ~ 11 です。 したがって、ポータルで、スロット 2 のディスクで障害が発生していることを示している場合は、上から 3 番目のスロットで障害が発生しているディスクを探します。
