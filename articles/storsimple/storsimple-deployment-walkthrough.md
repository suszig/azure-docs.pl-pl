...
|---------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **IP**</br>**サブネット**</br>**ゲートウェイ** | これを有効な IPv4 または IPv6 アドレスですか。</br>有効なサブネットですか。</br>これを有効なゲートウェイですか。</br>ネットワーク上の IP が重複してですか。                                                                          | `ping ip`</br>`arp -a`</br>`ping` コマンドと `arp` コマンドが失敗した場合、この IP を使用しているデバイスがデータセンター ネットワーク内に存在しないことを示しています。
|                           |                                                                                                                                                                    |                                                                                                                                                                                         |
...
|                           |                                                                                                                                                                    |                                                                                                                                                                                         |
| **プロキシ (省略可能)**          | 有効なプロキシ URI とポートかどうか。 </br> 認証モードは正しいですか。                                                                                                                                | <code>wget http://bing.com & #124 文字です。% {$_.StatusCode}</code></br>このコマンドは、web プロキシを構成した直後に実行する必要があります。 状態コード 200 が返された場合は、接続が成功したことを示します。                                                                                                                                 |
