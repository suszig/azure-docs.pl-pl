...
詳細については、次を参照してください。 [http://www.blitline.com](http://www.blitline.com)します。
...
に関する詳細情報が記載、 *関数* ここではサポートします。 <http://www.blitline.com/docs/functions>

ジョブ オプションに関するドキュメントもご覧ください。 <http://www.blitline.com/docs/api>

行うには必要なは、JSON を取得したら **POST** に `http://api.blitline.com/jobs`
