...
使用することができます、 [ARMClient ツール](https://github.com/projectkudu/ARMClient) を簡単に、REST API 呼び出しを作成します。 このツールを使用してログインした後、次のコマンドを発行する必要があります。
