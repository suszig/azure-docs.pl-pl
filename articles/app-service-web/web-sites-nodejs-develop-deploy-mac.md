<properties
    pageTitle="Tworzenie aplikacji sieci Web Node.js w usłudze Azure App Service | Microsoft Azure"
...
2. Skopiuj następujący kod do pliku **server.js**, a następnie zapisz plik:
...
3. Otwórz okno wiersza polecenia i uruchom aplikację sieci Web lokalnie przy użyciu poniższego polecenia.
...
1. W wierszu polecenia przejdź do katalogu **helloworld**, a następnie wprowadź poniższe polecenie w celu zainicjowania lokalnego repozytorium Git.

        git init


2. Dodaj pliki do repozytorium przy użyciu następujących poleceń:

        git add .
        git commit -m "initial commit"

3. Dodaj zdalny element systemu Git do wypychania aktualizacji do utworzonej aplikacji sieci Web przy użyciu następującego polecenia:

        git remote add azure [URL for remote repository]

4. Wypchnij wprowadzone zmiany na platformę Azure przy użyciu następującego polecenia:
...
5. Aby wyświetlić aplikację, kliknij przycisk **Przeglądaj** w części **Aplikacja sieci Web** w Portalu Azure.
...
2. W wierszu polecenia przejdź do katalogu **helloworld**, a następnie uruchom poniższe polecenia:
...
3. Odśwież okno przeglądarki, w którym jest wyświetlana strona wskazywana przez adres URL aplikacji sieci Web.
