...
5. Upewnij się, że jesteś nadal w katalogu głównym aplikacji, a następnie utwórz zasób aplikacji usługi App Service na platformie Azure przy użyciu unikatowej nazwy aplikacji za pomocą poniższego polecenia, na przykład http://{nazwa_aplikacji}.azurewebsites.net
    ...
    Postępuj zgodnie z wyświetlanymi instrukcjami, aby wybrać region platformy Azure, w którym aplikacja ma zostać wdrożona. 
...
8. Zapisz zmiany, a następnie użyj narzędzia git, aby wdrożyć aplikację na platformie Azure. Gdy zostanie wyświetlony monit, użyj utworzonych wcześniej poświadczeń użytkownika.
