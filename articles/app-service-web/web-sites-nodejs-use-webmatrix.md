...
アプリケーションで使用するバージョンを指定する方法と Azure に用意されている Node.js のバージョンに関する詳細については、「 [Azure アプリケーションでの Node.js のバージョンを指定する](../nodejs-specify-node-version-azure-apps.md)します。
