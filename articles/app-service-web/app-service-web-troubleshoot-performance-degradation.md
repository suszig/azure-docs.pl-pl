...
-   [Azure App Service で Web アプリの監視](web-sites-monitor.md)
-   [アラート通知を受信します。](insights-receive-alert-notifications.md)
...
(_S) extensions_ を活用することにより、アプリケーションのパフォーマンスを監視することもできます。
...
アプリケーション診断では、Web アプリケーションによって生成された情報を取り込むことができます。 ASP.NET アプリケーションは、`System.Diagnostics.Trace` クラスを使用して、情報をアプリケーション診断ログに記録できます。

アプリケーション ログ記録を構成する方法の詳細な手順については、次を参照してください。 [Azure App Service での web アプリの診断ログを有効にする](web-sites-enable-diagnostic-log.md)します。
...
Web Apps には、ファイルのデバッグ、調査、アップロード用のデバッグ コンソールのほか、ご利用の環境についての情報を入手するための JSON エンドポイントが用意されています。 _Kudu Console_ これと呼ばれますが、_SCM または web アプリの Dashboard_ です。

このダッシュ ボードをアクセスするには、リンクに移動して **https://<Your アプリ名 >.scm.azurewebsites.net/**します。
...
[について知っておくべき azure web サイト チーム サービス ツール](/blog/windows-azure-websites-online-tools-you-should-know-about/)します。
