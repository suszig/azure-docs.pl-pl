...
[Azure SDK for .NET 2.8 のリリース ノート](azure-sdk-dotnet-release-notes-2_8.md)

## Azure SDK for .NET 2.7 リリース ノート

[Azure SDK for .NET 2.7 リリース ノートします。](azure-sdk-dotnet-release-notes-2_7.md)
...
[Azure SDK for .NET 2.5.1 リリース ノートします。](../app-service/app-service-release-notes.md)
