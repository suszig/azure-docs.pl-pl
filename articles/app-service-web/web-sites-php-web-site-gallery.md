...
> [AZURE.NOTE]
> このチュートリアルを完了するには、Microsoft Azure アカウントが必要です。 アカウントを持っていない場合は、 [、Visual Studio のサブスクライバーの特典をアクティブ化](/pricing/member-offers/msdn-benefits-details/?WT.mc_id=A261C142F) または [無料評価版にサインアップ](/en-us/pricing/free-trial/?WT.mc_id=A261C142F)します。
>
