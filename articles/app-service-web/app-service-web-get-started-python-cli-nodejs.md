...
- [Interfejs wiersza polecenia platformy Azure w wersji 2.0](app-service-web-get-started-python.md) — nasz interfejs wiersza polecenia nowej generacji dla modelu wdrażania na potrzeby zarządzania zasobami
