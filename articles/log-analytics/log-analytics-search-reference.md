...
>[!NOTE]
> W tym artykule opisano dziennik wyszukiwania przy użyciu bieżącego języka zapytań w analizy dzienników.  Jeśli obszaru roboczego został uaktualniony do [języka zapytań nowe analizy dzienników](log-analytics-log-search-upgrade.md), a następnie należy zapoznać się [odwołanie językowe dla nowego języka](https://go.microsoft.com/fwlink/?linkid=856079).
