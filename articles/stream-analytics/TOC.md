# [Dokumentacja usługi Stream Analytics](index.md)
...
## Skalowanie
### [Skalowanie za pomocą jednostek przesyłania strumieniowego](stream-analytics-streaming-unit-consumption.md)
### [Skalowanie za pomocą przetwarzania równoległego zapytań](stream-analytics-parallelization.md)
#### [Zwiększanie przepływności](stream-analytics-scale-jobs.md)
### [Skalowanie za pomocą funkcji uczenia maszynowego](stream-analytics-scale-with-machine-learning-functions.md)

## Automatyzacja
### [Korzystanie z zestawu SDK dla platformy .NET](stream-analytics-dotnet-management-sdk.md)
### [Korzystanie z programu Azure PowerShell](https://github.com/Azure/azure-stream-analytics/tree/master/Samples/ASAOneClick)
...
### [Kroki rozwiązywania problemów](stream-analytics-troubleshooting-guide.md)
### [Typowe problemy z rozwiązywaniem problemów](stream-analytics-common-troubleshooting-issues.md)
### [Diagram zadań](stream-analytics-job-diagram-with-metrics.md)
### [Dzienniki diagnostyczne](stream-analytics-job-diagnostic-logs.md)
### [Sprawdzanie kondycji zasobu](stream-analytics-resource-health.md)
### [Instrukcja SELECT INTO](stream-analytics-select-into.md)
### [Odbiorcy Centrum zdarzeń](stream-analytics-event-hub-consumer-groups.md)

## Integracja z uczeniem maszynowym
### [Analiza tonacji przy użyciu modeli uczenia maszynowego](stream-analytics-machine-learning-integration-tutorial.md)
...
## [Wideo](https://azure.microsoft.com/resources/videos/index/?services=stream-analytics&sort=newest)
