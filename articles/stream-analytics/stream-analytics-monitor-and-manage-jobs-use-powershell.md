...
> [AZURE.NOTE] プログラムで作成された Stream Analytics ジョブは、既定では監視は有効になっていません。 ジョブの監視] ページに移動し、有効にする] ボタンをクリックして、Azure ポータルで監視を有効にできます手動でまたはにある手順に従って、プログラムで行うことができます [Azure Stream Analytics - Programatically Monitor Stream Analytics ジョブ](stream-analytics-monitor-jobs.md)
...
JSON ファイルの構造と内容の詳細についてを参照してください、 [入力の作成 (Azure ストリーム Analytics)][msdn-rest-api-create-stream-analytics-input] のセクションで、 [Stream Analytics 管理 REST API リファレンス Library][stream.analytics.rest.api.reference]します。
...
JSON ファイルの構造と内容の詳細についてを参照してください、 [Stream Analytics Job][msdn-rest-api-create-stream-analytics-job] のセクションで、 [Stream Analytics 管理 REST API リファレンス Library][stream.analytics.rest.api.reference]します。
...
JSON ファイルの構造と内容の詳細についてを参照してください、 [出力の作成 (Azure ストリーム Analytics)][msdn-rest-api-create-stream-analytics-output] のセクションで、 [Stream Analytics 管理 REST API リファレンス Library][stream.analytics.rest.api.reference]します。
...
JSON ファイルの構造と内容の詳細についてを参照してください、 [変換の作成 (Azure ストリーム Analytics)][msdn-rest-api-create-stream-analytics-transformation] のセクションで、 [Stream Analytics 管理 REST API リファレンス Library][stream.analytics.rest.api.reference]します。
