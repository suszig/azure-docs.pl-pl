...
13. **属性名** フィールドを入力 `アカウント`します。 **[属性値]** フィールドに、NetSuite アカウント ID を入力します。 アカウント ID を確認する方法を次に示します。
...
19. 構成をテストするには、以下の「セクションを参照してください。 [NetSuite にユーザーを割り当てる](#step-4-assign-users-to-netsuite)します。
