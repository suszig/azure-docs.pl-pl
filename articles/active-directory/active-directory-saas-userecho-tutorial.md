...
シングル サインオンを機能させるには、Azure AD ユーザーに対応する UserEcho ユーザーが Azure AD で認識されている必要があります。 言い換えると、Azure AD ユーザーと UserEcho の関連ユーザーの間で、リンク関係が確立されている必要があります。<br>
...
<br><br>![シングル サインオンを構成する](./media/active-directory-saas-userecho-tutorial/tutorial_userecho_04.png) <br>
...
<br><br>![シングル サインオンを構成する](./media/active-directory-saas-userecho-tutorial/tutorial_userecho_05.png) <br>
...
<br><br>![シングル サインオンを構成する](./media/active-directory-saas-userecho-tutorial/tutorial_userecho_06.png) <br>

1. クリックして **統合**します。
<br><br>![シングル サインオンを構成する](./media/active-directory-saas-userecho-tutorial/tutorial_userecho_07.png) <br>


1. クリックして **web サイト**, 、] をクリックし、 **シングル サインオン (SAML2)**します。
<br><br>![シングル サインオンを構成する](./media/active-directory-saas-userecho-tutorial/tutorial_userecho_08.png) <br>


1.  **シングル サインオン (SAML)** ] ページで、次の手順を実行します。
<br><br>![シングル サインオンを構成する](./media/active-directory-saas-userecho-tutorial/tutorial_userecho_09.png) <br>
...
<br><br>![シングル サインオンを構成する](./media/active-directory-saas-userecho-tutorial/tutorial_userecho_10.png) <br>

1. クリックして **ユーザー**します。
<br><br>![シングル サインオンを構成する](./media/active-directory-saas-userecho-tutorial/tutorial_userecho_11.png) <br>

1. クリックして **新しいユーザーを招待**します。
<br><br>![シングル サインオンを構成する](./media/active-directory-saas-userecho-tutorial/tutorial_userecho_12.png) <br>


1.  **新しいユーザーを招待** ] ダイアログ ボックスで、次の手順を実行します。
<br><br>![シングル サインオンを構成する](./media/active-directory-saas-userecho-tutorial/tutorial_userecho_13.png) <br>
...
<br><br>![シングル サインオンを構成する](./media/active-directory-saas-userecho-tutorial/tutorial_userecho_50.png) <br>
