...
1. レジストリ エディターを起動します。<br> ![Run](./media/active-directory-cloudappdiscovery-registry-settings-for-proxy-services/proxy01.png)

2. 移動するか、次のレジストリ キーを作成します <br> **hklm_local_machine \software\microsoft\cloud App discovery \endpoint**。

3. 新しい **複数行文字列** と呼ばれる値 **ポート**します。 ![新規](./media/active-directory-cloudappdiscovery-registry-settings-for-proxy-services/proxy02.png)
