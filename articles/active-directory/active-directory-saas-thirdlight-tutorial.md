...
7.  SAML2 構成セクションで、次の手順を実行します。
    ...
    1.  選択 **SAML2 シングル サインオンを有効にする**です。
    2.  として **IdP メタデータのソース**, [ **XML からロード IdP Metadata**します。
    3.  ダウンロードしたメタデータ ファイル、コンテンツをコピーして貼り付けます、 **IdP メタデータ XML** ] ボックスに貼り付けます。
    4.  クリックして **保存 SAML2 設定**します。
...
1.  ログインして **Thirdlight** 会社サイトに管理者として。

2.  移動して **ユーザー** ] タブをクリックします。

3.  選択 **ユーザーとグループ**します。

4.  クリックして **新しいユーザーを追加** ] ボタンをクリックします。

5.  入力 **プリセットまたは新しいメンバーのグループを選択ユーザー名、名前または説明、電子メール、** 、プロビジョニングする有効な AAD アカウントのです。

6.  クリックして **作成**します。

>[AZURE.NOTE] 他の Thirdlight ユーザー アカウント作成ツールを使用することができます。 または Api に用意されている Thirdlight AAD ユーザー アカウントのプロビジョニングします。
...
3.  テスト ユーザーを選択して [ **割り当てる**, 、順にクリック **はい** して割り当てを確認します。
    ...
    ![あり](./media/active-directory-saas-thirdlight-tutorial/IC767830.png "Yes")
