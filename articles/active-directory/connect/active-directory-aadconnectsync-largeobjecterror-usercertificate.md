...
2. W obszarze **kartę opis**, podaj następującej konfiguracji:
    ...
    | Typ łącza | **Dołącz** | |
    | Priorytet | *Wybierz liczbę z zakresu od 1 do 99* | Liczba wybrana nie mogą być używane przez żadną istniejącą regułę synchronizacji i ma mniejszą wartość (i w związku z tym wyższy priorytet) niż istniejącą regułę synchronizacji. |
