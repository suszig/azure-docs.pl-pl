...
W przypadku wdrożenia usługi Azure Active Directory (Azure AD) Połącz z wersją 1.1.614.0 lub po można użyć zadania dotyczące rozwiązywania problemów w kreatorze, rozwiązywanie problemów z synchronizacją hasła:
...
Wdrożenia z wersją 1.1.524.0 lub później, brak diagnostycznego polecenia cmdlet, które służy do rozwiązywania problemów z synchronizacją hasła:
...
7. Wybierz z menu sub **synchronizacji haseł nie działać w ogóle**.
