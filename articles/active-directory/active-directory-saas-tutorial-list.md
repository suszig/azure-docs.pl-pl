...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-citrix-gotomeeting-tutorial.png)| [GoToMeeting](active-directory-saas-citrix-gotomeeting-tutorial.md)| [Citrix GoToMeeting — Inicjowanie obsługi użytkowników](active-directory-saas-citrixgotomeeting-provisioning-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-cornerstone-ondemand-tutorial.png)| [Podstawy na żądanie](active-directory-saas-cornerstone-ondemand-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-ethicspoint-incident-management-tutorial.png)| [Zarządzanie zdarzeniami EthicsPoint](active-directory-saas-ethicspoint-incident-management-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-five9-tutorial.png)| [Five9 Plus karty](active-directory-saas-five9-tutorial.md)||
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-linkedinsalesnavigator-tutorial.png)| [Nawigator sprzedaży LinkedIn](active-directory-saas-linkedinsalesnavigator-tutorial.md)| [Nawigator sprzedaży LinkedIn — Inicjowanie obsługi użytkowników](active-directory-saas-linkedinsalesnavigator-provisioning-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-perceptionunitedstates-tutorial.png)| [Stany Zjednoczone z punktu widzenia użytkownika](active-directory-saas-perceptionunitedstates-tutorial.md)||
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-salesforce-sandbox-tutorial.png)| [Salesforce](active-directory-saas-salesforce-tutorial.md)| [SalesForce — Inicjowanie obsługi użytkowników](active-directory-saas-salesforce-provisioning-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-symantec-tutorial.png)| [Usługi zabezpieczeń firmy Symantec w sieci Web](active-directory-saas-symantec-tutorial.md)||
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-zscalerprivateaccess-tutorial.png  )| [Zscaler dostępu prywatnego](active-directory-saas-zscalerprivateaccess-tutorial.md)|
