...
4. W polu wyszukiwania wpisz **TrackVia**, wybierz pozycję **TrackVia** z panelu wyników kliknięcie **Dodaj** przycisk, aby dodać aplikację.
    ...
    ![TrackVia na liście wyników](./media/active-directory-saas-trackvia-tutorial/tutorial_trackvia_addfromgallery.png)
...
2. Na **logowanie jednokrotne** okno dialogowe, wybierz opcję **tryb** jako **na języku SAML logowania jednokrotnego** Aby włączyć logowanie jednokrotne.
    ...
    ![Okno dialogowe rejestracji jednokrotnej](./media/active-directory-saas-trackvia-tutorial/tutorial_trackvia_samlbase.png)
...
5. Na **certyfikat podpisywania SAML** kliknij **XML metadanych** , a następnie zapisz plik metadanych na tym komputerze.
    ...
    ![Łącze pobierania certyfikatu](./media/active-directory-saas-trackvia-tutorial/tutorial_trackvia_certificate.png) 
...
1. W portalu Azure, w okienku po lewej stronie kliknij **usługi Azure Active Directory** przycisku.
    ...
    ![Przycisk usługi Azure Active Directory](./media/active-directory-saas-trackvia-tutorial/create_aaduser_01.png)

2. Aby wyświetlić listę użytkowników, przejdź do **użytkowników i grup**, a następnie kliknij przycisk **wszyscy użytkownicy**.

    !["Użytkownicy i grupy" i "Wszyscy użytkownicy" łącza](./media/active-directory-saas-trackvia-tutorial/create_aaduser_02.png)

3. Aby otworzyć **użytkownika** okno dialogowe, kliknij przycisk **Dodaj** w górnej części **wszyscy użytkownicy** okno dialogowe.

    ![Przycisk Dodaj](./media/active-directory-saas-trackvia-tutorial/create_aaduser_03.png)

4. W **użytkownika** okna dialogowego wykonaj następujące czynności:

    ![Okno dialogowe użytkownika](./media/active-directory-saas-trackvia-tutorial/create_aaduser_04.png)
...
2. Na liście aplikacji zaznacz **TrackVia**.
    ...
    ![Łącze TrackVia na liście aplikacji](./media/active-directory-saas-trackvia-tutorial/tutorial_trackvia_app.png)  
