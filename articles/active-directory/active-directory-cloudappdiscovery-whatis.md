...
Cloud App Discovery を開始するを参照してください [で Cloud App Discovery 概要。](http://social.technet.microsoft.com/wiki/contents/articles/30962.getting-started-with-cloud-app-discovery.aspx)
