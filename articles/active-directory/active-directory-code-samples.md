...
| C#/.NET | [WebApp-WebAPI-OAuth2-UserIdentity-Dotnet](http://github.com/AzureADSamples/WebApp-WebAPI-OAuth2-UserIdentity-Dotnet) | 承認を追加 [Azure AD での OAuth 2.0](https://msdn.microsoft.com/library/azure/dn645545.aspx) 既存の web アプリケーション、web API を呼び出せるようにします。
...
| C#/.NET | [Azure AD を使用した Windows ストア アプリケーションと REST Web サービスのセキュリティ保護 (プレビュー)](https://msdn.microsoft.com/library/azure/dn169448.aspx) | 単純な web API リソースと Azure AD を使用して Windows ストア クライアント アプリケーションを作成し、 [Azure AD Authentication Library (ADAL)](http://go.microsoft.com/fwlink/?LinkID=258232)します。
