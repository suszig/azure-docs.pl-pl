<properties
   pageTitle="Zarządzanie katalogiem dla subskrypcji usługi Office 365 na platformie Azure | Microsoft Azure"
...
W tym artykule opisano sposób zarządzania katalogiem, który został utworzony dla subskrypcji usługi Office 365, ale będzie używany klasyczny portal Azure. Aby zalogować się do klasycznego portalu Azure, musisz być administratorem usługi albo współadministratorem subskrypcji platformy Azure. Jeśli nie masz jeszcze subskrypcji platformy Azure

1. Możesz zarejestrować się przy użyciu konta służbowego używanego do logowania się do usługi Office 365.

![Pole wprowadzania adresu e-mail](./media/active-directory-manage-o365-subscription/AAD_O365_01.png)

Odpowiednia subskrypcja dla platformy Azure nie zostanie znaleziona, ale możesz kliknąć przycisk **Zarejestruj się na platformie Azure**, aby formularz rejestracyjny został wypełniony odpowiednimi informacjami z konta usługi Office 365. To samo konto zostanie domyślnie przypisane do roli administratora usługi.

![Link umożliwiający zarejestrowanie się w celu uzyskania subskrypcji platformy Azure](./media/active-directory-manage-o365-subscription/AAD_O365_02.png)
...
Teraz załóżmy, że Anna Kowalska musi zalogować się do klasycznego portalu Azure i administrować witrynami sieci Web i zasobami baz danych skojarzonymi z subskrypcją platformy Azure dla użytkownika jnowak@hotmail.com. Aby mogła to zrobić, Jan Nowak musi wykonać następujące dodatkowe czynności:
...
2.  Przenieść subskrypcję do katalogu Contoso: kliknąć pozycje **Ustawienia** > **Subskrypcje** > wybrać subskrypcję > **Edytuj katalog** > wybrać pozycję **Contoso (Contoso.com)**. W ramach przeniesienia wszystkie konta służbowe, które nie mają uprawnień współadministratorów subskrypcji, zostaną usunięte.
