...
1. Wybierz **usługi Azure Active Directory**. Jeśli ta opcja nie jest widoczna na liście nawigacji, wybierz **wszystkie usługi** , a następnie przewiń w dół, aby znaleźć **usługi Azure Active Directory**.
