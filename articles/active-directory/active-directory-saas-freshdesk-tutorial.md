...
3.   **アプリケーション URL の構成** ] ページで、 **Freshdesk サインイン URL** ] ボックスに、次のパターンを使用して URL を入力"*https://\<tenant-name\>。Freshdesk.com*"、クリックして **次**します。
...
8.   **セキュリティ** セクションで、次の手順に従います。
    ...
    1.   **シングル サインオン (SSO)**, [ **に**します。
    2.  選択 **SAML SSO**します。
    3.  Azure ポータルで、 **Freshdesk でのシングル サインオンの構成** ] ダイアログ ページでコピー、 **リモート ログイン URL** 値に設定して、貼り付けます、 **SAML Login URL** ] ボックスに貼り付けます。
    4.  Azure ポータルで、 **Freshdesk でのシングル サインオンの構成** ] ダイアログ ページでコピー、 **リモート ログアウト URL** 値に設定して、貼り付けます、 **ログアウト URL** ] ボックスに貼り付けます。
...
5.  [エージェント情報] ダイアログで、次の手順を実行します。
    ...
    1.   **フル_ネーム** ] ボックスに、プロビジョニングする Azure AD アカウントの名前を入力します。
    2.   **電子メール** ] ボックスに、プロビジョニングする Azure AD アカウントの電子メール アドレスを Azure AD を入力します。
    3.   **タイトル** ] ボックスに、プロビジョニングする Azure AD アカウントのタイトルを入力します。
    4.  選択 **Agents role**, 、] をクリックし、 **割り当てる**します。
    5.  クリックして **保存**します。
    
        >[AZURE.NOTE] Azure AD アカウントの所有者では、継続は開始する前に、アカウントの確認へのリンクが記載された電子メールを取得します。

>[AZURE.NOTE] 他の Freshdesk ユーザー アカウント作成ツールを使用するや、AAD ユーザー アカウントをプロビジョニング、Freshdesk 提供の Api です。
...
3.  テスト ユーザーを選択して [ **割り当てる**, 、順にクリック **はい** して割り当てを確認します。
    ...
    ![あり](./media/active-directory-saas-freshdesk-tutorial/IC767830.png "Yes")
