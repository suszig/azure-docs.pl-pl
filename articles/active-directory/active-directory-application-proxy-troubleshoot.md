...
| Wyczyść błędu jest podana w oknie rejestracji. Nie można kontynuować | Jeśli zostanie wyświetlony ten błąd, a następnie zamyka okno, wprowadzono nieprawidłową nazwę użytkownika lub hasło. Próbuj ponownie. |
