...
3.   **アプリケーション URL の構成** ] ページで、 **Sciforma サインイン URL** ] ボックスに、次のパターンを使用して URL を入力"*https://\<tenant-name\>。Sciforma.com*"、クリックして **次**します。
