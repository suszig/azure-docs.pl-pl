...
このチュートリアルでは、Azure Active Directory (Azure AD) と Capriza を統合する方法を説明します。<br>Capriza を Azure AD と統合するには、次のメリットがあります。
...
> [AZURE.NOTE] ユーザーを手動で作成する必要がある場合は、Capriza サポート チームに連絡する必要があります。
