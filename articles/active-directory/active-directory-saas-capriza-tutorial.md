...
このチュートリアルでは、Azure Active Directory (Azure AD) と Capriza を統合する方法を説明します。<br>Azure AD と統合する Capriza を使うと、次の利点があります。
...
1. Azure クラシック ポータルの左側のナビゲーション ウィンドウで、をクリックして **Active Directory**します。 <br><br>
...
![アプリケーション][4]<br>
6. 検索ボックスに入力 **Capriza**します。<br><br>
![Azure AD テスト ユーザーを作成します。](./media/active-directory-saas-capriza-tutorial/tutorial_capriza_01.png)<br>
7. 結果ウィンドウで [ **Capriza**, 、クリックして **完了** アプリケーションを追加します。
<br><br>
...
4. * *[Capriza テスト ユーザーを作成する](#creating-a-capriza-test-user)* * - 自分の Azure AD の表現にリンクされている Capriza に Britta Simon に対応します。
...
<br><br>![でのシングル サインオンを構成する](./media/active-directory-saas-capriza-tutorial/tutorial_capriza_04.png) <br>
...
<br><br>![でのシングル サインオンを構成する](./media/active-directory-saas-capriza-tutorial/tutorial_capriza_05.png) <br>

    a. **[証明書のダウンロード]** をクリックし、コンピューターにファイルを保存します。

    b. **[次へ]** をクリックします。

5. SSO アプリケーション用に構成を取得するには、support@capriza.com を介して Capriza サポート チームに連絡し、ダウンロードした証明書ファイルを電子メールに添付します。 SAML SSO URL、サインアウト URL、発行元 URL もお知らせください。サポート チームが SSO 統合で設定します。
...
このセクションの目的は、Capriza で Britta Simon というユーザーを作成することです。 Capriza では、Just-In-Time プロビジョニングがサポートされています。この設定は、既定で有効になっています。 * * してください。 ドメイン名がユーザーの準備の Capriza で構成されていることを確認します。 その後のみ、・ イン タイムのユーザー プロビジョニングに work.* *

このセクションでは、ユーザー側で必要な操作はありません。 存在しない Capriza ユーザーにアクセスしようとすると、新しいユーザーが自動的に作成されます。 [Azure AD シングル サインオンを構成する](#configuring-azure-ad-single-single-sign-on)します。
> [AZURE.NOTE] ユーザーを手動で作成する必要がある場合は、Capriza のサポート チームにお問い合わせください。


### Azure AD テスト ユーザーの割り当て

このセクションでは、Britta Simon Capriza に自分のアクセスを与えることで Azure シングル サインオンの使用を有効にするとします。
...
<br><br>![でのシングル サインオンを構成する](./media/active-directory-saas-capriza-tutorial/tutorial_capriza_50.png) <br>
