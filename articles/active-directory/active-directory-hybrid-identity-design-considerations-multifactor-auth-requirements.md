...
>[AZURE.NOTE]
MFA とその機能に慣れていない場合の記事を読むことを強くお勧め [Azure 多要素認証は何ですか?](multi-factor-authentication.md) 前に、このセクションの読み込みが続行されます。
...
[ハイブリッド id の採用戦略を定義します。](active-directory-hybrid-identity-design-considerations-identity-adoption-strategy.md)
