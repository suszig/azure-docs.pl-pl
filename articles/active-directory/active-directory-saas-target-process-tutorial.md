...
このチュートリアルでは、Azure Active Directory (Azure AD) と TargetProcess を統合する方法を説明します。<br>Azure AD と統合する TargetProcess を使うと、次の利点があります。
...
<br><br>![でのシングル サインオンを構成する](./media/active-directory-saas-target-process-tutorial/tutorial_target_process_03.png) <br>

    a.  **サインオン URL** ユーザー TargetProcess アプリケーションにサインオンする URL を使用] ボックスに、種類 (例:: *https://fabrikam.TargetProcess.com/*)。

    b. **[次へ]** をクリックします。

4. **TargetProcess でのシングル サインオンの構成** ] ページで、次の手順を実行します。
<br><br>![でのシングル サインオンを構成する](./media/active-directory-saas-target-process-tutorial/tutorial_target_process_04.png) <br>
...
<br><br>![でのシングル サインオンを構成する](./media/active-directory-saas-target-process-tutorial/tutorial_target_process_05.png) <br>

1. **[Settings]** をクリックします。
<br><br>![でのシングル サインオンを構成する](./media/active-directory-saas-target-process-tutorial/tutorial_target_process_06.png) <br>

1. クリックして **シングル サインオン**します。
<br><br>![でのシングル サインオンを構成する](./media/active-directory-saas-target-process-tutorial/tutorial_target_process_07.png) <br>

1. シングル サインオンの設定] ダイアログでは、次の手順を実行します。
<br><br>![でのシングル サインオンを構成する](./media/active-directory-saas-target-process-tutorial/tutorial_target_process_08.png) <br>
    ...
    d. クリックして **JIT のプロビジョニングを有効にする**します。
...
<br><br>![でのシングル サインオンを構成する](./media/active-directory-saas-target-process-tutorial/tutorial_target_process_09.png) <br>
