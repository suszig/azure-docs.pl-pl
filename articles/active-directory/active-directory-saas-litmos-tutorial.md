...
このチュートリアルでは、Azure Active Directory (Azure AD) と Litmos を統合する方法を説明します。<br>Azure AD と統合する Litmos を使うと、次の利点があります。
...
1. 下の値をコピー **litmos の「SAML endoiint が:**します。
...
<br><br>![シングル サインオンを構成します。][14]<br>
    ...
    a.**[ユーザー属性の追加]** をクリックします。<br><br>![シングル サインオンを構成します。][15]<br>
