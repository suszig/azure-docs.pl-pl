...
任意の職場または学校のアカウントのサインイン画面から、職場または学校のアカウントをリセットするには、次の手順に従います。
 ...
 >[AZURE.IMPORTANT] この機能は、場合は、管理者がオンにするのみです。  オンになっていない場合、この機能はアカウントでは有効になっていないというメッセージが表示されます。  その場合、管理者にアカウントをロック解除してもらうために、[管理者に連絡してください] リンクを使用します。<br><br>この機能を使用できるよう管理者がこの機能を有効にした場合、使用するにはまずサインアップする必要があります。  それにはこちら: http://aka.ms/ssprsetup です。
...
## 自分のアカウントのロックを解除する
任意の職場または学校のアカウントのサインイン画面から、ローカル アカウントをリセットするには、次の手順に従います。  **注: のみことができますロックされている内部設置型経過している場合、アカウントのロックを解除します。**
...
<table>
          ...
          <tr>
            ...
            <td>
              <p>管理者は、内部設置型環境内でパスワードを管理しからパスワードをリセットすることはできないためこのメッセージが表示されて、 <b>アカウントのリンクにアクセスできません。</b>. <br><br> パスワードをリセットするには、管理者に直接連絡して支援を依頼し、Office 365 からパスワードをリセットしたいことを伝え、この機能を有効にしてもらう必要があります。</p>
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td>
              <p>管理者が組織からのパスワード リセット有効でないためこのメッセージが表示されて、 <b>アカウントにアクセスできません。</b> リンク、または機能を使用するライセンスが許可していません。 <br><br> パスワードをリセットする] をクリックします <b>管理者に問い合わせてください。</b> 会社の管理者に電子メールを送信するリンク、ためかどうかをするこの機能を有効にする Office 365 からパスワードをリセットする必要がわかっている自分のことができるようにします。</p>
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td>
              <p>このメッセージは、パスワードのリセットは有効になっているが、サービスの使用を登録していない場合に表示されます。  パスワードのリセットを登録するには、アカウントに再アクセスできるようになった後に http://aka.ms/ssprsetup に進みます。 <br><br> パスワードをリセットする] をクリックします <b>管理者に問い合わせてください。</b> 会社の管理者に電子メールを送信へのリンク</p>
            </td>
          </tr>
        </tbody></table>
