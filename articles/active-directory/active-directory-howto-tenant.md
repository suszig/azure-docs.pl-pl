...
- [既存の Office 365 サブスクリプションがあります。](#use-an-existing-office-365-subscription)
- [Microsoft アカウントに関連付けられている既存の Azure サブスクリプションがあります。](#use-an-msa-azure-subscription)
- [組織のアカウントに関連付けられている既存の Azure サブスクリプションがあります。](#use-an-organizational-azure-subscription)
- [上記のいずれを所有していず、最初から開始します。](#start-from-scratch)
