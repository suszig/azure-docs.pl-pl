<properties
   pageTitle="Azure AD B2B コラボレーションのプレビュー: しくみ |Microsoft Azure"
   description="Azure Active Directory B2B コラボレーションがビジネス パートナーが会社のアプリケーションを選択的にアクセスを有効にすると、企業間のリレーションシップをサポートする方法について説明します。"
