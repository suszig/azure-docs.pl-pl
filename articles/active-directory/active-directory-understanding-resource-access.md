...
> [AZURE.NOTE] このトピックでは、完全な Azure ポータルでのサブスクリプション管理者によるリソース アクセス制御の概念について説明します。 Azure プレビュー ポータルは、代わりに、 [ロールベースのアクセス制御](role-based-access-control-configure.md) Azure リソースをより厳密に管理できるようにします。 
...
<br><br>![複数のサブスクリプションとディレクトリを持つユーザー][4]
