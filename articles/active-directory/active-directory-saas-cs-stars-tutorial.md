...
このチュートリアルでは、Azure Active Directory (Azure AD) と CS 星を統合する方法を説明します。<br>CS 星を Azure AD と統合することを使うと、次の利点があります。
...
<br><br>![アプリ設定を構成します。][8]<br>
     ...
     3.1 に、 **サインオン URL** ] ボックスに、型に使用する URL、ユーザーが CS 星アプリケーションにサインオン (例:: *https://uat.csstars.com/enterprise/default.cmdx?ssoclient=C234UAT2*)。
