...
- [Azure AD Connect Health 同期](active-directory-aadconnect-health-sync.md)します。
- サポート [Azure AD ドメイン サービス](active-directory-ds-getting-started.md) パスワード同期します。

**新しくサポートされたシナリオ:**

- 複数のオンプレミス Exchange 組織がサポートされました。 参照してください [を複数の Active Directory フォレストとのハイブリッド デプロイ](https://technet.microsoft.com/library/jj873754.aspx) の詳細。
...
- 属性ベースのフィルターでのパスワード同期がサポートされるようになりました。 詳細については、次を参照してください。 [のパスワード同期フィルタ リングを](active-directory-aadconnectsync-configure-filtering.md)します。
