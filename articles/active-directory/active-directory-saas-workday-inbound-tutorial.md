...
2. 完了、 **Create Integration System User** 新しい統合システム ユーザーのユーザー名とパスワードを指定することによってタスクです。  このユーザーはプログラムを使用してログオンするため、[次回のサインイン時に新しいパスワードを要求する] オプションはオフのままにしておきます。 <br>
...
新しいセキュリティ グループ アクセス許可を付与するこの手順で **取得** と **配置** 次のドメイン セキュリティ ポリシーによって保護されているオブジェクトに対する操作。
...
2. システムと選択の検索、 **システム** 機能領域。  Click **OK**.  <br><br>   ![ドメイン セキュリティ ポリシー](./media/active-directory-saas-workday-inbound-tutorial/IC750987.png "Domain Security Policies")  
...
1. 検索ボックスに「アクティブ化」と入力し、[保留中のセキュリティ ポリシーの変更をアクティブ化] をクリックします。 <br><br>   ![アクティブ化](./media/active-directory-saas-workday-inbound-tutorial/IC750992.png "Activate") 
...
2. で、 **設定と管理者資格情報** ] ページで、次の手順を実行して順にクリックして **次**: <br><br>   ![設定と管理者資格情報](./media/active-directory-saas-workday-inbound-tutorial/IC750995.png "Settings and admin credentials")  
...
3.  **接続をテストする** ] ページで [ **テストの開始** を接続を確認し、をクリックして **次**します。 <br><br>   ![接続をテストします。](./media/active-directory-saas-workday-inbound-tutorial/IC750996.png "Test connection")  
...
5.  **プロビジョニングを開始** ダイアログ ボックスで、をクリックして **完了**します。 <br><br>   ![プロビジョニングを開始します。](./media/active-directory-saas-workday-inbound-tutorial/IC750998.png "Start provisioning")
