...
Można używać certyfikatów z podpisem własnym, jak również. Jeśli używasz urzędu certyfikacji prywatnej CDP (punkt dystrybucji punktu odwołania certyfikatu) dla certyfikatu powinny być publiczne.
