...
このチュートリアルでは、Azure Active Directory (Azure AD) と Kiteworks を統合する方法を説明します。<br>Azure AD と統合する Kiteworks を使うと、次の利点があります。
...
このリンク関係は、Azure AD の **[ユーザー名]** の値を、Kiteworks の **[Username]** の値として割り当てることで確立されます。
...
<br><br>![でのシングル サインオンを構成する](./media/active-directory-saas-kiteworks-tutorial/tutorial_kiteworks_04.png) <br>

    a.  **サインオン URL** ユーザー Kiteworks アプリケーションにサインオンする URL を使用] ボックスに、種類 (例:: *https://fabrikam.kiteworks.com/*)。

    b. **[次へ]** をクリックします。

4. **Kiteworks でのシングル サインオンの構成** ] ページで、次の手順を実行します。
<br><br>![でのシングル サインオンを構成する](./media/active-directory-saas-kiteworks-tutorial/tutorial_kiteworks_05.png) <br>
...
<br><br>![でのシングル サインオンを構成する](./media/active-directory-saas-kiteworks-tutorial/tutorial_kiteworks_09.png) <br>
...
<br><br>![でのシングル サインオンを構成する](./media/active-directory-saas-kiteworks-tutorial/tutorial_kiteworks_50.png) <br>
