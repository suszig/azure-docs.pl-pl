...
- [モバイルおよび OAuth 2.0 でのネイティブ アプリケーションを構築します。](active-directory-v2-protocols-oauth-code.md)
- [Web をビルド Open ID を使用したアプリケーションの接続](active-directory-v2-protocols-oidc.md)
- [OAuth 2.0 の暗黙的なフローでのシングル ページ アプリをビルドします。](active-directory-v2-protocols-implicit.md)
