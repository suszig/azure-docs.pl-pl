...
- [Azure AD アプリケーション プロキシを有効にします。](active-directory-application-proxy-enable.md#step-1-enable-application-proxy-in-azure-ad)
- [Azure AD アプリケーション プロキシ経由でアプリケーションを公開](active-directory-application-proxy-publish.md)
