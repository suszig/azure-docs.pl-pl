<properties
   pageTitle="Azure Active Directory B2B コラボレーションのため現在のプレビューの制限事項 |Microsoft Azure"
...
- コンシューマー電子メール アドレス (hotmail.com、Gmail.com、comcast.net など) への招待は現在サポートされていません。
