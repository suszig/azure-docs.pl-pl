...
* からアプリを追加 [Azure Active Directory アプリ ギャラリー](http://azure.microsoft.com/updates/azure-active-directory-over-1000-apps/)
...
* サインアップ/サインインしますなどの Microsoft オンライン サービスに [Office 365](http://products.office.com/)
...
* Visual Studio を使用して開発中のアプリを追加します。以下を参照してください。
    ...
    * [接続済みサービス](http://blogs.msdn.com/b/visualstudio/archive/2014/11/19/connecting-to-cloud-services.aspx)
* 使用して、を使用するアプリを追加 [Azure AD アプリケーション プロキシ](https://msdn.microsoft.com/library/azure/dn768219.aspx)
...
* 開発者: [Github で Azure Active Directory と統合されたアプリのサンプル コードをレビュー](https://github.com/AzureADSamples)
