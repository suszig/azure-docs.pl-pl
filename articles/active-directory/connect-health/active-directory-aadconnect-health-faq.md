...
Azure AD Connect Health generuje alert, gdy nie otrzyma punktów danych z serwera w ciągu ostatnich dwóch godzin. [Dowiedz się więcej](active-directory-aadconnect-health-data-freshness.md).
