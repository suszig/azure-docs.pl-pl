...
3.  右クリック **グループ ポリシー オブジェクト** 選択 **新規**します。 グループ ポリシー オブジェクトの名前を指定 **を有効にする Microsoft Passport**します。 Click **OK**.
4.  新しいグループ ポリシー オブジェクトを右クリックし、[ **編集**します。
5.  移動 **コンピューターの構成** > **ポリシー** > **管理用テンプレート** > **Windows コンポーネントの** > **Passport for Work を**します。
6.  右クリック **Passport for Work を有効にする** し、[ **編集**します。
