<properties
    pageTitle="Azure Active Directory ハイブリッド identity 設計に関する考慮事項には、データ保護要件を決定する |Microsoft Azure"
    description="ハイブリッド id ソリューションを計画するときは、ビジネスやにこれらの要件を満たす最適なオプションのデータ保護要件を特定します。"
    documentationCenter=""
