...
* [デバイスの登録を設定します。](active-directory-azureadjoin-setup.md)

### ユーザーの作業

* [セットアップ中に Azure AD と新しい Windows 10 デバイスのセットアップ](active-directory-azureadjoin-user-frx.md)
* [設定からの Windows 10 デバイスを Azure AD を設定します。](active-directory-azureadjoin-user-upgrade.md)
