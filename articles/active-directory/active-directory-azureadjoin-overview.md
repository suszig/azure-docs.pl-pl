...
* **その他のビジネス**: これら特定のシナリオよりも幅広いと考えることがあります、社内でユーザーを管理する場合でも AD のディレクトリを得られます簡略に参加するための Azure AD 参加が発生すると、Azure ad で自動 MDM 登録、デバイスの管理と、単一のユーザーがすることで Azure AD へのサインオンと内部設置型リソースです。  
