...
|   ------                                              |   -----                                                                                       |
| **異常アクティビティ レポート**
| [不明なソースからのサインインします。](active-directory-reporting-sign-ins-from-unknown-sources.md)| 追跡されないサインインの試行を示す場合があります。|
| [複数のエラー後のサインインします。](active-directory-reporting-sign-ins-after-multiple-failures.md)| ブルート フォース攻撃の成功を示す場合があります。|
| [複数の地域からのサインインします。](active-directory-reporting-sign-ins-from-multiple-geographies.md)| 複数のユーザーが同じアカウントでサインインしていることを示す場合があります。|
| [不審なアクティビティの IP アドレスからのサインイン](active-directory-reporting-sign-ins-from-ip-addresses-with-suspicious-activity.md)| 持続的な侵入の試行後のサインインの成功を示す場合があります。|
| [感染している可能性があるデバイスからのサインインします。](active-directory-reporting-sign-ins-from-possibly-infected-devices.md)| 感染の疑いのあるデバイスからサインインしようとした可能性があります。|
| [不規則なサインイン アクティビティ](active-directory-reporting-irregular-sign-in-activity.md)| ユーザーのサインイン パターンに対して異常なイベントを示す場合があります。|
| [異常なサインイン アクティビティを持つユーザー](active-directory-reporting-users-with-anomalous-sign-in-activity.md)| アカウントが侵害された可能性があるユーザーを示します。|
...
<p>
            すべての「複数のエラー後サインイン」レポートを除くこれらのレポートもフラグ疑わしい 
            <i>フェデレーション</i>
             フェデレーション プロバイダーに関係なく、前述のサービスへのサインインします。 
          </p>
<p>次のレポートを使用できます。 </p><ul>
<li>[不明なソースからのサインイン](active-directory-reporting-sign-ins-from-unknown-sources.md)します。</li>
<li>[複数のエラー後のサインイン](active-directory-reporting-sign-ins-after-multiple-failures.md)します。</li>
<li>[複数の地域からのサインイン](active-directory-reporting-sign-ins-from-multiple-geographies.md)します。</li>
<li>[不審なアクティビティの IP アドレスからのサインイン](active-directory-reporting-sign-ins-from-ip-addresses-with-suspicious-activity.md)します。</li>
<li>[不規則なサインイン アクティビティ](active-directory-reporting-irregular-sign-in-activity.md)します。</li>
<li>[感染している可能性があるデバイスからのサインイン](active-directory-reporting-sign-ins-from-possibly-infected-devices.md)します。</li>
<li>[サインイン アクティビティが異常なユーザー](active-directory-reporting-users-with-anomalous-sign-in-activity.md)します。</li>
...
| 説明| レポートの場所|
| :-------------     | :-------        |
| 過去 24 時間、過去 7 日間、または過去 30 日間内のすべての監査イベントのレコードを表示します。<br /> 詳細については、を参照してください [Azure Active Directory 監査レポート イベント](active-directory-reporting-audit-events.md)。| [ディレクトリ] > [レポート] タブ|
...
| イベントの種類| 表示の有無|
| ----------------------                                | ---------     |
| へのサインイン [パネルにアクセスする](http://myapps.microsoft.com/)| あり|
| へのサインイン [Azure 管理ポータル](https://manage.windowsazure.com/)| はい|
| へのサインイン [Microsoft Azure ポータル](http://portal.azure.com/)| はい|
| へのサインイン [Office 365 ポータル](http://portal.office.com/)| あり|
...
- ユーザーのパスワードをリセットする
- [多要素認証を有効に](multi-factor-authentication-get-started.md) 追加のセキュリティ
