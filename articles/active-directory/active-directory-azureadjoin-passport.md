...
パスワードだけで認証する現在の方法は、ユーザーの安全を保つうえで十分ではありません。 ユーザーは、パスワードを再利用したり、忘れたりすることがあります。 パスワードに対しては、攻撃やフィッシング、解読、推測が可能です。 ような攻撃になり、覚えにくいも取得"[ハッシュを渡す](https://technet.microsoft.com/dn785092.aspx)"です。
...
詳細な展開手順については、次を参照してください。 [作業、組織内の Microsoft Passport を有効にする](active-directory-azureadjoin-passport-deployment.md)します。
