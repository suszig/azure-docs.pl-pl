...
**前提条件**: Windows Server、Active Directory ドメイン サービスおよび Azure Active Directory の使用経験があります。 本書では、ソリューションが単独または統合ソリューションの形式でビジネス ニーズを満たす方法を読者が探しているものと想定しています。
...
|-------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ID 要件を決定する                                   | [ビジネス ニーズを判断する](active-directory-hybrid-identity-design-considerations-business-needs.md)<br> [ディレクトリ同期の要件を決定する](active-directory-hybrid-identity-design-considerations-directory-sync-requirements.md)<br> [多要素認証要件を決定する](active-directory-hybrid-identity-design-considerations-multifactor-auth-requirements.md)<br> [ハイブリッド id の採用戦略の定義](active-directory-hybrid-identity-design-considerations-identity-adoption-strategy.md)                       |
| 強力な ID ソリューションによりデータ セキュリティを強化するための計画を立てる | [データ保護要件を決定する](active-directory-hybrid-identity-design-considerations-dataprotection-requirements.md) <br> [コンテンツ管理の要件を決定する](active-directory-hybrid-identity-design-considerations-contentmgt-requirements.md)<br> [を決定するアクセス制御要件](active-directory-hybrid-identity-design-considerations-accesscontrol-requirements.md)<br> [インシデント対応要件を決定する](active-directory-hybrid-identity-design-considerations-incident-response-requirements.md) <br> [データ保護の戦略を定義します。](active-directory-hybrid-identity-design-considerations-data-protection-strategy.md)  |
| ハイブリッド ID ライフサイクルの計画を立てる                                | [ハイブリッド id 管理タスクを決定](active-directory-hybrid-identity-design-considerations-hybridId-management-tasks.md) <br> [同期管理](active-directory-hybrid-identity-design-considerations-hybridId-management-tasks.md)<br> [ハイブリッド id 管理の採用戦略の決定](active-directory-hybrid-identity-design-considerations-lifecycle-adoption-strategy.md) |     


##このガイドをダウンロードする
ハイブリッドの Id の設計に関する考慮事項ガイドからの pdf 版をダウンロードすることができます、 [Technet ギャラリー](https://gallery.technet.microsoft.com/Azure-Hybrid-Identity-b06c8288)します。 
