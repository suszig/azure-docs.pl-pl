...
分割|使用できる値とその意味
---|---
登録済みデータ| **電子メールの代替** – ユーザーの認証に連絡用電子メールまたは認証の電子メールを使用します。<p><p>**会社電話**– の認証に使用するユーザーの会社電話<p>**携帯電話** -使用するユーザーの携帯電話または認証用電話を認証するには<p>**セキュリティの質問** – ユーザーの認証にセキュリティの質問を使用します。<p>**上記の任意の組み合わせ (連絡用電子メール + 携帯電話など)** – 2 ゲート ポリシーが指定されている場合、ユーザーが使用する 2 つの方法が表示、パスワード リセット要求を認証します。
...
分割|使用できる値とその意味
---|---
使用された方法|**電子メールの代替** – ユーザーの認証に連絡用電子メールまたは認証の電子メールを使用します。<p>**会社電話** – の認証に使用するユーザーの会社電話<p>**携帯電話** – 使用するユーザーの携帯電話または認証用電話を認証するには<p>**セキュリティの質問** – ユーザーの認証にセキュリティの質問を使用します。<p>**上記の任意の組み合わせ (連絡用電子メール + 携帯電話など)** – 2 ゲート ポリシーが指定されている場合、ユーザーが使用する 2 つの方法が表示、パスワード リセット要求を認証します。
結果|**破棄** – ユーザー パスワード リセットを開始しはしましたが途中では完了しません<p>**ブロックされている** - または単一のパスワード リセット ゲートを 24 時間以内に何度も、ユーザーのアカウントがパスワード リセット ページを使用するパスワードをリセットしようとして原因を使用する禁止されました<p>**キャンセル** – ユーザーはパスワードのリセットを開始しましたが、途中のセッションをキャンセルするキャンセル ボタンをクリックして <p>**管理者に連絡** – ユーザー セッション中に解決できない問題があり、ユーザーは完了せずに、[管理者に連絡"リンクをクリックしたため、パスワード リセット フロー<p>**失敗した** – ユーザーは、(例: ライセンスのない、見つからない、認証情報を管理されているパスワードがオンプレミスでが書き戻しがオフ) 機能を使用して、ユーザーが構成されていなかったために、可能性の高いパスワードをリセットできませんでした。<p>**成功した** – パスワード リセットは成功しました。
詳細|次の表を参照してください。
