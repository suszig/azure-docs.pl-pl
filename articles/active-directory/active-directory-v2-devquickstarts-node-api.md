...
`git クローン--ブランチ スケルトン https://github.com/AzureADQuickStarts/AppModelv2-WebAPI-nodejs.git`
...
`$ curl - isS-x POST http://127.0.0.1:8888/タスク/brandon/こんにちは`
...
`git クローン--ブランチの完全な https://github.com/AzureADQuickStarts/AppModelv2-WebAPI-nodejs.git`

これ以降は、さらに高度なトピックに進むことができます。 次のチュートリアルを試してみてください。

[Node.js のバージョン 2.0 アプリケーション モデルと Web アプリのセキュリティ保護 >>](active-directory-v2-devquickstarts-node-web.md)
