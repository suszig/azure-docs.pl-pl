...
5.  [構成] タブに移動 **組織パブリック IP アドレス範囲** <br><br>![Cloud App Discovery のしくみ方法](./media/active-directory-known-networks/known-netwoks-03.png)
...
* [不審なアクティビティの IP アドレスからのサインイン](active-directory-reporting-sign-ins-from-ip-addresses-with-suspicious-activity.md)
* [複数の地域からのサインインします。](active-directory-reporting-sign-ins-from-multiple-geographies.md)
