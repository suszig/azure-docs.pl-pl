<properties
   ...
   description =「5 つの最も一般的な認証シナリオ Azure Active Directory (AAD) の概要」
...
> [AZURE.IMPORTANT] Azure AD は、公開キー暗号化を使用してトークンに署名し、トークンが有効であることを確認します。 参照してください [重要な情報署名キー ロール オーバーに関する Azure AD で](https://msdn.microsoft.com/library/azure/dn641920.aspx) について必要なロジックをアプリケーションに常に最新のキーを使用して更新することを確認する必要があります。
...
[Azure AD での署名キー ロール オーバーに関する重要な情報](https://msdn.microsoft.com/library/azure/dn641920.aspx)
