...
このチュートリアルでは、Azure Active Directory (Azure AD) と GaggleAMP を統合する方法を説明します。<br>GaggleAMP を Azure AD と統合するには、次のメリットがあります。
...
6.  **SAML SSO** ] ページで、次の手順を実行します。  
   <br><br>![GaggleAMP シングル サイン オン](./media/active-directory-saas-gaggleamp-tutorial/tutorial_gaggleamp_06.png) <br>
    ...
    a. Azure クラシック ポータルでは、コピー、 **発行者 URL**, に貼り付けると、 **Id プロバイダー発行者** ] ボックスに貼り付けます。 

    b. Azure クラシック ポータルでは、コピー、 **シングル サインオン サービス URL**, に貼り付けると、 **Id プロバイダー シングル サインオン URL** ] ボックスに貼り付けます。 
