...
Sposób śledzenia i zbierać przeglądami dostęp do różnych celów je zorganizować programy można uprościć. Przegląd każdego dostępu może być połączony z programem. Następnie podczas przygotowania raportów audytorzy tylko przeglądami dostępu w zakresie określonym inicjatywy są widoczne.
