...
- **オンプレミスの Active Directory の保護グループ内に存在するユーザー アカウントではサポートされません。** 保護グループの詳細については、次を参照してください。 [保護アカウントおよび Active Directory でグループ](https://technet.microsoft.com/library/dn535499.aspx)します。
