...
- Można kontrolować w usłudze Azure AD, który ma dostęp do ArcGIS Online
...
4. W polu wyszukiwania wpisz **ArcGIS Online**.
...
5. W panelu wyników wybierz **ArcGIS Online**, a następnie kliknij przycisk **Dodaj** przycisk, aby dodać aplikację.
...
Ta relacja łącza zostanie nawiązane, przypisując wartość **nazwy użytkownika** w usłudze Azure AD jako wartość **Username** w ArcGIS w trybie Online.
...
3. **[Tworzenie użytkownika testowego ArcGIS Online](#creating-an-arcgis-online-test-user)**  — w celu zapewnienia odpowiednikiem Simona Britta ArcGIS Online, które jest połączone z usługi Azure AD reprezentację użytkownika.
...
3. Na **ArcGIS Online domeny i adres URL** sekcji, wykonaj następujące kroki:

    ![Konfigurowanie rejestracji jednokrotnej](./media/active-directory-saas-arcgis-tutorial/tutorial_arcgisonline_url.png)

    W **adres URL logowania** tekstowym, wpisz wartość, przy użyciu następującego wzorca:`https://<company>.maps.arcgis.com`

    > [!NOTE] 
    > Ta wartość nie jest rzeczywistym. Zaktualizuj tę wartość przy rzeczywisty adres URL logowania. Skontaktuj się z [zespołem pomocy technicznej Online klienta ArcGIS](http://support.esri.com/) aby zyskać tę wartość. 
