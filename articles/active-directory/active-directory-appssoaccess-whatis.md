...
関連項目: [でのシングル サインオン用の証明書を管理するフェデレーション](active-directory-sso-certs.md)
...
詳細については、を参照してください [ユーザー プロビジョニングの自動化と SaaS アプリケーションへのプロビジョニング解除](active-directory-saas-app-provisioning.md)。
...
*   **使用している、一覧にないアプリを追加する** - Azure 管理ポータル内のアプリケーション ギャラリーでカスタム カテゴリを使用して、組織が使用している、一覧にないアプリケーションを接続します。 SAML 2.0 をサポートする任意のアプリケーション、または HTML ベースのサインイン ページをパスワード SSO アプリとして持つ任意のアプリケーションをフェデレーション アプリケーションとして追加できます。 詳細については、この記事を参照してください。 [独自のアプリケーションを追加する](active-directory-saas-custom-apps.md)します。
...
*   **アプリケーション統合を要求** -を使用して必要なアプリケーションのサポートを要請、 [Azure AD のフィードバック フォーラム](http://feedback.azure.com/forums/169401-azure-active-directory)します。
