...
- [Office 365 の MDM](https://technet.microsoft.com/en-us/library/ms.o365.cc.devicepolicy.aspx) 管理し、Office 365 組織に接続しているときに、モバイル デバイスをセキュリティ保護することができます。 MDM for Office 365 を利用し、デバイスのセキュリティ ポリシーとアクセス ルールを設定し、紛失または盗難時にモバイル デバイスのデータを消去できます。
