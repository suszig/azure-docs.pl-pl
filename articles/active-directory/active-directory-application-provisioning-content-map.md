---
title: "Problemy z konfiguracji i inicjowania obsługi użytkowników aplikacji\""
description: "Problemy z konfiguracji i inicjowania obsługi użytkowników aplikacji\""
...
## <a name="i-want-to-know-when-provisioning-will-finish"></a>Chcę wiedzieć, kiedy zakończy się inicjowanie obsługi administracyjnej
  Następujące dokumenty mogą ułatwić rozwiązanie niektórych często spotykanych problemów tego typu.
  * [Nie wiem, jak ustalić, kiedy dany użytkownik będzie mógł uzyskać dostęp do aplikacji](https://docs.microsoft.com/azure/active-directory/application-provisioning-when-will-provisioning-finish-specific-user/?/?WT.mc_id=DMC_AAD_Manage_Apps_Troubleshooting_Nav)
  * [Aprowizacja w aplikacji z galerii usługi Azure AD działa, ale proces aprowizacji trwa całymi godzinami](https://docs.microsoft.com/azure/active-directory/application-provisioning-when-will-provisioning-finish/?/?WT.mc_id=DMC_AAD_Manage_Apps_Troubleshooting_Nav)

## <a name="im-having-problems-configuring-user-provisioning-to-an-application"></a>Występują problemy z skonfigurowania inicjowania obsługi użytkowników do aplikacji
  Następujące dokumenty mogą ułatwić rozwiązanie niektórych często spotykanych problemów tego typu.
