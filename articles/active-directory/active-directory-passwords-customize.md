...
ユーザーに最良のエクスペリエンスを与えるため、Password Management の使用可能なすべての構成オプションを調べて試してみることをお勧めします。 構成] タブに移動して今すぐ調査を開始する実際には、 **Active Directory 拡張機能** で、 [Azure 管理ポータル](https://manage.windowsazure.com)します。 このトピック内から管理者として実行できるさまざまなパスワード管理のカスタマイズのすべてを説明します **構成** ] タブで、ディレクトリの [Azure 管理ポータル](https://manage.windowsazure.com), も含め。
...
次の表は、各コントロールが、パスワード リセットの登録とリセットを行うユーザーのエクスペリエンスに対して、どのように影響するかを説明しています。  これらのオプションを構成することができます、 **ディレクトリのプロパティ** セクションで、ディレクトリの **構成** タブ内で、 [Azure 管理ポータル](https://manage.windowsazure.com)します。
            ...
            <tr>
              ...
              <td>
                ...
                <ul>
                  ...
                  <li class="unordered">
                                                If set to yes, then only end users specified in the <strong>パスワードをリセットできるグループ</strong> コントロールは、パスワードをリセットできます。<br><br></li>
                </ul>
              </td>
            </tr>
            <tr>
...
次の表は、各コントロールが、パスワード リセット通知を受信するユーザーと管理者のエクスペリエンスに対して、どのように影響するかを説明しています。  これらのオプションを構成することができます、 **通知** セクションで、ディレクトリの **構成** ] タブで、 [Azure 管理ポータル](https://manage.windowsazure.com)します。
