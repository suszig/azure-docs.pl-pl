...
- [アプリ モデル バージョン 2.0 プロトコル リファレンス](active-directory-v2-protocols.md)
- [アプリ モデル バージョン 2.0 のトークンの参照](active-directory-v2-tokens.md)
- [Office 365 REST API リファレンス](https://msdn.microsoft.com/office/office365/howto/authenticate-Office-365-APIs-using-v2)
- [スコープと v2 のエンドポイントでの承諾](active-directory-v2-scopes.md)
