...
[!code-powershell[główne](../../../powershell_scripts/load-balancer/load-balance-multiple-web-sites-vm/load-balance-multiple-web-sites-vm.ps1  "Równoważenie obciążenia wielu witryn sieci web")]
