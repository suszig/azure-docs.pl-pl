---
title: Rozpoczynanie pracy z usługą Azure Data Lake Analytics przy użyciu Portalu Azure | Microsoft Docs
...
3. Wpisz lub wybierz wartości poniższych pozycji:
...
4. Wybierz pozycję **Przypnij do tablicy startowej**. Jest to wymagane w celu wykonania kroków tego samouczka.
5. Kliknij przycisk **Utwórz**. Spowoduje to przejście do tablicy startowej portalu. Do tablicy startowej zostanie dodany nowy kafelek z etykietą „Deploying Azure Data Lake Analytics” (Wdrażanie usługi Azure Data Lake Analytics). Utworzenie konta usługi Data Lake Analytics może potrwać kilka minut. Utworzone konto jest wyświetlane w nowym bloku otwartego portalu.
...
6. W bloku konta usługi Data Lake Analytics kliknij przycisk **Eksplorator danych** w górnej części. 
...
7. W bloku domyślnego konta usługi Data Lake Store kliknij pozycję **Przykłady**, aby rozwinąć folder, a następnie kliknij pozycję **Dane**, aby rozwinąć folder. Powinny zostać wyświetlone następujące pliki i foldery.
...
1. Kliknij przycisk **Prześlij zadanie** u górnej części. Zostanie otwarte nowe okienko Szczegóły zadania. Na pasku tytułu widoczny jest stan zadania.   
2. Poczekaj, aż stan zadania zmieni się na **Zakończono pomyślnie**. Po zakończeniu zadania szczegóły zadania zostaną wyświetlone w nowym bloku portalu:
...
3. W dolnej części bloku **Szczegóły zadania** kliknij nazwę zadania w pozycji **SearchLog-from-Data-Lake.csv**. Można wyświetlić podgląd pliku wyjściowego, pobrać go, zmienić jego nazwę i go usunąć.
...
4. Kliknij przycisk **Podgląd**, aby wyświetlić plik wyjściowy.
