...
- **Data Lake Analytics ジョブ プロセスの基本的な知識**。 参照してください [Azure ポータルを使用して Azure Data Lake 分析を使ってみる](data-lake-analytics-get-started-use-portal.md)します。
- **Data Lake Analytics アカウント**。 参照してください [Azure ポータルを使用して Azure Data Lake 分析を使ってみる](data-lake-analytics-get-started-use-portal.md#create-adl-analytics-account)します。
- **既定の Data Lake Store アカウントへのサンプル データのコピー**。 を参照してください [ソース データを準備する](data-lake-analytics-get-started-use-portal.md.md#prepare-source-data)
...
- [Azure Data Lake 分析の概要](data-lake-analytics-overview.md)
- [Azure PowerShell を使用して Azure Data Lake 分析を使ってみる](data-lake-analytics-get-started-powershell.md)
- [Azure Data Lake 分析および Visual Studio を使用して U SQL を使ってみる](data-lake-analytics-get-started-u-sql-studio.md)
