...
4.  **ソリューション エクスプ ローラー**, Script.usql を展開し、ダブルクリック、 **Script.usql.cs**します。
...
6.  **ソリューション エクスプ ローラー**, を右クリックして **Script.usql**, 、クリックして **ビルド スクリプト**します。
6.  **ソリューション エクスプ ローラー**, を右クリックして **Script.usql**, 、クリックして **送信スクリプト**します。
7. Azure サブスクリプションに接続していない場合は、Azure アカウント資格情報の入力を求められます。
7. クリックして **送信**します。 送信が完了すると、[結果] ウィンドウに送信結果とジョブのリンクが示されます。
8. 最新のジョブの状態を表示して、画面を更新するには、[更新] をクリックする必要があります。

**ジョブの出力を表示するには**

1.  **サーバー エクスプ ローラー**, 、展開 **Azure**, 、展開 **Data Lake 分析**, 、Data Lake 分析アカウントを展開し、 **ストレージ アカウント**, を既定の記憶域を右クリックし、をクリックし、 **エクスプ ローラー**します。 
2. サンプルを展開し、出力を展開し、ダブルクリック **Drivers.csv**します。
