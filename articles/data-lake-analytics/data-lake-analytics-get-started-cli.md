<properties 
   pageTitle="Wprowadzenie do korzystania z usługi Azure Data Lake Analytics przy użyciu interfejsu wiersza polecenia platformy Azure | Microsoft Azure" 
...
- **Domyślne konto usługi Data Lake**: każde konto usługi Data Lake Analytics ma domyślne konto usługi Data Lake.
    ...
    > [AZURE.NOTE] Nazwa konta usługi Data Lake może zawierać tylko małe litery i cyfry.
...
> [AZURE.NOTE] Nazwa konta usługi Data Lake Analytics może zawierać tylko małe litery i cyfry.
