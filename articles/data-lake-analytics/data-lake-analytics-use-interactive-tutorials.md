...
4. Kliknij pozycję **Azure Data Lake Analytics** na liście.
5. Kliknij pozycję **Utwórz** w dolnej części bloku.
...
8. Kliknij przycisk **Utwórz**. Spowoduje to przejście do tablicy startowej portalu. Do strony głównej zostanie dodany nowy kafelek z etykietą „Deploying Azure Data Lake Analytics” (Wdrażanie usługi Azure Data Lake Analytics). Utworzenie konta usługi Data Lake Analytics może potrwać kilka minut. Utworzone konto jest wyświetlane w nowym bloku otwartego portalu.
...
##Uruchamianie interaktywnego samouczka analizy dzienników witryn sieci Web
...
5. Kliknij pozycję **1 Introduction** (1 Wprowadzenie) i postępuj zgodnie z instrukcjami.
