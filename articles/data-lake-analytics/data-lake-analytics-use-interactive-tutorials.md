---
title: "Poznawanie usługi Data Lake Analytics i języka U-SQL przy użyciu interaktywnych samouczków z witryny Azure Portal | Microsoft Docs"
...
Każde konto usługi Data Lake Analytics jest w relacji zależności z kontem usługi [Azure Data Lake Store](../data-lake-store/data-lake-store-overview.md), domyślnym kontem usługi Data Lake Store.  Podczas pracy z tym samouczkiem utworzysz domyślne konto usługi Data Lake Store z kontem usługi Analytics, jednak możesz je także utworzyć wcześniej.
...
7. Wpisz lub wybierz następujące wartości:
...
6. Kliknij pozycję **Introduction** (Wprowadzenie) i postępuj zgodnie z instrukcjami
