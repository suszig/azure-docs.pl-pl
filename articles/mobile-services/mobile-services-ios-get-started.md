---
title: Wprowadzenie do usług Azure Mobile Services dla aplikacji systemu iOS | Microsoft Docs
...
4. W obszarze **Download and run your app** (Pobierz i uruchom aplikację) kliknij opcję **Download** (Pobierz). Spowoduje to pobranie projektu przykładowej aplikacji *To do list* (Lista zadań do wykonania), która jest połączona z usługą mobilną, wraz z zestawem SDK usług Mobile Services systemu iOS. Zapisz skompresowany plik projektu na komputerze lokalnym i zapamiętaj, gdzie został on zapisany.
