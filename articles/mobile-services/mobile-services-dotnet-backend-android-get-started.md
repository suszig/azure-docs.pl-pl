<properties
    pageTitle ="Azure Mobile Services Android アプリの使用"
    description ="このチュートリアルに従って Android 開発用の Azure Mobile Services の使用を開始します"。
...
> [AZURE.IMPORTANT] このチュートリアルを完了するには、Azure アカウントが必要です。 アカウントがない場合は、Azure 試用版にサインアップして最大 10 の無料モバイル サービスを取得し、試用期間が終わった後でも使用し続けることができます。 詳細については、「 [Azure 無料試用版](http://azure.microsoft.com/pricing/free-trial/?WT.mc_id=AE564AB28)します。
