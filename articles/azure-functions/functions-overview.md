<properties
   pageTitle="Azure Functions — omówienie | Microsoft Azure"
...
* **Wybór języka** — funkcje zapisu przy użyciu języka C#, Node.js, Python, F#, PHP, batch, bash, Java lub dowolnego pliku wykonywalnego.  
