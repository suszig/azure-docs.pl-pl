...
Po uruchomieniu obrazu niestandardowego w lokalnym kontenerze Docker zweryfikuj, że aplikacja funkcji i kontener działają prawidłowo, przechodząc do adresu <http://localhost: 8080>.
