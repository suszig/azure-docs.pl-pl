...
{"generatedBy": "Microsoft.NET.Sdk.Functions-1.0.0.0", "configurationSource": "attributes", "powiązania": [{"type": "queueTrigger", "queueName": "% input Nazwa kolejki %", "name": "myQueueItem"}], "wyłączone": ma wartość FAŁSZ, "plik_skryptu": "... \\bin\\FunctionApp1.dll ","punktu wejścia":"FunctionApp1.QueueTrigger.Run"}
