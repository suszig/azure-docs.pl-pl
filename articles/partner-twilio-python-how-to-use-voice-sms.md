...
* **< レコード >**: 呼び出し元の声を録音し、記録を含むファイルの URL を返します。
...
Twilio アカウントを取得する準備ができたら、サインアップ ページ [Twilio ][try_twilio]します。 無料アカウントで始め、後でアカウントをアップグレードすることができます。
...
* [Twilio のハウツー ガイドとコードの例 ][twilio_howtos]
