...
--- | --- | --- | ---
SYSTEMU PLIKÓW NFS | Nie dotyczy | Nie dotyczy
SMB 3.0 | Yes | Yes
SIECI SAN (ISCSI) | Yes | Yes
Wiele ścieżek (MPIO). Przetestowane z:<br></br> Moduł DSM firmy Microsoft, EMC PowerPath 5.7 z dodatkiem SP4<br/><br/> Program EMC PowerPath DSM dla CLARiiON | Yes | Yes
...
**Funkcja BitLocker** | Nieobsługiwane | Przed włączeniem replikacji dla maszyny Wirtualnej, należy wyłączyć funkcję BitLocker.
