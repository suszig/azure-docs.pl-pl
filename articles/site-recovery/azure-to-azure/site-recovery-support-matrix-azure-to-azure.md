...
>[!NOTE]
>
> - Replikowanie maszyn wirtualnych platformy Azure z jedną subskrypcję do innej scenariuszy odzyskiwania po awarii nie jest obsługiwane.
> - Azure Migrowanie maszyn wirtualnych między subskrypcjami nie jest obsługiwane.
> - Azure Migrowanie maszyn wirtualnych w tym samym regionie nie jest obsługiwane.
> - Migrowanie maszyn wirtualnych platformy Azure z klasycznego modelu wdrożenia do zasobu modelu wdrażania Menedżera nie jest obsługiwane.
