...
- VMM クラウドの Hyper-V 仮想マシンを Azure にレプリケートする [詳細については](site-recovery-vmm-to-azure.md) このシナリオの詳細。
...
4. 使用して保護する仮想マシンのレプリケーションを有効にする **ネットワーク経由で** レプリケーションの方法としてどちらのクラウドが同じサーバー上にあるためです。
