...
Maszyna wirtualna platformy Azure do wyboru w może nie być wyświetlana [włączyć replikację: krok 2](./site-recovery-azure-to-azure.md#step-2-select-virtual-machines). Ten problem może z powodu konfiguracji usługi Site Recovery starych pozostać na maszynie Wirtualnej Azure. Przestarzałą konfigurację może pozostać na maszynie Wirtualnej platformy Azure w następujących przypadkach:
