...
2. Określ częstotliwość codziennych zmian (przenoszenia) dla replikowanych danych. Aby to zrobić, należy pobrać [narzędzia do planowania pojemności funkcji Hyper-V](https://www.microsoft.com/download/details.aspx?id=39057) uzyskać szybkość zmian. [Dowiedz się więcej](site-recovery-capacity-planning-for-hyper-v-replication.md) o tym narzędziu. Zaleca się uruchomić to narzędzie dłużej niż przez tydzień do przechwytywania średnie.
...
3. W **Capacity Planner** arkusza, wprowadź wymagane informacje. Należy podać we wszystkich polach zaznaczona kółkiem na czerwono na poniższym zrzucie ekranu.
   ...
   * **Kompresji** ustawienie nie jest używany podczas replikowania maszyn wirtualnych funkcji Hyper-V do platformy Azure. Kompresji Użyj urządzenia innych firm, takich jak Riverbed.
   * W **przechowywania danych wejściowych**, określ, jak długo repliki powinny być przechowywane, w godzinach.
...
[Dowiedz się, jak uruchomić](site-recovery-capacity-planning-for-hyper-v-replication.md) Planisty wydajności.
