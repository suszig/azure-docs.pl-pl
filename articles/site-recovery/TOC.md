...
# Wprowadzenie
## [Replikowanie maszyn wirtualnych platformy Azure (wersja zapoznawcza)](azure-to-azure-walkthrough-overview.md)
### [Krok 1. Przegląd architektury](azure-to-azure-walkthrough-architecture.md)
### [Krok 2. Przed rozpoczęciem](azure-to-azure-walkthrough-prerequisites.md)
### [Krok 3. Planowanie sieci](azure-to-azure-walkthrough-network.md)
### [Krok 4. Tworzenie magazynu](azure-to-azure-walkthrough-vault.md)
### [Krok 5. Włączanie replikacji](azure-to-azure-walkthrough-enable-replication.md)
### [Krok 6. Wykonywanie próby przejścia w tryb failover](azure-to-azure-walkthrough-test-failover.md)
...
## [Replikacja maszyn wirtualnych funkcji Hyper-V do lokacji dodatkowej (z programem VMM)](vmm-to-vmm-walkthrough-overview.md)
### [Krok 1. Przegląd architektury](vmm-to-vmm-walkthrough-architecture.md)
### [Krok 2. Przegląd wymagań wstępnych i ograniczeń](vmm-to-vmm-walkthrough-prerequisites.md)
### [Krok 3. Planowanie sieci](vmm-to-vmm-walkthrough-network.md)
### [Krok 4. Przygotowywanie programu VMM i funkcji Hyper-V](vmm-to-vmm-walkthrough-vmm-hyper-v.md)
### [Krok 5. Tworzenie magazynu](vmm-to-vmm-walkthrough-create-vault.md)
### [Krok 6. Konfigurowanie elementu źródłowego i docelowego](vmm-to-vmm-walkthrough-source-target.md)
### [Krok 7. Konfigurowanie mapowania sieci](vmm-to-vmm-walkthrough-network-mapping.md)
### [Krok 8. Tworzenie zasad replikacji](vmm-to-vmm-walkthrough-replication.md)
### [Krok 9. Włączanie replikacji](vmm-to-vmm-walkthrough-enable-replication.md)
### [Krok 10. Wykonywanie próby przejścia w tryb failover](vmm-to-vmm-walkthrough-test-failover.md)
