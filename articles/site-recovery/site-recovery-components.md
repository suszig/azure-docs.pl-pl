...
# Jak działa usługa Azure Site Recovery w przypadku infrastruktury lokalnej?
...
W tym artykule opisano podstawową architekturę usługi [Azure Site Recovery](site-recovery-overview.md) i składniki, dzięki którym działa, w związku z replikacją obciążeń ze środowisk lokalnych do platformy Azure.
...
## Replikacja do platformy Azure

Następujące elementy infrastruktury lokalnej można chronić i replikować do platformy Azure:
...
## Z programu VMware do platformy Azure
...
**Serwery VMware** | Maszyny wirtualne programu VMware są hostowane na serwerach vSphere ESXi. Zalecamy użycie serwera vCenter do zarządzania hostami. | Serwery VMware są dodawane do magazynu usługi Recovery Services.<br/><br/>
...
## Serwer fizyczny do platformy Azure
...
## Z funkcji Hyper-V do platformy Azure
...
## Replikacja do lokacji dodatkowej
...
## Replikacja z programu VMware/serwera fizycznego do lokacji dodatkowej
...
## Z funkcji Hyper-V do lokacji dodatkowej
