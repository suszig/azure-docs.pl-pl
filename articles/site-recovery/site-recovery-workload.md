...
**ワークロード** | <p>**HYPER-V 仮想マシンをレプリケート**</p> <p>**(をセカンダリ サイト)**</p> | <p>**HYPER-V Vm の複製**</p> <p>**(Azure) に**</p> | <p>**VMware 仮想マシンをレプリケート**</p> <p>**(をセカンダリ サイト)**</p> | <p>**VMware 仮想マシンをレプリケート**</p><p>**(Azure) に**</p>
---|---|---|---|---
