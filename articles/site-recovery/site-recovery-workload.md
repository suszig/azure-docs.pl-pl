 ...
 **ワークロード**| <p>**HYPER-V 仮想マシンをレプリケート**</p> <p>**(セカンダリ サイト) に**</p>| <p>**HYPER-V Vm の複製**</p> <p>**(Azure) に**</p>| <p>**VMware 仮想マシンをレプリケート**</p> <p>**(セカンダリ サイト) に**</p>| <p>**VMware 仮想マシンをレプリケート**</p><p>**(Azure) に**</p>
---|---|---|---|---
 Active Directory、DNS| Y| Y| Y| Y
 Web アプリケーション (IIS、SQL)| Y| Y| Y| Y
 SCOM| Y| Y| Y| Y
 SharePoint| Y| Y| Y| Y
 <p>SAP</p><p>以外のクラスターを Azure に SAP レプリケーション サイト</p>| Y (Microsoft によってテスト済み)| Y (Microsoft によってテスト済み)| Y (Microsoft によってテスト済み)| Y (Microsoft によってテスト済み)
...
[詳細については](http://aka.ms/asr-sharepoint)
...
[詳細を表示](http://aka.ms/asr-dynamics)
...
- 小規模な展開で、1 つまたはクラスター化されていないサーバーなどの Site Recovery は、保護し、を Azure またはセカンダリ サイトにフェールオーバーします。

[詳細します。](http://aka.ms/asr-exchange)
