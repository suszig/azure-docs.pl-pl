...
**ワークロード** | <p>**HYPER-V Vm を複製します。**</p> <p>**(をセカンダリ サイト)**</p> | <p>**HYPER-V Vm を複製します。**</p> <p>**(Azure) に**</p> | <p>**VMware 仮想マシンをレプリケートします。**</p> <p>**(をセカンダリ サイト)**</p> | <p>**VMware 仮想マシンをレプリケートします。**</p><p>**(Azure) に**</p>
---|---|---|---|---
Active Directory、DNS | Y | Y | Y | Y 
Web アプリケーション (IIS、SQL) | Y | Y | Y | Y
SCOM | Y | Y | Y | Y
SharePoint | Y | Y | Y | Y
<p>SAP</p><p>非クラスターを Azure に SAP サイトをレプリケートします。</p> | Y (Microsoft によってテスト済み) | Y (Microsoft によってテスト済み) | Y (Microsoft によってテスト済み) | Y (Microsoft によってテスト済み)
