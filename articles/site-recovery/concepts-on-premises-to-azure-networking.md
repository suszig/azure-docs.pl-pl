---
title: "Sieć wirtualna łączności po przejściu w tryb failover Azure z usługą Azure Site Recovery | Dokumentacja firmy Microsoft"
...
---
# <a name="networking-for-vm-connectivity-after-failover"></a>Sieć wirtualna łączności po w tryb failover
