...
* Sprawdź zrzuty stosu i dzienniki śledzenia.

### <a name="build-measure-learn"></a>Kompilowanie, mierzenie, poznawanie
Zmierz efektywność każdej nowej wdrażanej funkcji.
