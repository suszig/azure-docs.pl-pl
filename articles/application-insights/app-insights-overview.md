...
* **[Analizowanie użycia aplikacji mobilnej](app-insights-mobile-center-quickstart.md)**  dzięki integracji z programem Visual Studio aplikacji Center.
