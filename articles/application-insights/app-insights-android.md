...
Firma Microsoft udostępnia dwa rozwiązania metodyki DevOps dotyczące urządzeń: [HockeyApp](http://hockeyapp.net/) do analiz po stronie klienta oraz [Application Insights](app-insights-overview.md) po stronie serwera.

[HockeyApp](http://hockeyapp.net/) to nasze rozwiązanie metodyki Mobile DevOps do aplikacji na urządzenia z systemami iOS, OS X, Android lub Windows, a także aplikacji międzyplatformowych opartych na technologiach Xamarin, Cordova i Unity. Dzięki niemu można dystrybuować kompilacje do testerów wersji beta, zbierać dane dotyczące awarii i uzyskiwać opinie użytkowników. Jest zintegrowane z usługami Visual Studio Team Services, co pozwala na łatwe wdrażanie kompilacji i integrację elementów pracy.

Przejdź do strony:

* [HockeyApp](http://support.hockeyapp.net/kb)
* [Wprowadzenie do rozwiązania HockeyApp dla systemu Android](http://support.hockeyapp.net/kb/client-integration-android/hockeyapp-for-android-sdk).
