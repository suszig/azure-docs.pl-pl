<properties 
    pageTitle="Konfigurowanie analizy aplikacji sieci Web w technologii ASP.NET za pomocą usługi Application Insights" 
...
W programie Visual Studio zobaczysz liczbę zdarzeń, które zostały zarejestrowane. 

![W programie Visual Studio przycisk Application Insights jest widoczny podczas debugowania.](./media/app-insights-asp-net/54.png)
...
* Poszczególne zdarzenia są wyświetlane w obszarze **Wyszukiwanie** (1). Dane są wyświetlane najpierw w tym miejscu (i w strumieniu na żywo). Kliknij dowolne zdarzenie, aby wyświetlić jego właściwości. 
...
Jeśli chcesz, możesz [wykonać te kroki ręcznie](app-insights-asp-net-manual.md).
...
| | 
|---|---
|**[Praca z usługą Application Insights w programie Visual Studio](app-insights-visual-studio.md)**<br/>Debugowanie przy użyciu telemetrii, wyszukiwanie diagnostyczne, przechodzenie do szczegółów kodu.|![Visual Studio](./media/app-insights-asp-net/61.png)
...
|**[Dodawanie większej ilości danych](app-insights-asp-net-more.md)**<br/>Monitorowanie użycia, dostępności, zależności, wyjątków. Integrowanie śladów ze struktur rejestrowania. Zapisywanie niestandardowych danych telemetrycznych. | ![Visual Studio](./media/app-insights-asp-net/64.png)
