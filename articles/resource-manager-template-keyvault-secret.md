...
| 名前 | 型 | 必須 | 使用できる値 | 説明 |
| ---- | ---- | -------- | ---------------- | ----------- |
| type | enum | あり | 資格情報コンテナーの子リソースとして:<br />**シークレット**<br /><br />最上位のリソースとして:<br />**Microsoft.KeyVault/vaults/secrets** | 作成するリソースの種類。 |
...
| プロパティ | オブジェクト | はい | (下記参照) | 作成するシークレットの値を指定するオブジェクト。 |
