...
高度なプロパティ | **Bot ユーザー名**: このメッセージに使用する bot の名前。 これが入力されていない場合は、メッセージを"Bot"として投稿されます。<p><p>**アイコンの URL**: このメッセージのアイコンとして使用するイメージの URL。<p><p>**Icon Emoji**: このメッセージのアイコンとして使用される絵文字です。 このプロパティは、アイコンの URL プロパティを上書きします。
