...
4.  **[承認]** を選択します。 Slack アカウントにサインインします。 最後に、Slack アカウントにアクセスする権限をコネクタに付与するように求められます。 選択 **承認**:  
![][3]  
![][4]  
![][5]  
![][6]
...
--- | ---
 ...
 高度なプロパティ| **Bot User name**: このメッセージに使用する Bot の名前。これが入力されていない場合は、メッセージを"Bot"として投稿されます。<p><p>**アイコンの URL**: このメッセージのアイコンとして使用するイメージの URL<p>。<p>**Icon Emoji**: このメッセージのアイコンとして使用される絵文字です。このプロパティは、アイコンの URL プロパティを上書きします。
