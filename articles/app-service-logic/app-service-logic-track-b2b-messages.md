...
## X12
X12 のインスタンスを作成すると、API アプリがそのインスタンスを参照して選択 **追跡**します。 ここでは X12 のすべての追跡情報を表示して、フィルタリングできます。 さらに、インターチェンジ レベル、グループ レベル、トランザクション セット レベルのデータをすべて 1 つのビューに表示することができます。
