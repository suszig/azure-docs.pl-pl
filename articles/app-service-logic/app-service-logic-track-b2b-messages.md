...
## AS2
AS2 API アプリのインスタンスを作成した後、そのインスタンスを参照して選択 **追跡**します。 ここでは AS2 のすべての追跡情報を表示して、フィルタリングできます。  

![][1]  

## EDIFACT
EDIFACT API アプリのインスタンスを作成した後、そのインスタンスを参照して選択 **追跡**します。 ここでは EDIFACT のすべての追跡情報を表示して、フィルタリングできます。 さらに、インターチェンジ レベル、グループ レベル、トランザクション セット レベルのデータをすべて 1 つのビューに表示することができます。 
...
## X12
[X12 のインスタンスを作成した後、API アプリがそのインスタンスを参照して選択 **追跡**します。 ここでは X12 のすべての追跡情報を表示して、フィルタリングできます。 さらに、インターチェンジ レベル、グループ レベル、トランザクション セット レベルのデータをすべて 1 つのビューに表示することができます。
