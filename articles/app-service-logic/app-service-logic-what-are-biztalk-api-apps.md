---
title: "Co to są łączniki i aplikacje API Apps w BizTalk"
...
---
# <a name="what-are-connectors-and-biztalk-api-apps"></a>Co to są łączniki i aplikacje API Apps w BizTalk
[!INCLUDE [app-service-logic-version-message](../../includes/app-service-logic-version-message.md)]

*Łącznik* to typ aplikacji interfejsu API, którego działanie koncentruje się na łączności. Łączniki — tak samo jak każda inna Aplikacja interfejsu API — są używane z poziomu usług Web Apps, Mobile Apps i Logic Apps. Łączniki ułatwiają nawiązywanie połączeń z istniejącymi usługami, wspomagają zarządzanie uwierzytelnianiem, a także oferują możliwości monitorowania, analizy i inne.
...
Aby deweloperzy mogli szybciej tworzyć rozwiązania, zespół ds. platformy Azure dodał w witrynie Marketplace wiele łączników umożliwiających realizację wielu typowych scenariuszy. Ponadto w celu rozszerzenia zasięgu o złożone i zaawansowane scenariusze integracji można skorzystać z możliwości warstwy Premium i usługi BizTalk.

Dostępne są różne „warstwy” usług. Wszystkie warstwy obejmują wszystkie łączniki i aplikacje API Apps wraz z ich pełną funkcjonalnością.  
...
## <a name="hybrid-connectors"></a>Łączniki hybrydowe
...
Reguły biznesowe to zasady i decyzje, które kontrolują procesy biznesowe. Zazwyczaj reguły są dynamiczne i zmieniają się wraz z upływem czasu z różnych powodów, takich jak plany biznesowe, regulacje prawne i wiele innych. Informacje w artykule [BizTalk Rules](app-service-logic-use-biztalk-rules.md) (Reguły BizTalk) ułatwiają oddzielenie tych zasad od kodu aplikacji, dzięki czemu proces wprowadzania zmian jest prostszy i szybszy.

## <a name="connector-and-api-app-list"></a>Lista łączników i Aplikacji interfejsu API
