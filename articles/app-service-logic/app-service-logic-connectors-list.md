---
title: "Lista dostępnych łączników i aplikacji API Apps | Microsoft Docs"
...
---
# <a name="list-of-connectors-and-api-apps-to-use-in-your-logic-apps"></a>Lista łączników i aplikacji API Apps do użycia w aplikacjach Logic Apps
> [!NOTE]
> Ta wersja artykułu ma zastosowanie do aplikacji logiki w wersji schematu 2014-12-01-preview. Informacje o ogólnie dostępnej wersji usługi Logic Apps zawiera [Nowa lista łączników](../connectors/apis-list.md).
> 
> 
...
## <a name="core-connectors"></a>Łączniki podstawowe
...
## <a name="enterprise-integration-connectors"></a>Łączniki integracji dla przedsiębiorstw
...
## <a name="create-your-own-connectors-and-api-apps"></a>Tworzenie własnych łączników i aplikacji API Apps
...
## <a name="more-on-connectors-and-api-apps"></a>Więcej informacji na temat łączników i aplikacji API Apps
