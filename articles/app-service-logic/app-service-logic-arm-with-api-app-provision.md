...
完全なテンプレートを参照してください。 [ロジック アプリと API アプリ テンプレート](https://github.com/Azure/azure-quickstart-templates/blob/master/201-logic-app-api-app-create/azuredeploy.json)します。
