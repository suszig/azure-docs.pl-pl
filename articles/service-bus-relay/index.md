        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Przykłady</h3>
                        <p><a href="/azure/service-bus-relay/service-bus-relay-samples">Przykłady dotyczące usługi Service Bus Relay</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Inne</h3>
                        <p><a href="service-bus-relay-port-settings.md">Ustawienia portu</a></p>
                   </div>
                </div>
            </div>
        </div>
