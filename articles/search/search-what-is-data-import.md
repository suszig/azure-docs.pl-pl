...
プル モデルでは、サポートされているデータ ソースをクロールしてインデックスを読み込みます。 Azure Search では、この機能は*インデクサー*によって実装され、現在は Azure SQL Database、DocumentDB、および Azure VM の SQL Server で利用可能です。 参照してください [インデクサー](search-howto-connecting-azure-sql-database-to-azure-search-using-indexers-2015-02-28.md) Azure SQL データのアップロードについて説明します。
