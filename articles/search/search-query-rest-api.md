...
Azure Search では、非常に強力なクエリを作成できる多くのオプションが用意されています。 クエリ文字列のすべてのさまざまなパラメーターの詳細については、次を参照してください [このページ](https://msdn.microsoft.com/library/azure/dn798927.aspx)します。
