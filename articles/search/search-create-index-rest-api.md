...
## <a name="ii-define-your-azure-search-index-using-wellformed-json"></a>II. Definiowanie indeksu usługi Azure Search przy użyciu poprawnie sformułowanej zawartości JSON
