<properties
    pageTitle="Wprowadzenie do usługi Azure Search w środowisku NodeJS | Microsoft Azure | Hostowana usługa wyszukiwania w chmurze"
...
2. Wpisz polecenie `npm install -g http-server`.
