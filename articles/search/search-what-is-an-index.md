<properties
    pageTitle="Tworzenie indeksu usługi Azure Search | Microsoft Azure | Hostowana usługa wyszukiwania w chmurze"
...
## Typy i atrybuty pól w indeksie usługi Azure Search
...
## Wskazówki dotyczące definiowania schematu indeksu
