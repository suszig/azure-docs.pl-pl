...
Teraz możesz używać narzędzia [Robomongo](../documentdb/documentdb-mongodb-robomongo.md) / [Studio 3T](../documentdb/documentdb-mongodb-mongochef.md) do modyfikowania nowych danych, wykonywania zapytań względem nich i pracowania z nimi.
...
> [Importuj dane usługi MongoDB do usługi Azure Cosmos DB](../documentdb/documentdb-mongodb-migrate.md)
