...
Aby rozpocząć pracę, Pobierz Spark do bazy danych Azure rozwiązania Cosmos connector (wersja zapoznawcza) z [azure-cosmosdb-spark](https://github.com/Azure/azure-cosmosdb-spark/) repozytorium w witrynie GitHub.
...
* [Apache Spark w usłudze Azure HDInsight](../hdinsight/hdinsight-apache-spark-jupyter-spark-sql.md) tak, aby platforma Apache Spark w chmurze na potrzeby wdrożeń krytycznym można wdrożyć za pomocą [Azure HDInsight](https://azure.microsoft.com/services/hdinsight/apache-spark/).
...
mvn clean package
```
Możesz również pobrać najnowsze wersje JAR z *zwalnia* folderu.
...
Poniższy fragment kodu przedstawia sposób korzystania z łącznika w kontekście Spark.
...
* Aby użyć Scala i zaktualizować ją do uwzględnienia otoki Python, zgodnie z opisem w [problem 3: otoki dodać Python i przykłady](https://github.com/Azure/azure-cosmosdb-spark/issues/3).
...
Można także przejrzeć [Apache Spark SQL, przewodnik zestawów danych i DataFrames](http://spark.apache.org/docs/latest/sql-programming-guide.html) i [Apache Spark w usłudze Azure HDInsight](../hdinsight/hdinsight-apache-spark-jupyter-spark-sql.md) artykułu.
