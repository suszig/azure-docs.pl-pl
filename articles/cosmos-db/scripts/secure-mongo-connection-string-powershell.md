...
[!code-powershell[główne](../../../powershell_scripts/cosmosdb/get-mongodb-connection-string/get-mongodb-connection-string.ps1?highlight=37-41 "pobrać ciągu połączenia bazy danych MongoDB z konta bazy danych Azure rozwiązania Cosmos")]
