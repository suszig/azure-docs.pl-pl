...
[!code-powershell[główne](../../../powershell_scripts/cosmosdb/create-firewall/create-firewall.ps1?highlight=35-36,39-43 "utworzenie zapory dla bazy danych Azure rozwiązania Cosmos")]
