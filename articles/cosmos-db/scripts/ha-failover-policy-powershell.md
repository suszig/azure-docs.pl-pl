...
[!code-powershell[główne](../../../powershell_scripts/cosmosdb/modify-failover-priority/modify-failover-priority.ps1?highlight=36-39,42-47 "Tworzenie konta usługi interfejsu API Azure rozwiązania Cosmos bazy danych usługi DocumentDB")]
