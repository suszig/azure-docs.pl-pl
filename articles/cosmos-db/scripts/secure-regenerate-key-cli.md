---
title: "Klucz konta w usłudze Azure DB rozwiązania Cosmos Azure Regenerate skryptu interfejsu wiersza polecenia | Dokumentacja firmy Microsoft"
...
---
# <a name="regenerate-an-azure-cosmos-db-account-key-using-the-azure-cli"></a>Ponowne generowanie klucza konta bazy danych rozwiązania Cosmos Azure przy użyciu wiersza polecenia platformy Azure
...
| [Utwórz az cosmosdb](https://docs.microsoft.com/cli/azure/cosmosdb#az_cosmosdb_create) | Aktualizuje konto bazy danych Azure rozwiązania Cosmos. |
