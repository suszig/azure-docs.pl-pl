...
[!code-powershell[główne](../../../powershell_scripts/cosmosdb/replicate-database-multiple-regions/replicate-database-multiple-regions.ps1?highlight=37-44,47-48,51-55 "replikację konta bazy danych Azure rozwiązania Cosmos w różnych regionach")]
