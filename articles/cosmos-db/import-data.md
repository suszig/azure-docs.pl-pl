...
* Zakres. Ta zasada jest najlepszy, gdy używasz ORDER BY zakresu i zapytań o równość na liczb i ciągów. Ta zasada ma wyższy narzut na przechowywanie indeksu niż domyślne lub wyznaczania wartości skrótu.
