...
HDInsight Emulator の使用に関する情報を参照してください [[hdinsight エミュレーター] HDInsight Emulator の概要][hdinsight-emulator]します。
...
[作成 HDInsight クラスターのカスタム オプション ][hdinsight-provision]します。 詳細については 
