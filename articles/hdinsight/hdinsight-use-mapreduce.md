...
* [Python MapReduce ジョブを開発します。](hdinsight-hadoop-streaming-python.md)
...
この例で使用される MapReduce ジョブは **wasb://example/jars/hadoop-mapreduce-examples.jar**, であり、HDInsight クラスターと共に提供されます。 これには、**davinci.txt** に対して実行するワード カウント例が含まれます。
...
* [HDInsight 用 Python ストリーミング MapReduce プログラムを開発します。](hdinsight-hadoop-streaming-python.md)

* [C# Hadoop ストリーミング MapReduce プログラムを HDInsight ][hdinsight-develop-streaming]

* [HDInsight での Apache Hadoop による Scalding MapReduce ジョブを開発します。](hdinsight-hadoop-mapreduce-scalding.md)
...
* [HDInsight のサンプル ][hdinsight-samples]
