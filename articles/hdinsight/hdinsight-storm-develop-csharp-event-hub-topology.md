...
* [Narzędzia HDInsight tools for Visual Studio](hdinsight-hadoop-visual-studio-tools-get-started.md).
...
Centra zdarzeń to źródło danych, w tym przykładzie. Skorzystaj z informacji w sekcji "Tworzenie Centrum zdarzeń" [Rozpoczynanie pracy z usługą Event Hubs](../event-hubs/event-hubs-csharp-ephcs-getstarted.md).
