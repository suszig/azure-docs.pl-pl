...
**Klaster usługi HDInsight**: Aby uzyskać więcej informacji, zobacz [Rozpoczynanie pracy z usługą HDInsight w systemie Linux](hdinsight-hadoop-linux-tutorial-get-started.md).
