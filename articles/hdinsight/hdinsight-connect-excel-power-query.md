...
- **HDInsight クラスター**。 構成方法については、次を参照してください。 [[hdinsight の入門] Azure HDInsight の概要][hdinsight-get-started]します。
...
## <a id="InstallPowerQuery"></a>Microsoft Power Query for Excel をインストールします。
...
Microsoft Power Query を使用して Excel for ダウンロード、 [power query のダウンロード Microsoft ダウンロード センター][powerquery-download] し、インストールします。

## <a id="ImportData"></a>HDInsight データを Excel にインポートします。
