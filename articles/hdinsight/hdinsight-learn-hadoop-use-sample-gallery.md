...
* [HDInsight の Getting Started ギャラリーを使用して Hadoop を説明します。](hdinsight-learn-hadoop-use-sample-gallery-v1.md)
...
ダッシュ ボードを http://を参照してアクセスできる<YourHDInsightClusterName>.azurehdinsight.net/または Azure ポータルからです。
