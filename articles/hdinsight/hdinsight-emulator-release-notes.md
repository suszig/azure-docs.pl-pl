...
* [Hadoop の更新コンポーネントのバージョン](hdinsight-component-versioning.md) サービスの version 3.1 に対応します。 これには、Hive 0.13 と Tez のサポートが含まれます。
...
- [[Hdinsight の hadoop-エミュレーター-入門] HDInsight Emulator の概要します。][hdinsight-hadoop-emulator-get-started]
