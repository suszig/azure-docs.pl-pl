...
- **HDInsight 環境の HBase クラスター**。 クラスターのプロビジョニング方法については、「  [[hbase--はじめに] HDInsight での Hadoop で HBase の使用開始][hbase-get-started]します。 このチュートリアルを読み進めるには、次のデータが必要です。
  ...
  <table border="1">
    ...
    <tr><td>クラスター ユーザー名</td><td>Hadoop ユーザー アカウント名。既定の Hadoop ユーザー名は <strong>admin</strong>.</td></tr>
    <tr><td>クラスター ユーザー パスワード</td><td>Hadoop クラスター ユーザーのパスワード。</td></tr>
    </table>

- Visual Studio 2013 がインストールされている**ワークステーション**。 手順については、次を参照してください。 [Visual Studio のインストール](http://msdn.microsoft.com/library/e2h7fzkw.aspx)します。





## <a id="twitter"></a>Twitter アプリケーション ID とシークレットを作成します。
...
1. サインイン [Twitter アプリ](https://apps.twitter.com/)します。 Twitter アカウントを持っていない場合は、**[今すぐ登録]** リンクをクリックします。
...
## <a id="streaming"></a> 簡単な Twitter ストリーミング サービスを作成します。
...
Azure Web サイトにこのアプリケーションをデプロイすることもできます。 手順については、次を参照してください。 [Azure Websites と ASP.NET の ][website-get-started]します。
...
- [[Hdinsight での分析の twitter のデータ] の HDInsight の Hadoop を使用した Twitter データを分析します。][hdinsight-analyze-twitter-data]
