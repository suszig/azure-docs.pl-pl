...
4.  **クラスターの構成** ページで入力するか、次を選択します。
    ...
    <table border='1'>
        ...
        <tr><td>リージョン/Virtual Network</td><td><p>リージョン、またはすでに作成済みの場合は Azure 仮想ネットワークを選択します。 このチュートリアルでは、以前に作成したネットワークの選択し、対応するサブネットを選択します。 既定の名前は <b>サブネット 1</b>.</p></td></tr>
