...
[!code-powershell[główne](../../powershell_scripts/hdinsight/streaming-python/streaming-python.ps1?range=138-140)]

Poniższy skrypt programu PowerShell umożliwia przekazanie plików, uruchom zadanie i wyświetlić dane wyjściowe:

[!code-powershell[główne](../../powershell_scripts/hdinsight/streaming-python/streaming-python.ps1?range=5-134)]
