---
title: Dowiedz się, jak używać narzędzi Visual Studio Hadoop dla usługi HDInsight | Microsoft Docs
...
* Stacja robocza z następującym oprogramowaniem:
  ...
  * Visual Studio (jedna z następujących wersji):
    ...
    * Visual Studio 2015 (Community/Enterprise)
    ...
    > [!NOTE]
    > Obecnie narzędzia HDInsight Tools for Visual Studio występują tylko w angielskiej wersji językowej.
    > 
    > 
