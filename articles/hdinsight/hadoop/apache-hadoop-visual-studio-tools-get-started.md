...
* Klaster usługi Azure HDInsight: aby utworzyć klaster, zobacz [Rozpoczynanie pracy z usługą HDInsight opartą na systemie Linux](apache-hadoop-linux-tutorial-get-started.md)
