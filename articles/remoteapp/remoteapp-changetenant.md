<properties
    pageTitle ="Azure RemoteApp で Azure Active Directory テナントの変更 |Microsoft Azure]
    description =「Azure RemoteApp に関連付けられている Azure Active Directory テナントを変更する方法について説明します」
    サービス =「remoteapp」
    documentationCenter=""
    authors ="lizap"
    manager ="mbaldwin"/>
