...
RemoteApp は、Windows ライセンスもリモート デスクトップ CAL も必要としません。 サブスクリプションにより、RemoteApp 側自体のライセンス処理が行われます  (チェック アウト、の詳細 [料金プラン](../../../pricing/details/remoteapp/).)
