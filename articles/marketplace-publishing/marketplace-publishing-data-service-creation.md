...
**公開ポータルに最初にログインするには、デベロッパー センターに登録される会社の販売者のプロファイルを同じアカウントを使用します。**発行ポータルでは、他の従業員を共同管理者として後で追加できます。 
...
> [AZURE.IMPORTANT] 月間のトランザクションの制限に達しているエンドユーザーは、引き続きサービスを使用して、1 か月のサブスクリプションのサイクルの最後までからブロックされます。
