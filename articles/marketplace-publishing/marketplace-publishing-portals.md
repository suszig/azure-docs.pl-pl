...
理想的には、これは、配布リストまたはセキュリティ グループ (@ azurepublishing など*partnercompany*.com)。 配布リストまたはセキュリティ グループは、Microsoft アカウントとして登録する**必要があります**。
...
- [概要: Azure Marketplace のオファーを公開する方法](marketplace-publishing-getting-started.md)
