...
**1. サインインに、Microsoft Developer Center * *。

- 新しい Chrome Incognito または Internet Explorer InPrivate ブラウズ セッションを開き、個人用アカウントにサインインしていないことを確認します。
- に [http://dev.windows.com/registration?accountprogram=azure](http://dev.windows.com/registration?accountprogram=azure)

![inprivate][4]

**2. 貴社の会社または学校アカウント * * (つまり、AzureStore@yourcompany.com) でサインインします。

![signin][5]

**3. 「アカウントを保護する役立つ」検証 * * を完了します。
> [AZURE.NOTE] 電話番号または電子メール アドレスで検証できます。

![protectacct][6]

**4. アカウントの詳細と会社の詳細 * * に移動します。
