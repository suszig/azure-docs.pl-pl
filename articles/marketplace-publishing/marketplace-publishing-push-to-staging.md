...
**英語は既定値し、のみサポートされている言語です。**フィールドに指定するすべての情報が英語であることを確認してください。 ステージングにプッシュするまでは、すべての情報をいつでも編集することができます。
  ...
  3. メイン パネルで、クリックして、 **英語 (米国)** ] ボタンをクリックします。
...
### リンク
 **リンク** 左側のバーのタブで、お客様に役立つ情報とのリンクを入力します。 各リンクの名前と URL を入力します。

![図](media/marketplace-publishing-push-to-staging/pubportal-02.png)

### サンプル イメージ (省略可能)
> [AZURE.NOTE] サンプル イメージを含め、省略可能なステップです。 ステージングにプッシュするための要件を満たすために、他のマーケティング コンテンツを実行することもできます。

 **サンプル イメージ** ] タブで、左側のメニューをクリックして、新しいイメージをアップロード **新しいイメージをアップロード**します。 既存のイメージがあるし、置き換える] をクリックするか **置換イメージ**します。
...
### 法的情報
 **法的** ] タブで、ポリシー/使用条件へのリンクを提供します。 入力するか、大規模な条件を貼り付けます **使用条件** ボックス。

> [AZURE.IMPORTANT] すべてのフィールドには、エントリ、ステージング環境にプッシュできるようにするためのイメージを含む必要があります。
...
|消費量 (ルール サブタイプ) 使用状況、メートル) | 従量課金。プランの発行者が定義します。 超過料金はシートやユーザーごとなどの方法で定義できません。これは、比例配分を行うためのユーザーまたは容量の分割の概念を採用していないためです。 使用量は、時間単位でパートナーが報告します。 お客様は前払いではなく、月額プランなどの月ごとの請求サイクルで支払います。 |
|無料試用版 | お客様は、期間限定で、無料で試用し、その後、標準料金を支払うことを選択できます。 |
|Free レベル | プランは常時無料です |
| 移行 (ルール サブタイプ) 変換またはアップグレード/ダウン グレード) の計画 | ユーザーが現在のプランから別の許容されるプランに移行するという概念。パートナーが定義します。 |

**使用できる価格モデル (プランの種類別)**

> [AZURE.IMPORTANT] 特定の価格設定モデルの可用性は、プランの種類によって異なります。 次の表を参照してください。
...
### 2.1. VM 料金を設定する
> [AZURE.NOTE] BYOL 方法は、仮想マシンにのみサポートされます。

1.  下にある、 **価格** ] タブで、サポートされている市場のすべてが表示されます。 適切なものを 1 つ選択し、価格フィールドに移ります。
...
|ブロンズ プラス|無料試用期間: 0 ドル/月 + 0 ドル/メーター 01 |基本的な機能と機能 X の 10,000 のクォータ。 機能 X クォータが使用されると、meter01 経由で使用する単位、顧客を支払うことができます。|シルバー プラスとゴールドの各プランに移行可能|
|ブロンズ プラス| (ルール サブタイプ) 有料期間 無料の試用期間が期限切れ): 10 ドル/月 + 0.05 ドル/meter01|基本的な機能と機能 X の 10,000 のクォータ。 機能 X クォータが使用されると、meter01 経由で使用する単位、顧客を支払うことができます。|シルバー プラスとゴールドの各プランに移行可能|
|シルバー|0.15 ドル/メーター 01|お客様は、メーター 01 経由で、従量課金で支払います (機能 X 用)|ブロンズ、ゴールドの各プランに移行可能|
|シルバー プラス|20 ドル/月 + 0.15 ドル/メーター 01 + 0.01 ドル/メーター 02|基本的な機能は、10,000 台機能 X と Y の機能の 100 のクォータ。 機能 X クォータが使用されると、meter01 経由で使用する単位、顧客を支払うことができます。  機能 Y のクォータが使用されると、お客様は メーター 02 経由の従量課金で支払うことができます。|ブロンズ プラス、ゴールドの各プランに移行可能|
...
1.  移動して、 **サポート** 公開ポータルの左側にある見出しです。
2.  下にある情報を入力 **エンジニア リングにお問い合わせください**します。
3.  下にある情報を入力 **カスタマー サポート**します。 電子メール サポートのみを指定する場合は、ダミーの電話番号を入力すると、指定した電子メールが代わりに使用されます。
4.  サポート URL を入力します。

## 手順 4.: Azure Marketplace カテゴリを選択する
 **カテゴリ** ] タブが選択項目の配列を提供します。 該当するカテゴリを最大 5 つまで選択できます。

## マーケティングの表示例
以下はマーケティング情報の提供を使用する方法の詳細を表示で、 [Azure Marketplace web サイト](http://azure.microsoft.com/marketplace) し、[、 [Azure プレビュー ポータル](https://ms.portal.azure.com)します。
