...
> [!IMPORTANT]
>Usługa Azure Media Services zawiera pełną integrację z usługą Azure CDN. Za pomocą jednego kliknięcia można je zintegrować wszystkie dostępne usługi Azure CDN dostawców (Akamai i Verizon) do punktu końcowego przesyłania strumieniowego w tym produktów w sieci CDN w warstwie standardowa i Premium. Aby uzyskać więcej informacji, zobacz [anonsu](https://azure.microsoft.com/blog/standardstreamingendpoint/).
> 
...
1. Aby skonfigurować nagłówków pamięci podręcznej przy użyciu portalu Azure, zajrzyj do [jak zarządzać punktami końcowymi przesyłania strumieniowego](../media-services/media-services-portal-manage-streaming-endpoints.md) sekcji konfiguracji punktu końcowego przesyłania strumieniowego.
