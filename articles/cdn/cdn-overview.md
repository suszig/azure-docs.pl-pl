...
- [国のフィルタ リング](cdn-restrict-access-by-country.md)
- [コアの分析](cdn-analyze-usage-patterns.md)
- [カスタム コンテンツの元のドメイン](cdn-map-content-to-custom-domain.md)
- [HTTPS の有効化します。](cdn-how-to-use-cdn.md#accessing-cached-content-over-https)
- 負荷分散
- DDOS 保護
- [高速の消去します。](cdn-purge-endpoint.md)
- [REST API を介して管理](https://msdn.microsoft.com/library/mt634456.aspx)
