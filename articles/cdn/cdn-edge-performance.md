...
> [AZURE.NOTE] エッジ パフォーマンス分析は、Premium CDN レベルの機能です。 Standard および Premium CDN 機能の比較では、次を参照してください。 [Azure CDN の概要](cdn-overview.md)します。
>
...
1. [CDN プロファイル] ブレードで、**[管理]** をクリックします。
    ...
    ![[CDN プロファイル] ブレードの ](./media/cdn-edge-performance/cdn-manage-btn.png)
...
-------|------------
 ...
 HTTP 応答コード| HTTP 状態コードの内訳 (200 など、OK、403 など禁止ですが、404 が見つかりません)。エッジ サーバーで HTTP クライアントに配信されました。円グラフでは、アセットがどのように提供されたかをすばやく評価することができます。詳細な統計データは、応答コードごとに、グラフの下に表示されます。
