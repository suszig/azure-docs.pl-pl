...
4. **リソース グループ**を選択または作成します。 リソース グループの詳細については、次を参照してください。 [Azure リソース マネージャーの概要](resource-group-overview/#resource-groups)します。
...
- [コンテンツ配信ネットワーク (CDN) コンテンツをカスタム ドメインにマップする方法](cdn-map-content-to-custom-domain.md)
