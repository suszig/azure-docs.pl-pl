...
> [AZURE.NOTE] 規則エンジンは、Premium CDN 層の機能です。 Standard および Premium CDN 機能の比較では、次を参照してください。 [Azure CDN の概要](cdn-overview.md)します。

## チュートリアル

1. [CDN プロファイル] ブレードで、**[管理]** をクリックします。

    ![[CDN プロファイル] ブレードの ](./media/cdn-rules-engine/cdn-rules-manage-btn.png)
...
* [ルール エンジンの一致条件と機能の詳細](cdn-rules-engine-details.md)
* [Azure CDN の概要](cdn-overview.md)
* [Microsoft Azure CDN でのリアルタイムの統計](cdn-real-time-stats.md)
