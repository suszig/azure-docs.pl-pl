---
title: "Skróty klawiaturowe dla usługi Azure Data Catalog | Dokumentacja firmy Microsoft"
description: "W tym artykule przedstawiono skróty klawiaturowe dla usługi Azure Data Catalog."
...
## <a name="keyboard-shortcuts-for-the-data-catalog-data-source-registration-tool"></a>Narzędzia rejestracji źródła skróty klawiaturowe dla danych wykazu danych
### <a name="general-keyboard-shortcuts"></a>Ogólne skróty klawiaturowe
| Operacja | Naciśnij klawisz |
| --- | --- |
| Karta do każdego formantu na stronie |Karta |
...
| Zmień wybranego typu, gdy fokus jest ustawiony na kafelka |W lewo, w górę w prawo lub Strzałka w dół |
...
| Przejdź do każdego elementu listy |W górę i Strzałka w dół |
| Hierarchia serwera rozwiń węzeł widoku drzewa |STRZAŁKA W PRAWO |
| Przenieś zaznaczone elementy dla **dostępne obiekty** lub **obiekty do zarejestrowania** |SPACJA |
...
## <a name="keyboard-shortcuts-for-the-data-catalog-portal"></a>Skróty klawiaturowe dla portalu wykazu danych
| Operacja | Naciśnij klawisz |
| --- | --- |
...
| Na stronie odnajdowania po aktywowaniu zasobów wybierz zasobów |MIEJSCA lub ENTER |
| Dodaje lub usuń zasobów z wyborem wielokrotnym |CTRL + SPACJA lub ENTER |
| Przełącz na wyszukiwanie dopasowań |ALT + S |
| Przełącz **Otwórz w** menu |ALT + O |
| Eksplorowanie kontenera, jeśli zasób jest kontenerem |ALT + L |
