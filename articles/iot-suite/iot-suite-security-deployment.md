...
Korzystanie z [oparta na urządzeniach certyfikatu X.509] [ lnk-protocols] i jego skojarzony prywatnych i publicznych pary kluczy umożliwia dodatkowe uwierzytelnianie w warstwie fizycznej. Klucz prywatny jest bezpiecznie przechowywana w urządzeniu, a nie wykrywalny poza urządzenie. Certyfikat X.509 zawiera informacje dotyczące urządzenia, takich jak identyfikator urządzenia i inne szczegóły organizacji. Podpis certyfikatu jest generowany przy użyciu klucza prywatnego.
...
* [Azure DB rozwiązania Cosmos][lnk-docdb]: Usługa skalowalne, pełni indeksowana bazy danych dla częściowo ustrukturyzowanych danych, która zarządza metadanych dla urządzeń udostępnieniem, takich jak atrybuty, konfiguracji i właściwości zabezpieczeń. Rozwiązania cosmos DB oferuje przetwarzanie wysokiej wydajności i wysokiej przepustowości, niezależny od schematu indeksowania danych i interfejs zaawansowanych zapytań SQL.
