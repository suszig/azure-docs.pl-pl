<properties
   pageTitle="Zabezpieczenia usługi Azure Automation | Microsoft Azure"
...
Konto Uruchom jako platformy Azure | Azure Resource Manager | [Uwierzytelnianie elementów Runbook przy użyciu konta Uruchom jako platformy Azure](../automation/automation-sec-configure-azure-runas-account.md)
Klasyczne konto Uruchom jako platformy Azure | Usługa Azure Service Management | [Uwierzytelnianie elementów Runbook przy użyciu konta Uruchom jako platformy Azure](../automation/automation-sec-configure-azure-runas-account.md)
