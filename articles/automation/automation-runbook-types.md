...
| 型| 説明|
|:---|:---|
| [グラフィック](#graphical-runbooks)| Windows PowerShell ワークフローに基づいており、Azure ポータルのグラフィカル エディターで完全に作成および編集されます。|
...
- [作成または Runbook をインポートします。](http://msdn.microsoft.com/library/azure/dn643637.aspx)
