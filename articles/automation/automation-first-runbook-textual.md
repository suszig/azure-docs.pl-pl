...
7. Gdy stanem elementu Runbook będzie *Ukończono*, kliknij pozycję **Dane wyjściowe**. Zostanie otwarte okienko danych wyjściowych z naszym ciągiem *Witaj, świecie*.<br> ![Podsumowanie zadania](media/automation-first-runbook-textual/job-pane-output.png)  
