...
次の表は、公開された runbook を実行している場合との両方の各ストリームと、Azure 管理ポータルでの動作の簡単な説明を示します [runbook をテストする](http://msdn.microsoft.com/library/azure/dn879147.aspx)です。 各ストリームの詳細については、後続のセクションで説明します。
