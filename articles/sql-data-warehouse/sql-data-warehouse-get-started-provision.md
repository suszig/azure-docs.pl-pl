...
- **Serwer Azure SQL**: Aby uzyskać więcej informacji, zobacz [Tworzenie serwera logicznego usługi Azure SQL Database przy użyciu witryny Azure Portal][].

> [AZURE.NOTE] Utworzenie bazy danych w usłudze SQL Data Warehouse może skutkować powstaniem nowej usługi płatnej.  Aby uzyskać więcej informacji o cenach, zobacz [Cennik usługi SQL Data Warehouse][].
...
> [AZURE.NOTE] Sortowanie domyślne dla usługi SQL Data Warehouse to SQL_Latin1_General_CP1_CI_AS. Jeśli potrzebne jest inne sortowanie, za pomocą polecenia języka [T-SQL][] można utworzyć bazę danych z innym sortowaniem.

4. Kliknij przycisk **Utwórz**, aby utworzyć usługę SQL Data Warehouse.

5. Poczekaj kilka minut. Po utworzeniu magazynu danych powinien nastąpić powrót do witryny [Azure Portal](https://portal.azure.com). Usługę SQL Data Warehouse można znaleźć na pulpicie nawigacyjnym, na liście Bazy danych SQL lub w grupie zasobów użytej podczas tworzenia. 
...
Reguły zapory można również skonfigurować za pomocą języka Transact-SQL. Aby uzyskać więcej informacji, zobacz artykuły dotyczące poleceń [sp_set_firewall_rule][] i [sp_set_database_firewall_rule][].

Warto również zapoznać się z artykułem [Najlepsze praktyki][].
