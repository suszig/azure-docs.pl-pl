...
[SQL Data Warehouse を作成する][] サンプル データを含むデータベースをプロビジョニングする方法を示します。 ができる場合は、既に SQL Data Warehouse データベースがあるが、サンプル データがない、 [サンプル データを手動で読み込む:operator[]][]
...
1. サインイン [Azure Machine Learning studio の][] [実験] をクリックします。
...
1. **[モデルのスコア付け]** モジュールをキャンバスにドラッグします。
    最初の入力: トレーニング済みのモデル
    2 番目の入力: テスト データ
![モデルにスコアを付ける][9]
