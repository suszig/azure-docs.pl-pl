...
7. **[サポート プラン]** を選択します。
    ...
    - スコープ、応答時間、料金などを含む Azure のサポートの詳細を参照 [Azure サポート プラン][]します。

    ![サポート プラン](./media/sql-data-warehouse-get-started-create-support-ticket/support-plan.png)

    プレミア サポート プランがある場合は、SQL Data Warehouse も報告できますに関連する問題、 [マイクロソフト プレミア サポート オンライン ポータルの [][]します。
...
接続するさらに、SQL Data Warehouse と azure sqldw を使用したコミュニティのタグを [スタック オーバーフロー][] または [Azure SQL データ ウェアハウスの MSDN フォーラムの][]します。
