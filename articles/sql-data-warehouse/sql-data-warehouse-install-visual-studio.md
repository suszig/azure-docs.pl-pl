...
1. [Visual Studio 2015 のダウンロード](https://www.visualstudio.com/downloads) Visual Studio チームのサービスからです。 
2. に従ってをインストール、 [Visual Studio のインストール](https://msdn.microsoft.com/library/e2h7fzkw.aspx) MSDN のガイドし、既定の構成を選択します。
...
1. [SQL Server データ ツールのプレビューをダウンロードして](https://msdn.microsoft.com/library/mt204009.aspx) Visual Studio 2013 または 2015年のいずれかにします。
2. ダウンロード サイトのインストール手順に従って、インストールします。

## 次のステップ

準備ができたら、最新バージョンの SSDT をしたら [接続](./sql-data-warehouse-get-started-connect.md) 、データベースにします。
