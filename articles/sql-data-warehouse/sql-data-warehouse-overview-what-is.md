...
## Optymalizacja pod kątem obciążeń magazynu danych
...
## Wstrzymywanie i skalowanie na żądanie
...
## Oparta na programie SQL Server
...
- Niektóre elementy języka T-SQL, które są mniej typowe dla obciążeń magazynowania danych lub są nowsze dla programu SQL Server, mogą być obecnie niedostępne. Aby uzyskać więcej informacji, zapoznaj się z [dokumentacją dotycząca migracji][].
...
**Narzędzia oparte na chmurze:** Usługi SQL Data Warehouse można używać razem z szeregiem nowych narzędzi platformy Azure, takimi jak Data Factory, Stream Analytics, Machine Learning oraz z usługą Power BI. Bardziej kompletny wykaz znajdziesz w artykule [Integrated tools overview][] (Przegląd zintegrowanych narzędzi).

**Narzędzia innych firm:** Duża liczba innych firm dostarczających narzędzia ma certyfikat integracji swoich narzędzi z usługą SQL Data Warehouse. Pełną listę znajdziesz w artykule [SQL Data Warehouse solution partners][] (Partnerzy rozwiązania SQL Data Warehouse).

## Hybrydowe scenariusze źródeł danych
