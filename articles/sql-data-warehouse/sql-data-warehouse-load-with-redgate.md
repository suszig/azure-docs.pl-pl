<properties
   pageTitle="Za pomocą usługi Data Platform Studio firmy Redgate można ładować dane do usługi SQL Data Warehouse | Microsoft Azure"
...
> [AZURE.NOTE] Firma [Redgate](http://www.red-gate.com) to wieloletni partner firmy Microsoft, który dostarcza różne narzędzia programu SQL Server. Ta funkcja w usłudze Data Platform Studio została udostępniona bezpłatnie do użytku komercyjnego i niekomercyjnego.
...
> [AZURE.NOTE] Bramę można zainstalować na dowolnej maszynie z dostępem sieciowym do źródłowej bazy danych programu SQL Server. Uzyskuje ona dostęp do bazy danych programu SQL Server przy użyciu uwierzytelniania systemu Windows i poświadczeń bieżącego użytkownika.
...
- [Tworzenie zapytań względem usługi Azure SQL Data Warehouse (Visual Studio)][]
...
- [Migrowanie rozwiązania do usługi SQL Data Warehouse][]
...
[Wizualizacja danych przy użyciu usługi Power BI]: ./sql-data-warehouse-get-started-visualize-with-power-bi.md
[Migrowanie rozwiązania do usługi SQL Data Warehouse]: ./sql-data-warehouse-overview-migrate.md
[Ładowanie danych do usługi Azure SQL Data Warehouse]: ./sql-data-warehouse-overview-load.md
