...
> [AZURE.NOTE] SSDT の SQL Data Warehouse への接続に関するガイダンスを参照してください戻る、 [接続し、クエリ][] 概要についての記事です。 

ことが再び TRANSACT-SQL ステートメント **使用 <your DB>** 接続のデータベースの変更はサポートされていません 
...
## 次のステップ
接続が完了したら、テーブルの設計を開始できます。 参照してください、 [table design] の詳細については、資料です。
