...
- **Środowisko do wykonywania poleceń języka T-SQL**: Do wykonywania poleceń języka T-SQL możesz użyć programu [Visual Studio][Instalowanie programu Visual Studio i narzędzi SSDT], narzędzia [sqlcmd][] lub programu [SSMS][].
