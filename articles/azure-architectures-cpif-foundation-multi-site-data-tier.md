...
[Cloud Platform Integration Framework (CPIF)](azure-architectures-cpif-overview.md) アプリケーションを Microsoft クラウド ソリューションにオンボードするためのワークロード統合ガイダンスを提供します。
...
SQL Server 2012 で導入された AlwaysOn 可用性グループは、Azure Infrastructure Service 上に完全にサポートされる高可用性および障害復旧機能です。 詳細な情報と Windows Azure Infrastructure Service 上の AlwaysOn 可用性グループの正式なサポートのアナウンスは AlwaysOn 可用性グループの記事で見つかります。
...
![リソース ブレードとリソース グループのブレードの ](./media/azure-architectures-cpif-foundation-multi-site-data-tier/overview.png)
