...
2.  [Azure クラシック ポータル] にログオンし、選択 **クラウド サービス**します。 クラウド サービスを作成して、**[ステージング]** 列の状態が**実行中**に更新されたら、サービス名をクリックします。
...
1.  [Azure 旧ポータルにログイン] をクリックして **クラウド サービス** サービス名を選択します。
...
- [Azure の Vip スワップによってサービス アップグレードを運用環境に配置する方法]
