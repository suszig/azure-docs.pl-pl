...
この問題のトラブルシューティング方法の詳細については、「ブログの投稿 [Azure PaaS コンピューティング診断データ] と [一般的な問題ロールがリサイクル](cloud-services-troubleshoot-common-issues-which-cause-roles-recycle.md)
...
2. Azure クラシック ポータルの **[プロパティ]** ウィンドウで次の状況を考慮しながら、問題を解決します。
   ...
   * 診断データと、ブログ投稿 [Azure PaaS コンピューティング診断データ] のトラブルシューティングのシナリオを見ていきます。
