...
2. Na [Azure strony portalu klasycznego](http://go.microsoft.com/fwlink/p/?LinkID=269851), wyświetlić pulpit nawigacyjny maszyny wirtualnej, aby wyświetlić maszyny wirtualnej **odcisk PALCA certyfikatu protokołu RDP**. Ta wartość jest używana dla `ServerThumbprint` wartości w konfiguracji rozszerzenia.
