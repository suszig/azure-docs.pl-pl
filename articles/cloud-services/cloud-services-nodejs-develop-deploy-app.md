<properties
    pageTitle="Wprowadzenie do języka Node.js — przewodnik | Microsoft Azure"
...
>[AZURE.TIP] Chcesz utworzyć prostą witrynę sieci Web? Jeśli scenariusz obejmuje tylko prosty fronton witryny sieci Web, rozważ użycie [korzystanie z lekkiej aplikacji sieci web]. Możesz łatwo przeprowadzić uaktualnienie do Usługi w chmurze w przypadku rozwoju witryny sieci Web lub zmiany wymagań.
...
> [AZURE.NOTE] W tym samouczku jest używany program Azure PowerShell, który wymaga systemu Windows.
...
4.  Wprowadź poniższe polecenie, aby dodać nową rolę sieci Web:
    ...
    > [AZURE.NOTE] Jeśli nie określisz nazwy roli, będzie używana nazwa domyślna. Nazwa może być pierwszym parametrem polecenia cmdlet: `Add-AzureNodeWebRole MyRole`
...
> [AZURE.NOTE] W przypadku publikowania aplikacji po raz pierwszy jej wdrożenie i udostępnienie może potrwać kilka minut.
