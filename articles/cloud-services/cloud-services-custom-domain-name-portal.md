...
1. これらの手段のいずれかを使用して、クラウド サービスに割り当てられた **.cloudapp.net** ドメイン名を見つけます。
    ...
    * ログインで確認して、[Azure ポータル] に、クラウド サービスを選択して、 **Essentials** セクションし、検索、 **サイトの URL** エントリです。
...
1. 次の手段のいずれかを使用して、クラウド サービスの IP アドレスを取得します。
    ...
    * ログインで確認して、[Azure ポータル] に、クラウド サービスを選択して、 **Essentials** セクションし、検索、 **パブリック IP アドレスを** エントリです。
