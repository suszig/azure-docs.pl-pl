...
* 詳細については、 [App Service](../app-service-web-overview.md)
* 詳細については、 [クラウド サービス](services/cloud-services/)
* 詳細については、 [仮想マシン](https://msdn.microsoft.com/library/azure/jj156143.aspx)
