...
> [AZURE.NOTE] アンインストール済み情報 MS15 031 が表示されます。 このゲスト OS リリースには適用されません。
...
| 該当なし         | [3004375][3004375] | Windows を改善する更新プログラムのコマンド ラインの監査<p/>**注**: これは、インストールされますが、有効にするレジストリ キーがになっています | 4.17、3.24、2.36 | 該当なし |
