...
> [AZURE.NOTE]関連する Azure の制限を表示するには、を参照してください [Azure サブスクリプションとサービスの制限、クォータ、および制約](../azure-subscription-service-limits.md)。
...
| A8| 8| 56 GB| OS = ゲスト OS のサイズ<br/>ローカル リソース = 1856172 MB<br/>アプリ = 約 1.5 GB<blockquote> 注: 情報とこのサイズの使用に関する注意事項については、次を参照してください。 <a href="http://go.microsoft.com/fwlink/p/?linkid=328042">A8、A9、A10、A11 コンピューティング集中型インスタンスおよび</a>します。</blockquote>|
| A9| 16| 112 GB| OS = ゲスト OS のサイズ<br/>ローカル リソース = 1856172 MB<br/>アプリ = 約 1.5 GB<blockquote> 注: 情報とこのサイズの使用に関する注意事項については、次を参照してください。 <a href="http://go.microsoft.com/fwlink/p/?linkid=328042">A8、A9、A10、A11 コンピューティング集中型インスタンスおよび</a>します。</blockquote>|
| A10| 8| 56 GB| OS = ゲスト OS のサイズ<br/>ローカル リソース = 1856172 MB<br/>アプリ = 約 1.5 GB<blockquote> 注: 情報とこのサイズの使用に関する注意事項については、次を参照してください。 <a href="http://go.microsoft.com/fwlink/p/?linkid=328042">A8、A9、A10、A11 コンピューティング集中型インスタンスおよび</a>します。</blockquote>|
| A11| 16| 112 GB| OS = ゲスト OS のサイズ<br/>ローカル リソース = 1856172 MB<br/>アプリ = 約 1.5 GB<blockquote> 注: 情報とこのサイズの使用に関する注意事項については、次を参照してください。 <a href="http://go.microsoft.com/fwlink/p/?linkid=328042">A8、A9、A10、A11 コンピューティング集中型インスタンスおよび</a>します。</blockquote>|
...
[Azure のクラウド サービスをセットアップします。](https://msdn.microsoft.com/library/hh124108)
