...
1. W [portalu Azure](https://portal.azure.com), wybierz pozycję **nowy** > **obliczeniowe** > **aplikacji funkcji**.
...
2. Na **aplikacji funkcji** bloku, wprowadź następujące wartości, a następnie wybierz **OK** do utworzenia aplikacji:
    ...
    |**Plan hostingu**|Użycie planu| Typ planu używany przez funkcję aplikacji. Dostępne opcje to zużycie lub plan usługi aplikacji Azure. |
...
6. Przejdź do usługi Azure moduły. W lokalnej **AzureRM.Network** folderu, wybierz wszystkie pliki w folderze. Następnie wybierz **OK**. 
