...
## <a name="a-namediagramsaconnection-topology-diagrams"></a><a name="diagrams"></a>Diagramy topologii połączeń
Dostępne są różne konfiguracje połączeń bramy sieci VPN. Musisz określić, która konfiguracja najlepiej odpowiada Twoim wymaganiom. Poniższe sekcje zawierają informacje i diagramy topologii dotyczące następujących połączeń bramy sieci VPN: Poniższe sekcje zawierają tabele z informacjami o następujących elementach:
...
### <a name="site-to-site-and-multi-site-connections"></a>Połączenia typu lokacja-lokacja i połączenia obejmujące wiele lokacji
#### <a name="a-names2sasite-to-site"></a><a name="S2S"></a>Lokacja-lokacja
...
#### <a name="a-namemultiamulti-site"></a><a name="Multi"></a>Wiele witryn
...
### <a name="a-namev2vavnet-to-vnet-connections"></a><a name="V2V"></a>Połączenia między sieciami wirtualnymi
...
### <a name="a-namecoexistingasite-to-site-and-expressroute-coexisting-connections"></a><a name="coexisting"></a>Współistniejące połączenia typu lokacja-lokacja i ExpressRoute
