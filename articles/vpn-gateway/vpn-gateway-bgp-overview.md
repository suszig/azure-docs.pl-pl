---
title: Omówienie użycia protokołu BGP z bramami sieci VPN na platformie Azure | Microsoft Docs
...
> [!IMPORTANT]
> Obecnie anonsowanie trasy domyślnej (0.0.0.0/0) do bram sieci VPN platformy Azure będzie blokowane. Po włączeniu tej możliwości zostaną udostępnione dalsze aktualizacje.
> 
> 
...
## <a name="bgp-faqs"></a>Protokół BGP — często zadawane pytania
