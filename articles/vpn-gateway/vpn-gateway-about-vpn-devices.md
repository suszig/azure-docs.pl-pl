...
| Barracuda Networks, Inc.| Barracuda Firewall| Barracuda Firewall 6.5| [Barracuda ファイアウォール](https://techlib.barracuda.com/BFW/ConfigAzureVPNGateway)| 互換性なし|
...
| Citrix| CloudBridge MPX アプライアンス、または VPX 仮想アプライアンス| 該当なし| [統合手順](https://www.citrix.com/welcome.html?resource=%2Fdownloads%2Fcloudbridge%2Fbetas-and-tech-previews%2Fcloudbridge-azure-integration)| 互換性なし|
...
| Palo Alto Networks| PAN-OS 5.0 またはそれ以上を実行しているすべてのデバイス| PAN-OS 5x またはそれ以上| [パロアルト ネットワーク](https://support.paloaltonetworks.com/)| 互換性なし|
...
1. メモ帳を使用してサンプルを開きます。
1. 検索し、置換すべて <*text*> 文字列は、環境に対応する値。含めてください < と > です。名前を指定する場合、選択する名前は一意である必要があります。コマンドが機能しない場合は、デバイスの製造元のドキュメントを参照してください。
