...
---
# <a name="create-and-provision-an-x509-simulated-device-using-iot-hub-device-provisioning-service-preview"></a>Tworzenie i aprowizowanie symulowanego urządzenia X.509 za pomocą usługi IoT Hub Device Provisioning Service (wersja zapoznawcza)
