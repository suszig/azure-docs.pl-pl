...
---
# <a name="create-and-provision-a-simulated-device-using-iot-hub-device-provisioning-services"></a>Tworzenie i aprowizowanie symulowanego urządzenia za pomocą usług IoT Hub Device Provisioning
