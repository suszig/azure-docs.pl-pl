...
4. W bloku podsumowania usługi Device Provisioning Service wybierz pozycję **Zarządzaj rejestracjami**. Wybierz kartę **Indywidualne rejestracje** i kliknij u góry przycisk **Dodaj**. Wybierz pozycję **Moduł TPM** jako *mechanizm* zaświadczania o tożsamości i wprowadź *Identyfikator rejestracji* oraz *Klucz poręczenia* zgodnie z wymogami bloku. Gdy skończysz, kliknij przycisk **Zapisz**. 
