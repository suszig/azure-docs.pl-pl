...
|Rozmiar - Size\Name |Procesor wirtualny     |Memory (Pamięć) | Maksymalny rozmiar dysku tymczasowego | Przepływność dysku Mac OS: (IOPS) | Maksymalna przepustowość tymczasowego magazynu (IOPS) | Dysku (IOPS) maksymalna przepustowość |
|-----------------|-----|---------|---------|-----|------|-----------|
...
|----------------|--|------|----|----|----|-------|---------|
|**Standardowa_A0** |1 |0,768 |20  |500 |500 |1 x 500  |2 / 100  |
