...
Użytkownicy mogą teraz używać źródła wdrożenia dla elementów, takich jak [ciągłe wdrażanie](https://docs.microsoft.com/en-us/azure/app-service-web/app-service-continuous-deployment), [lokalnego wdrożenia Git](https://docs.microsoft.com/en-us/azure/app-service-web/app-service-deploy-local-git), i [chmury synchronizacji folderu](https://docs.microsoft.com/en-us/azure/app-service-web/app-service-deploy-content-sync).
