...
## [Ponowne wdrażanie usługi Azure Stack](azure-stack-redeploy.md)
...
# Tworzenie magazynu i zarządzanie nim
## [Omówienie](azure-stack-storage-overview.md)
## [Zarządzanie kontami magazynu](azure-stack-manage-storage-accounts.md)
...
## [Wyświetlanie zużycia publicznego adresu IP](azure-stack-viewing-public-ip-address-consumption-in-tp2.md)

# Dodawanie zawartości do usługi Azure Stack
...
# Zarządzanie wartościami bezpiecznymi za pomocą usługi Key Vault
## [Wprowadzenie](azure-stack-kv-intro.md)
## [Rozpoczęcie pracy](azure-stack-kv-getting-started.md)
## [Wdrażanie maszyny wirtualnej z hasłem usługi Key Vault](azure-stack-kv-deploy-vm-with-secret.md)
## [Tworzenie maszyny wirtualnej z certyfikatem usługi Key Vault](azure-stack-kv-push-secret-into-vm.md)
## [Przykładowa aplikacja usługi Key Vault](azure-stack-kv-sample-app.md)

# Śledzenie użycia dla fakturowania i obciążenia zwrotnego
...
### [Włączanie publikowania FTP](azure-stack-app-service-enable-ftp.md)
