...
1. **Visual Studio**
    ...
    > [AZURE.NOTE] Visual Studio の機能の登録を編集するのには、登録数が限られた開発/テスト中にのみ使用する必要があります。 登録を一括で修正する必要がある場合は、エクスポート/インポートを使用することを検討してください登録説明されている機能として、[エクスポート/インポートの登録] (https://msdn.microsoft.com/library/dn790624.aspx)
