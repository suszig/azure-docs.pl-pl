...
![ジャンプバーの ](./media/documentdb-create-collection/docdb-database-creation-1-3.png)

1.  [Azure ポータル](https://portal.azure.com/), 、ジャンプバー、[ **DocumentDB アカウント**します。

2.  **[DocumentDB アカウント]** ブレードで、コレクションを追加するアカウントを選択します。 表示されているすべてのアカウントを取得していない場合は、する必要があります [DocumentDB アカウントの作成](documentdb-create-account.md)します。

3. 選択したアカウントの **[DocumentDB アカウント]** ブレードで、**[データベース]** レンズまで下にスクロールし、コレクションを追加するデータベースを選択します。

4. **[データベース]** ブレードで、**[コレクションの追加]** をクリックします。

    ![[データベース] ブレードの ](./media/documentdb-create-collection/docdb-collection-creation-4-7.png)
