...
1.  特定の部分に表示されるメトリックをカスタマイズするには、メトリックのグラフを右クリックし、[ **グラフの編集**します。  
    ![[グラフの編集] ボタンをハイライトした要求数合計チャートのスクリーンショット](./media/documentdb-monitor-accounts/madocdb3.png)
...
2.  メニューの **[複製]** をクリックしてパーツをコピーし、**[カスタマイズの完了]** をクリックします。
    ...
    ![[複製] および ](./media/documentdb-monitor-accounts/madocdb7.png)
...
2.  内で、 **操作** レンズをクリックして、 **アラート ルール** 部分です。  
    ![[操作] レンズ内で ](./media/documentdb-monitor-accounts/madocdb10.png)

3.  アラート ルール] ブレードで [ **アラートの追加**します。  
    ![[アラート ルール] ブレードで ](./media/documentdb-monitor-accounts/madocdb11.png)
