...
5. **[スケジュールの管理]** ダイアログ ボックスの **[スケジュールの追加または変更]** で、以下の手順を実行します。
    ...
    2. チェック アイコンをクリックして ![1 のスケジュールを変更して](./media/storsimple-add-modify-backup-schedule-u2/HCS_CheckIcon-include.png)します。
    ...
    5. チェック アイコンをクリックして ![チェック マーク アイコン](./media/storsimple-add-modify-backup-schedule-u2/HCS_CheckIcon-include.png) スケジュールを保存します。
