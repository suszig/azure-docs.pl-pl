...
* * 図: Azure App Service は、静的な web ページ、一般的な web アプリケーション、およびさまざまなテクノロジで構築されたカスタム web アプリケーションをサポートします。 モバイル バックエンド、API アプリを実行することもでき、web 以外のコンピューティング ワークロード (web ジョブを使用). * *
