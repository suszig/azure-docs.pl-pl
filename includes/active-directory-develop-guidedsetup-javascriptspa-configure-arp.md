...
Skonfiguruj `Redirect URL` pola z adresem URL strony index.html oparte na serwerze sieci web, a następnie kliknij przycisk *aktualizacji*.
...
> Dla języka Python można ustawić sieci web port serwera przy użyciu wiersza polecenia. Ten przewodnik instalacji korzysta z portu 8080 dla odwołania, ale działanie może używać innych dostępnych portów. W każdym przypadku użyj poniższych instrukcji, aby skonfigurować adres URL przekierowania w informacji o rejestracji aplikacji:<br/>
