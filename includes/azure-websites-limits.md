...
[スケール アウト](web-sites-scale.md) (最大インスタンス)|1 Shared インスタンス|1 Shared インスタンス|3 専用インスタンス<sup>3</sup>|10 専用インスタンス<sup>3</sup>|50 専用インスタンス<sup>3、4</sup>
...
同時実行 [デバッガーの接続](web-sites-dotnet-troubleshoot-visual-studio.md) アプリケーション単位|1|1|1|5|5
