...
- [(Windows ランタイム 8.1 ユニバーサル c# | .NET)](../articles/mobile-services-dotnet-backend-windows-store-dotnet-get-started.md)
- [(Windows ランタイム 8.1 ユニバーサル c# |Javascript)](../articles/mobile-services-javascript-backend-windows-store-dotnet-get-started.md)
- [(Windows ランタイム 8.1 ユニバーサル JavaScript |Javascript)](../articles/mobile-services-javascript-backend-windows-store-javascript-get-started.md)
