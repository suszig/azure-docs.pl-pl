...
3. W polu **Serwer DNS** w polu **Dodaj serwer DNS** wprowadź adres IP serwera DNS, który ma być używany do rozpoznawania nazw.
4. Po zakończeniu dodawania serwerów DNS kliknij przycisk **Zapisz** znajdujący się na górze bloku, aby zapisać konfigurację.
