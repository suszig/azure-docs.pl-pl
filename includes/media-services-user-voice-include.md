使用して、 [User Voice](http://go.microsoft.com/fwlink/?linkid=698785&clcid=0x409) フォーラムにフィードバックを提供し、Azure Media Services の改善方法に関する推奨を作成します。 また、次のカテゴリのいずれかをクリックすると、そのカテゴリのフォーラムに直接アクセスすることもできます。 
