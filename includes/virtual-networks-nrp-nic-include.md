...
|**dnsSettings**|NIC の DNS 設定|参照してください [PIP](#Public-IP-address)|
...
### IP 構成
Nic がという名前の子オブジェクトがある **ipConfigurations** 次のプロパティを格納します。
...
|**publicIPAddress**|NIC に関連付けられた PIP|参照してください [DNS の設定](#DNS-settings)|
...
- 読み取り、 [REST API リファレンス ドキュメント](https://msdn.microsoft.com/library/azure/mt163579.aspx) Nic 用です。
