...
2. W bloku **Tworzenie bramy sieci wirtualnej** wypełnij wartości dla swojej bramy sieci wirtualnej.
    ...
    ![Pola bloku Tworzenie bramy sieci wirtualnej](./media/vpn-gateway-add-gw-rm-portal-include/createvng.png "Pola bloku Tworzenie bramy sieci wirtualnej")
...
7. **Lokalizacja**: Dostosuj wartość w polu **Lokalizacja**, aby wskazywała lokalizację sieci wirtualnej. Jeśli lokalizacja nie wskazuje regionu, w którym znajduje się Twoja sieć wirtualna, sieć ta nie będzie widoczna na liście rozwijanej „Wybierz sieć wirtualną”.
...
14. Kliknij przycisk **Utwórz**, aby rozpocząć tworzenie bramy. Zostanie sprawdzona poprawność ustawień, a na pulpicie nawigacyjnym pojawi się kafelek „Wdrażanie bramy sieci wirtualnej”. Tworzenie bramy może potrwać do 45 minut. Być może będzie trzeba odświeżyć stronę portalu, aby zobaczyć, czy tworzenie zostało ukończone.
    ...
    ![Wdrażanie bramy sieci wirtualnej](./media/vpn-gateway-add-gw-rm-portal-include/deployvnetgw150.png "Wdrażanie bramy sieci wirtualnej")
