...
- Blob サービスのリファレンス ドキュメントを [.NET 用ストレージ クライアント ライブラリ](http://go.microsoft.com/fwlink/?LinkID=390731) の詳細については、利用可能な Api のリファレンスです。
...
- Azure でデータを格納するための追加のオプションについては、他の機能ガイドも参照してください。
  ...
  - 使用する [キュー ストレージ](./storage-dotnet-how-to-use-queues.md) 非構造化データを格納します。
