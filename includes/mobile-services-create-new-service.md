...
1.  ログイン、 [Azure クラシック ポータル](https://manage.windowsazure.com/)します。 ナビゲーション ウィンドウの下部にある **[新規]** をクリックします。 **[コンピューティング]**、**[モバイル サービス]** の順に展開し、**[作成]** をクリックします。

    ![](./media/mobile-services-create-new-service/mobile-create.png)

    **[モバイル サービスの作成]** ダイアログ ボックスが表示されます。

2.  **[モバイル サービスの作成]** ダイアログで、**[無料の 20 MB SQL Database の作成]** を選択し、**[JavaScript]** ランタイムを選択してから、**[URL]** テキストボックスに新しいモバイル サービスのサブドメイン名を入力します。 右矢印ボタンをクリックして、次のページに進みます。
