...
- [(Windows 8.x ストア c# | .NET)](../articles/mobile-services-dotnet-backend-windows-store-dotnet-get-started-users.md)
- [(Windows 8.x ストア c# |Javascript)](../articles/mobile-services-windows-store-dotnet-get-started-users.md)
