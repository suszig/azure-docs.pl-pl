...
3. **[バックアップ ポリシーの追加]** ダイアログ ボックスの **[バックアップ ポリシーの定義]** で、次の操作を行います。
    ...
    3. 矢印アイコンをクリックして ![矢印アイコン](./media/storsimple-add-backup-policy-u2/HCS_ArrowIcon-include.png) 次のページに移動します。
...
4. **[スケジュールの定義]** で、以下を実行します。
    ...
    6. チェック アイコンをクリックして ![チェック マーク アイコン](./media/storsimple-add-backup-policy-u2/HCS_CheckIcon-include.png) 、ポリシーを保存します。
