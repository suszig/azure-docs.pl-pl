...
1. Visual Studio で、新しい Visual c# のデスクトップ アプリを使用してプロジェクトを作成、 **コンソール アプリケーション** プロジェクト テンプレートです。 プロジェクトの名前として「**Sender**」と入力します。
...
3. 検索 `Microsoft Azure Service Bus`, 、] をクリックして **インストール**, 、使用条件に同意します。
    ...
    これをダウンロード、インストール、およびへの参照を追加、 <a href="https://www.nuget.org/packages/WindowsAzure.ServiceBus/">Azure Service Bus ライブラリ NuGet パッケージ</a>します。
