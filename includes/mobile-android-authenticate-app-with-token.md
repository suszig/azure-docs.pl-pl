...
2. 追加、以下のメンバーに、 `ToDoActivity` クラスです。

        public static final String SHAREDPREFFILE = "temp"; 
        public static final String USERIDPREF = "uid";  
        public static final String TOKENPREF = "tkn";   

3. ToDoActivity.java ファイルに追加します、次の定義、 `cacheUserToken` メソッドです。
...
4. ToDoActivity.java ファイルに追加します、次の定義、 `loadUserTokenCache` メソッドです。
...
5. *ToDoActivity.java* ファイルで置き換えます、 `認証` トークン キャッシュを使用する次のメソッドを持つメソッドです。 Google 以外のアカウントを使用する場合は、ログイン プロバイダーを変更します。
