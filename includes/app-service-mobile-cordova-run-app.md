...
5. W programie Visual Studio z listy rozwijanej znajdującej się obok strzałki rozpoczęcia wybierz platformę rozwiązania (Android, iOS lub Windows), a następnie wybierz urządzenie określonego wdrożenia lub emulator, klikając przycisk listy rozwijanej na zielonej strzałce. Należy pamiętać, że można użyć domyślnej platformy Android i emulatora Ripple. Samouczki bardziej zaawansowane będą wymagać, aby wybrać obsługiwane urządzenie lub emulator. 

6. Naciśnij klawisz F5 lub kliknij zieloną strzałkę, aby skompilować i uruchomić aplikację systemu Cordova. Jeśli w emulatorze widzisz okno dialogowe zabezpieczeń żądające dostępu do sieci, zaakceptuj je.   

7. Po uruchomieniu aplikacji na urządzeniu lub w emulatorze wpisz znaczący tekst w obszarze **Wprowadź nowy tekst**, taki jak _Ukończ samouczek_, a następnie kliknij przycisk **Dodaj**.  
...
8. Powtórz poprzednie trzy kroki dla każdej platformy urządzenia, która ma być obsługiwana.
