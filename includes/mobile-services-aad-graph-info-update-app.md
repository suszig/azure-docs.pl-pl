...
1. Visual Studio で MainPage.xaml.cs を開き、次の追加 `を使用して` ステートメントをファイルの上部にします。
...
3. MainPage.xaml.cs で、更新、 `AuthenticateAsync` を AAD からユーザーに関する追加情報を返すカスタム API を呼び出すメソッド。
