...
最大受信速度<sup>2</sup> ストレージ アカウント (米国リージョン) あたり|GRS/ZRS の場合は 10 Gbps<sup>3</sup> が有効な場合 10 Gbps、LRS に 20 Gbps
最大送信速度<sup>2</sup> ストレージ アカウント (米国リージョン) あたり|RA GRS/GRS ZRS/の場合に 20 Gbps<sup>3</sup> 有効な場合は、LRS で 30 Gbps
最大受信速度<sup>2</sup> (ヨーロッパおよびアジア リージョン) にストレージ アカウントごと|GRS/ZRS 場合 5 Gbps<sup>3</sup> が有効な場合 10 Gbps、LRS に 10 Gbps
最大送信速度<sup>2</sup> (ヨーロッパおよびアジア リージョン) にストレージ アカウントごと|RA GRS/GRS ZRS/の場合は 10 Gbps<sup>3</sup> 有効な場合は、LRS の 15 Gbps

<sup>1</sup>100 以上のストレージ アカウントを必要とする場合にお問い合わせください。 [Azure サポート](http://azure.microsoft.com/support/faq/) サポートが必要です。

<sup>2</sup>*受信* ストレージ アカウントに送信されるすべてのデータ (要求) を参照します。 *出口* ストレージ アカウントから送信されているすべてのデータ (応答) を参照します。  

<sup>3</sup>Azure のストレージ レプリケーション オプションは次のとおりです。

- **RA-GRS**: 読み取りアクセス geo 冗長ストレージです。 RA-GRS が有効な場合、2 次拠点への送信ターゲットは、1 次拠点と同じになります。
- **GRS**: Geo 冗長ストレージです。 
- **ZRS**: ゾーン冗長ストレージです。 ブロック BLOB でのみ使用できます。 
- **LRS**: ローカル冗長ストレージです。 
