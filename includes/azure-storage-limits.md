...
---|---
 ...
 最大受信速度<sup>2</sup> (米国リージョン) のストレージ アカウントごと| GRS/ZRS の場合は 10 Gbps<sup>3</sup> 有効な場合は、LRS に 20 Gbps
 最大送信速度<sup>2</sup> (米国リージョン) のストレージ アカウントごと| 20 Gbps 場合 RA GRS/GRS ZRS/<sup>3</sup> 有効な場合は、LRS で 30 Gbps
 最大受信速度<sup>2</sup> (ヨーロッパおよびアジア リージョン) にストレージ アカウントごと| 5 Gbps 場合 GRS/ZRS<sup>3</sup> 有効な場合は、LRS に 10 Gbps
...
<sup>2</sup>*受信* ストレージ アカウントに送信されるすべてのデータ (要求) を参照します。 *送信*とはストレージ アカウントから送信されるすべてのデータ (応答) のことです。

<sup>3</sup>azure Storage のレプリケーションのオプションがあります。
