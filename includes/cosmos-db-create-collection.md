...
2. W bloku **Eksplorator danych (wersja zapoznawcza)** kliknij pozycję **Nowa kolekcja**, a następnie podaj następujące informacje:
    ...
    ---|---|---
    Identyfikator bazy danych|Zadania|Identyfikator nowej bazy danych. Nazwy baz danych muszą zawierać od 1 do 255 znaków i nie mogą zawierać znaków /, \\, #, ? ani mieć spacji na końcu.
    Identyfikator kolekcji|Items|Identyfikator nowej kolekcji. W przypadku nazw kolekcji obowiązują takie same wymagania dotyczące znaków, jak dla identyfikatorów baz danych.
    Pojemność magazynu| Stała (10 GB)|Użyj wartości domyślnej. To jest pojemność magazynu bazy danych.
