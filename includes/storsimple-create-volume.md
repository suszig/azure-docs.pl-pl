...
2. ボリュームの追加ウィザードの **[基本設定]** で、次の操作を行います。
   ...
   4. 矢印アイコンをクリックして ![矢印アイコン](./media/storsimple-create-volume/HCS_ArrowIcon-include.png) 次のページに移動します。
...
4. チェック アイコンをクリックして ![チェック マーク アイコン](./media/storsimple-create-volume/HCS_CheckIcon-include.png)します。 指定された設定でボリュームが作成されます。
