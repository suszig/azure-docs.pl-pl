...
>[AZURE.NOTE] Więcej informacji znajduje się na stronie witryny GitHub [StackExchange.Redis](http://github.com/StackExchange/StackExchange.Redis) oraz w [dokumentacji dotyczącej klienta pamięci podręcznej StackExchange.Redis](http://github.com/StackExchange/StackExchange.Redis#documentation).
