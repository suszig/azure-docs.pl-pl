...
| **SKU**| **Funkcje**|
| ---    | ---         |
|**Podstawowa**   | **VPN opartej na trasach**: 10 tuneli o P2S; nie uwierzytelniania RADIUS na potrzeby P2S; nie protokołu IKEv2 dla P2S<br>**Sieć VPN oparta na zasadach** (IKEv1): 1 tunel, bez połączeń typu punkt-lokacja|
