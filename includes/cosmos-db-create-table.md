...
2. W bloku Eksplorator danych kliknij pozycję **Nowa tabela**, a następnie wypełnij stronę, korzystając z poniższych informacji.
    ...
    RU/m|Wyłączone|Użyj wartości domyślnej. Później będzie można włączyć funkcję [RU/m](../articles/cosmos-db/request-units-per-minute.md), jeśli będzie konieczna obsługa skokowych wzrostów obciążenia.
