...
5. A teraz moment, na który wszyscy czekaliśmy! Ustaw rozmiar dysku systemu operacyjnego na żądaną wartość i zaktualizuj maszynę wirtualną w następujący sposób:
   ...
   > [!WARNING]
   > Nowy rozmiar powinien być większy niż istniejący rozmiar dysku. Maksymalna dozwolona wartość to 2048 GB. (Można rozwinąć obiektu blob dysku VHD poza ten rozmiar, ale system operacyjny będą mogli tylko do pracy z pierwszego 2048 GB miejsca).
   > 
   > 
