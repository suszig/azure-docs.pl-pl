...
1. 選択 **ストア**します。  
![ストア][button-store]
1. [MongoLab] を選択します。 もありますが、 **App Services** カテゴリとして [も **すべて**です。  
![MongoLab][entry-mongolab]
1. クリックして **次**します。  
![次へ]][button-next]  
  MongoLab ストア エントリが表示されます。  
![NewMongoLab][screen-newmongolab]
1. 必要な選択 **サブスクリプション** オプション。
1. 入力、 **名前** 、データベースにします。 名前には、英数字、ダッシュ、ドット、アンダースコアのみ使用できます。 MongoLab では、この名前を一意にする必要もあるため、名前が使用されている場合は要求を再送信するよう求められることがあります。
1. 必要な選択 **地域**します。
1. クリックして **次**します。  
![次へ]][button-next]
1. ストアの購入情報を確認し、クリックして **購入** を確認します。  
![次へ]][button-purchase]  
