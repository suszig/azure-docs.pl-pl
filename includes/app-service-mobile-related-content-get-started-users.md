モバイル アプリに認証を追加します。 [iOS][ios-get-started-users], 、[Xamarin.iOS][xamarin-ios-get-started-users], 、[Xamarin.Android][xamarin-android-get-started-users], 、[Windows ユニバーサル][windows-get-started-users]します。
