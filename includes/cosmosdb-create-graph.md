...
2. W bloku Eksplorator danych kliknij pozycję **Nowa kolekcja**, a następnie wypełnij stronę, korzystając z poniższych informacji.
    ...
    Identyfikator kolekcji|sample-graph|Identyfikator nowej kolekcji. W przypadku nazw kolekcji obowiązują takie same wymagania dotyczące znaków, jak dla identyfikatorów baz danych.
