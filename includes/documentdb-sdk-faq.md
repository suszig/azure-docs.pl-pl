...
**2.顧客は 12 か月の期間中に"to-be"インベントリから削除された DocumentDB SDK を使用してアプリケーションを作成できますか。** 
...
**3.顧客を作成および変更できます 12 か月の通知期間の後のインベントリから削除された DocumentDB SDK を使用するアプリケーションですか。**
