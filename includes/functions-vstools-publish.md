...
Kliknij pozycję **Utwórz**, aby utworzyć aplikację funkcji na platformie Azure przy użyciu tych ustawień. 

Po zakończeniu aprowizacji kliknij pozycję **Opublikuj**, aby wdrożyć kod projektu w nowej aplikacji funkcji. 

![Lokalne środowisko uruchomieniowe platformy Azure](./media/functions-vstools-publish/functions-vstools-publish-profile.png)

Zanotuj wartość **Adres URL witryny**, która jest adresem aplikacji funkcji na platformie Azure. 