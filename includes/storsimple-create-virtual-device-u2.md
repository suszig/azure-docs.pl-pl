...
1.  Azure ポータルに移動、 **StorSimple Manager** サービスです。

2. 移動して、 **デバイス** ページです。 クリックして **仮想デバイスの作成** の下部にある、 **デバイス** ページです。

3.  **仮想デバイスの作成] ダイアログ ボックス**, 、次の詳細を指定します。

     ![StorSimple 仮想デバイスの作成](./media/storsimple-create-virtual-device-u2/CreatePremiumsva1.png)
