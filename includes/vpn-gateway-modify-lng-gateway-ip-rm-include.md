...
>[AZURE.IMPORTANT] Nie należy usuwać bramy sieci VPN. Jeśli tak zrobisz, trzeba będzie wrócić do poprzednich kroków, aby utworzyć ją ponownie, a także ponownie skonfigurować router lokalny przy użyciu adresu IP przypisanego nowo utworzonej bramie.
