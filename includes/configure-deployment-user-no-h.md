...
W poniższym przykładzie zastąp ciągi *\<username>* i *\<password>* (razem z nawiasami) nową nazwą użytkownika i hasłem. Nazwa użytkownika musi być unikatowa. Hasło musi mieć długość co najmniej ośmiu znaków i zawierać dwa z następujących trzech elementów: litery, cyfry, symbole. 
