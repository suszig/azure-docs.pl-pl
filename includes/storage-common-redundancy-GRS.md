...
Dla konta magazynu z GRS włączone aktualizacja najpierw przywiązuje dużą wagę do regionu podstawowego. Aktualizacja jest następnie replikowane asynchronicznie w regionie pomocniczym, gdzie jest również replikowane.
