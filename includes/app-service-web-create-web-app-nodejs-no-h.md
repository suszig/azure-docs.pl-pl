...
Środowisko uruchomieniowe w poniższym poleceniu ma ustawioną wartość `NODE|6.9`. Aby wyświetlić wszystkie obsługiwanych środowisk uruchomieniowych, uruchom [az aplikacji sieci Web listy runtimes](/cli/azure/webapp#list-runtimes). 
