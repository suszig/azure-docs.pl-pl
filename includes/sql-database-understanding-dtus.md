...
>[AZURE.NOTE] Podczas migrowania istniejącej bazy danych programu SQL Server można użyć narzędzia innej firmy, [Kalkulatora DTU usługi Azure SQL Database](http://dtucalculator.azurewebsites.net/), aby oszacować poziom wydajności i warstwę usługi, której może ona wymagać w usłudze Azure SQL Database.

### Jednostka DTU a eDTU
